...
void test_v1_lifecycle(int include_optional) {
	...
	mazu_cJSON* jsonv1_lifecycle_1 = v1_lifecycle_convertToJSON(v1_lifecycle_1);
	printf("v1_lifecycle :\n%s\n", mazu_cJSON_Print(jsonv1_lifecycle_1));
	v1_lifecycle_t* v1_lifecycle_2 = v1_lifecycle_parseFromJSON(jsonv1_lifecycle_1);
	mazu_cJSON* jsonv1_lifecycle_2 = v1_lifecycle_convertToJSON(v1_lifecycle_2);
	printf("repeating v1_lifecycle:\n%s\n", mazu_cJSON_Print(jsonv1_lifecycle_2));
}

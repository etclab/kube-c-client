...
void test_v1_api_service(int include_optional) {
	...
	mazu_cJSON* jsonv1_api_service_1 = v1_api_service_convertToJSON(v1_api_service_1);
	printf("v1_api_service :\n%s\n", mazu_cJSON_Print(jsonv1_api_service_1));
	v1_api_service_t* v1_api_service_2 = v1_api_service_parseFromJSON(jsonv1_api_service_1);
	mazu_cJSON* jsonv1_api_service_2 = v1_api_service_convertToJSON(v1_api_service_2);
	printf("repeating v1_api_service:\n%s\n", mazu_cJSON_Print(jsonv1_api_service_2));
}

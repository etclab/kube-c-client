...
void test_v1_endpoint_slice(int include_optional) {
	...
	mazu_cJSON* jsonv1_endpoint_slice_1 = v1_endpoint_slice_convertToJSON(v1_endpoint_slice_1);
	printf("v1_endpoint_slice :\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_slice_1));
	v1_endpoint_slice_t* v1_endpoint_slice_2 = v1_endpoint_slice_parseFromJSON(jsonv1_endpoint_slice_1);
	mazu_cJSON* jsonv1_endpoint_slice_2 = v1_endpoint_slice_convertToJSON(v1_endpoint_slice_2);
	printf("repeating v1_endpoint_slice:\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_slice_2));
}

...
void test_v1_component_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_component_condition_1 = v1_component_condition_convertToJSON(v1_component_condition_1);
	printf("v1_component_condition :\n%s\n", mazu_cJSON_Print(jsonv1_component_condition_1));
	v1_component_condition_t* v1_component_condition_2 = v1_component_condition_parseFromJSON(jsonv1_component_condition_1);
	mazu_cJSON* jsonv1_component_condition_2 = v1_component_condition_convertToJSON(v1_component_condition_2);
	printf("repeating v1_component_condition:\n%s\n", mazu_cJSON_Print(jsonv1_component_condition_2));
}

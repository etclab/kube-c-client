...
void test_v1_node_selector(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_selector_1 = v1_node_selector_convertToJSON(v1_node_selector_1);
	printf("v1_node_selector :\n%s\n", mazu_cJSON_Print(jsonv1_node_selector_1));
	v1_node_selector_t* v1_node_selector_2 = v1_node_selector_parseFromJSON(jsonv1_node_selector_1);
	mazu_cJSON* jsonv1_node_selector_2 = v1_node_selector_convertToJSON(v1_node_selector_2);
	printf("repeating v1_node_selector:\n%s\n", mazu_cJSON_Print(jsonv1_node_selector_2));
}

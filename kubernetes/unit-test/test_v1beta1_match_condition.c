...
void test_v1beta1_match_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1beta1_match_condition_1 = v1beta1_match_condition_convertToJSON(v1beta1_match_condition_1);
	printf("v1beta1_match_condition :\n%s\n", mazu_cJSON_Print(jsonv1beta1_match_condition_1));
	v1beta1_match_condition_t* v1beta1_match_condition_2 = v1beta1_match_condition_parseFromJSON(jsonv1beta1_match_condition_1);
	mazu_cJSON* jsonv1beta1_match_condition_2 = v1beta1_match_condition_convertToJSON(v1beta1_match_condition_2);
	printf("repeating v1beta1_match_condition:\n%s\n", mazu_cJSON_Print(jsonv1beta1_match_condition_2));
}

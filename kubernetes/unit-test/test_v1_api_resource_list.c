...
void test_v1_api_resource_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_api_resource_list_1 = v1_api_resource_list_convertToJSON(v1_api_resource_list_1);
	printf("v1_api_resource_list :\n%s\n", mazu_cJSON_Print(jsonv1_api_resource_list_1));
	v1_api_resource_list_t* v1_api_resource_list_2 = v1_api_resource_list_parseFromJSON(jsonv1_api_resource_list_1);
	mazu_cJSON* jsonv1_api_resource_list_2 = v1_api_resource_list_convertToJSON(v1_api_resource_list_2);
	printf("repeating v1_api_resource_list:\n%s\n", mazu_cJSON_Print(jsonv1_api_resource_list_2));
}

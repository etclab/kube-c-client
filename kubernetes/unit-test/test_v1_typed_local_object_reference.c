#ifndef v1_typed_local_object_reference_TEST
#define v1_typed_local_object_reference_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1_typed_local_object_reference_MAIN
#endif // TEST_MAIN
...
v1_typed_local_object_reference_t* instantiate_v1_typed_local_object_reference(int include_optional) {
  v1_typed_local_object_reference_t* v1_typed_local_object_reference = NULL;
  if (include_optional) {
    v1_typed_local_object_reference = v1_typed_local_object_reference_create(
      "0",
      "0",
      "0"
    );
  ...
  return v1_typed_local_object_reference;
}


#ifdef v1_typed_local_object_reference_MAIN
...
int main() {
  test_v1_typed_local_object_reference(1);
  test_v1_typed_local_object_reference(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1_typed_local_object_reference_MAIN
#endif // v1_typed_local_object_reference_TEST

...
void test_v1_csi_driver_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_csi_driver_list_1 = v1_csi_driver_list_convertToJSON(v1_csi_driver_list_1);
	printf("v1_csi_driver_list :\n%s\n", mazu_cJSON_Print(jsonv1_csi_driver_list_1));
	v1_csi_driver_list_t* v1_csi_driver_list_2 = v1_csi_driver_list_parseFromJSON(jsonv1_csi_driver_list_1);
	mazu_cJSON* jsonv1_csi_driver_list_2 = v1_csi_driver_list_convertToJSON(v1_csi_driver_list_2);
	printf("repeating v1_csi_driver_list:\n%s\n", mazu_cJSON_Print(jsonv1_csi_driver_list_2));
}

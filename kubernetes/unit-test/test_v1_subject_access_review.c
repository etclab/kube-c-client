...
void test_v1_subject_access_review(int include_optional) {
	...
	mazu_cJSON* jsonv1_subject_access_review_1 = v1_subject_access_review_convertToJSON(v1_subject_access_review_1);
	printf("v1_subject_access_review :\n%s\n", mazu_cJSON_Print(jsonv1_subject_access_review_1));
	...
	mazu_cJSON* jsonv1_subject_access_review_2 = v1_subject_access_review_convertToJSON(v1_subject_access_review_2);
	printf("repeating v1_subject_access_review:\n%s\n", mazu_cJSON_Print(jsonv1_subject_access_review_2));
}

...
void test_v1_exempt_priority_level_configuration(int include_optional) {
	...
	mazu_cJSON* jsonv1_exempt_priority_level_configuration_1 = v1_exempt_priority_level_configuration_convertToJSON(v1_exempt_priority_level_configuration_1);
	printf("v1_exempt_priority_level_configuration :\n%s\n", mazu_cJSON_Print(jsonv1_exempt_priority_level_configuration_1));
	...
	mazu_cJSON* jsonv1_exempt_priority_level_configuration_2 = v1_exempt_priority_level_configuration_convertToJSON(v1_exempt_priority_level_configuration_2);
	printf("repeating v1_exempt_priority_level_configuration:\n%s\n", mazu_cJSON_Print(jsonv1_exempt_priority_level_configuration_2));
}

...
void test_v1_scale_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_scale_status_1 = v1_scale_status_convertToJSON(v1_scale_status_1);
	printf("v1_scale_status :\n%s\n", mazu_cJSON_Print(jsonv1_scale_status_1));
	v1_scale_status_t* v1_scale_status_2 = v1_scale_status_parseFromJSON(jsonv1_scale_status_1);
	mazu_cJSON* jsonv1_scale_status_2 = v1_scale_status_convertToJSON(v1_scale_status_2);
	printf("repeating v1_scale_status:\n%s\n", mazu_cJSON_Print(jsonv1_scale_status_2));
}

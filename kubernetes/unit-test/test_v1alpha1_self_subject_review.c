...
void test_v1alpha1_self_subject_review(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_self_subject_review_1 = v1alpha1_self_subject_review_convertToJSON(v1alpha1_self_subject_review_1);
	printf("v1alpha1_self_subject_review :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_self_subject_review_1));
	...
	mazu_cJSON* jsonv1alpha1_self_subject_review_2 = v1alpha1_self_subject_review_convertToJSON(v1alpha1_self_subject_review_2);
	printf("repeating v1alpha1_self_subject_review:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_self_subject_review_2));
}

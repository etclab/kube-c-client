...
void test_v1_priority_level_configuration_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_priority_level_configuration_condition_1 = v1_priority_level_configuration_condition_convertToJSON(v1_priority_level_configuration_condition_1);
	printf("v1_priority_level_configuration_condition :\n%s\n", mazu_cJSON_Print(jsonv1_priority_level_configuration_condition_1));
	...
	mazu_cJSON* jsonv1_priority_level_configuration_condition_2 = v1_priority_level_configuration_condition_convertToJSON(v1_priority_level_configuration_condition_2);
	printf("repeating v1_priority_level_configuration_condition:\n%s\n", mazu_cJSON_Print(jsonv1_priority_level_configuration_condition_2));
}

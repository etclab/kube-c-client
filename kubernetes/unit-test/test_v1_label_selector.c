...
void test_v1_label_selector(int include_optional) {
	...
	mazu_cJSON* jsonv1_label_selector_1 = v1_label_selector_convertToJSON(v1_label_selector_1);
	printf("v1_label_selector :\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_1));
	v1_label_selector_t* v1_label_selector_2 = v1_label_selector_parseFromJSON(jsonv1_label_selector_1);
	mazu_cJSON* jsonv1_label_selector_2 = v1_label_selector_convertToJSON(v1_label_selector_2);
	printf("repeating v1_label_selector:\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_2));
}

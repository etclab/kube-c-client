...
void test_core_v1_endpoint_port(int include_optional) {
	...
	mazu_cJSON* jsoncore_v1_endpoint_port_1 = core_v1_endpoint_port_convertToJSON(core_v1_endpoint_port_1);
	printf("core_v1_endpoint_port :\n%s\n", mazu_cJSON_Print(jsoncore_v1_endpoint_port_1));
	core_v1_endpoint_port_t* core_v1_endpoint_port_2 = core_v1_endpoint_port_parseFromJSON(jsoncore_v1_endpoint_port_1);
	mazu_cJSON* jsoncore_v1_endpoint_port_2 = core_v1_endpoint_port_convertToJSON(core_v1_endpoint_port_2);
	printf("repeating core_v1_endpoint_port:\n%s\n", mazu_cJSON_Print(jsoncore_v1_endpoint_port_2));
}

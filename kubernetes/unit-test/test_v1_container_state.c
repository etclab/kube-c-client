...
void test_v1_container_state(int include_optional) {
	...
	mazu_cJSON* jsonv1_container_state_1 = v1_container_state_convertToJSON(v1_container_state_1);
	printf("v1_container_state :\n%s\n", mazu_cJSON_Print(jsonv1_container_state_1));
	v1_container_state_t* v1_container_state_2 = v1_container_state_parseFromJSON(jsonv1_container_state_1);
	mazu_cJSON* jsonv1_container_state_2 = v1_container_state_convertToJSON(v1_container_state_2);
	printf("repeating v1_container_state:\n%s\n", mazu_cJSON_Print(jsonv1_container_state_2));
}

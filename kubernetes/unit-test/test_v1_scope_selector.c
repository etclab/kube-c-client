...
void test_v1_scope_selector(int include_optional) {
	...
	mazu_cJSON* jsonv1_scope_selector_1 = v1_scope_selector_convertToJSON(v1_scope_selector_1);
	printf("v1_scope_selector :\n%s\n", mazu_cJSON_Print(jsonv1_scope_selector_1));
	v1_scope_selector_t* v1_scope_selector_2 = v1_scope_selector_parseFromJSON(jsonv1_scope_selector_1);
	mazu_cJSON* jsonv1_scope_selector_2 = v1_scope_selector_convertToJSON(v1_scope_selector_2);
	printf("repeating v1_scope_selector:\n%s\n", mazu_cJSON_Print(jsonv1_scope_selector_2));
}

...
void test_v1_policy_rule(int include_optional) {
	...
	mazu_cJSON* jsonv1_policy_rule_1 = v1_policy_rule_convertToJSON(v1_policy_rule_1);
	printf("v1_policy_rule :\n%s\n", mazu_cJSON_Print(jsonv1_policy_rule_1));
	v1_policy_rule_t* v1_policy_rule_2 = v1_policy_rule_parseFromJSON(jsonv1_policy_rule_1);
	mazu_cJSON* jsonv1_policy_rule_2 = v1_policy_rule_convertToJSON(v1_policy_rule_2);
	printf("repeating v1_policy_rule:\n%s\n", mazu_cJSON_Print(jsonv1_policy_rule_2));
}

...
void test_v1_policy_rules_with_subjects(int include_optional) {
	...
	mazu_cJSON* jsonv1_policy_rules_with_subjects_1 = v1_policy_rules_with_subjects_convertToJSON(v1_policy_rules_with_subjects_1);
	printf("v1_policy_rules_with_subjects :\n%s\n", mazu_cJSON_Print(jsonv1_policy_rules_with_subjects_1));
	...
	mazu_cJSON* jsonv1_policy_rules_with_subjects_2 = v1_policy_rules_with_subjects_convertToJSON(v1_policy_rules_with_subjects_2);
	printf("repeating v1_policy_rules_with_subjects:\n%s\n", mazu_cJSON_Print(jsonv1_policy_rules_with_subjects_2));
}

...
void test_v1_exec_action(int include_optional) {
	...
	mazu_cJSON* jsonv1_exec_action_1 = v1_exec_action_convertToJSON(v1_exec_action_1);
	printf("v1_exec_action :\n%s\n", mazu_cJSON_Print(jsonv1_exec_action_1));
	v1_exec_action_t* v1_exec_action_2 = v1_exec_action_parseFromJSON(jsonv1_exec_action_1);
	mazu_cJSON* jsonv1_exec_action_2 = v1_exec_action_convertToJSON(v1_exec_action_2);
	printf("repeating v1_exec_action:\n%s\n", mazu_cJSON_Print(jsonv1_exec_action_2));
}

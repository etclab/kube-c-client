...
void test_v1_env_var_source(int include_optional) {
	...
	mazu_cJSON* jsonv1_env_var_source_1 = v1_env_var_source_convertToJSON(v1_env_var_source_1);
	printf("v1_env_var_source :\n%s\n", mazu_cJSON_Print(jsonv1_env_var_source_1));
	v1_env_var_source_t* v1_env_var_source_2 = v1_env_var_source_parseFromJSON(jsonv1_env_var_source_1);
	mazu_cJSON* jsonv1_env_var_source_2 = v1_env_var_source_convertToJSON(v1_env_var_source_2);
	printf("repeating v1_env_var_source:\n%s\n", mazu_cJSON_Print(jsonv1_env_var_source_2));
}

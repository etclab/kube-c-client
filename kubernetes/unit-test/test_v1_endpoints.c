...
void test_v1_endpoints(int include_optional) {
	...
	mazu_cJSON* jsonv1_endpoints_1 = v1_endpoints_convertToJSON(v1_endpoints_1);
	printf("v1_endpoints :\n%s\n", mazu_cJSON_Print(jsonv1_endpoints_1));
	v1_endpoints_t* v1_endpoints_2 = v1_endpoints_parseFromJSON(jsonv1_endpoints_1);
	mazu_cJSON* jsonv1_endpoints_2 = v1_endpoints_convertToJSON(v1_endpoints_2);
	printf("repeating v1_endpoints:\n%s\n", mazu_cJSON_Print(jsonv1_endpoints_2));
}

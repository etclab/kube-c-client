...
void test_v1_self_subject_rules_review(int include_optional) {
	...
	mazu_cJSON* jsonv1_self_subject_rules_review_1 = v1_self_subject_rules_review_convertToJSON(v1_self_subject_rules_review_1);
	printf("v1_self_subject_rules_review :\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_rules_review_1));
	...
	mazu_cJSON* jsonv1_self_subject_rules_review_2 = v1_self_subject_rules_review_convertToJSON(v1_self_subject_rules_review_2);
	printf("repeating v1_self_subject_rules_review:\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_rules_review_2));
}

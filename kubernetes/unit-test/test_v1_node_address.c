...
void test_v1_node_address(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_address_1 = v1_node_address_convertToJSON(v1_node_address_1);
	printf("v1_node_address :\n%s\n", mazu_cJSON_Print(jsonv1_node_address_1));
	v1_node_address_t* v1_node_address_2 = v1_node_address_parseFromJSON(jsonv1_node_address_1);
	mazu_cJSON* jsonv1_node_address_2 = v1_node_address_convertToJSON(v1_node_address_2);
	printf("repeating v1_node_address:\n%s\n", mazu_cJSON_Print(jsonv1_node_address_2));
}

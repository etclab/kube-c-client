...
void test_v1_runtime_class(int include_optional) {
	...
	mazu_cJSON* jsonv1_runtime_class_1 = v1_runtime_class_convertToJSON(v1_runtime_class_1);
	printf("v1_runtime_class :\n%s\n", mazu_cJSON_Print(jsonv1_runtime_class_1));
	v1_runtime_class_t* v1_runtime_class_2 = v1_runtime_class_parseFromJSON(jsonv1_runtime_class_1);
	mazu_cJSON* jsonv1_runtime_class_2 = v1_runtime_class_convertToJSON(v1_runtime_class_2);
	printf("repeating v1_runtime_class:\n%s\n", mazu_cJSON_Print(jsonv1_runtime_class_2));
}

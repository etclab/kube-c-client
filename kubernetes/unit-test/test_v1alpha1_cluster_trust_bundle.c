#ifndef v1alpha1_cluster_trust_bundle_TEST
#define v1alpha1_cluster_trust_bundle_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1alpha1_cluster_trust_bundle_MAIN
#endif // TEST_MAIN
...
#include "test_v1alpha1_cluster_trust_bundle_spec.c"


v1alpha1_cluster_trust_bundle_t* instantiate_v1alpha1_cluster_trust_bundle(int include_optional) {
  v1alpha1_cluster_trust_bundle_t* v1alpha1_cluster_trust_bundle = NULL;
  if (include_optional) {
    v1alpha1_cluster_trust_bundle = v1alpha1_cluster_trust_bundle_create(
      "0",
      "0",
       // false, not to have infinite recursion
      instantiate_v1_object_meta(0),
       // false, not to have infinite recursion
      instantiate_v1alpha1_cluster_trust_bundle_spec(0)
    );
  } else {
    v1alpha1_cluster_trust_bundle = v1alpha1_cluster_trust_bundle_create(
      "0",
  ...
  return v1alpha1_cluster_trust_bundle;
}


#ifdef v1alpha1_cluster_trust_bundle_MAIN
...
int main() {
  test_v1alpha1_cluster_trust_bundle(1);
  test_v1alpha1_cluster_trust_bundle(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1alpha1_cluster_trust_bundle_MAIN
#endif // v1alpha1_cluster_trust_bundle_TEST

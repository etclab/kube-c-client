...
void test_v1_pod_failure_policy_on_pod_conditions_pattern(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_failure_policy_on_pod_conditions_pattern_1 = v1_pod_failure_policy_on_pod_conditions_pattern_convertToJSON(v1_pod_failure_policy_on_pod_conditions_pattern_1);
	printf("v1_pod_failure_policy_on_pod_conditions_pattern :\n%s\n", mazu_cJSON_Print(jsonv1_pod_failure_policy_on_pod_conditions_pattern_1));
	...
	mazu_cJSON* jsonv1_pod_failure_policy_on_pod_conditions_pattern_2 = v1_pod_failure_policy_on_pod_conditions_pattern_convertToJSON(v1_pod_failure_policy_on_pod_conditions_pattern_2);
	printf("repeating v1_pod_failure_policy_on_pod_conditions_pattern:\n%s\n", mazu_cJSON_Print(jsonv1_pod_failure_policy_on_pod_conditions_pattern_2));
}

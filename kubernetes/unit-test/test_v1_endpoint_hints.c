...
void test_v1_endpoint_hints(int include_optional) {
	...
	mazu_cJSON* jsonv1_endpoint_hints_1 = v1_endpoint_hints_convertToJSON(v1_endpoint_hints_1);
	printf("v1_endpoint_hints :\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_hints_1));
	v1_endpoint_hints_t* v1_endpoint_hints_2 = v1_endpoint_hints_parseFromJSON(jsonv1_endpoint_hints_1);
	mazu_cJSON* jsonv1_endpoint_hints_2 = v1_endpoint_hints_convertToJSON(v1_endpoint_hints_2);
	printf("repeating v1_endpoint_hints:\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_hints_2));
}

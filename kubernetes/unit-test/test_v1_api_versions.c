...
void test_v1_api_versions(int include_optional) {
	...
	mazu_cJSON* jsonv1_api_versions_1 = v1_api_versions_convertToJSON(v1_api_versions_1);
	printf("v1_api_versions :\n%s\n", mazu_cJSON_Print(jsonv1_api_versions_1));
	v1_api_versions_t* v1_api_versions_2 = v1_api_versions_parseFromJSON(jsonv1_api_versions_1);
	mazu_cJSON* jsonv1_api_versions_2 = v1_api_versions_convertToJSON(v1_api_versions_2);
	printf("repeating v1_api_versions:\n%s\n", mazu_cJSON_Print(jsonv1_api_versions_2));
}

...
void test_v1_custom_resource_definition_names(int include_optional) {
	...
	mazu_cJSON* jsonv1_custom_resource_definition_names_1 = v1_custom_resource_definition_names_convertToJSON(v1_custom_resource_definition_names_1);
	printf("v1_custom_resource_definition_names :\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_definition_names_1));
	...
	mazu_cJSON* jsonv1_custom_resource_definition_names_2 = v1_custom_resource_definition_names_convertToJSON(v1_custom_resource_definition_names_2);
	printf("repeating v1_custom_resource_definition_names:\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_definition_names_2));
}

...
void test_v1_pod_dns_config(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_dns_config_1 = v1_pod_dns_config_convertToJSON(v1_pod_dns_config_1);
	printf("v1_pod_dns_config :\n%s\n", mazu_cJSON_Print(jsonv1_pod_dns_config_1));
	v1_pod_dns_config_t* v1_pod_dns_config_2 = v1_pod_dns_config_parseFromJSON(jsonv1_pod_dns_config_1);
	mazu_cJSON* jsonv1_pod_dns_config_2 = v1_pod_dns_config_convertToJSON(v1_pod_dns_config_2);
	printf("repeating v1_pod_dns_config:\n%s\n", mazu_cJSON_Print(jsonv1_pod_dns_config_2));
}

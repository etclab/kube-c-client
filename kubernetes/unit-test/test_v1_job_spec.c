...
void test_v1_job_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_job_spec_1 = v1_job_spec_convertToJSON(v1_job_spec_1);
	printf("v1_job_spec :\n%s\n", mazu_cJSON_Print(jsonv1_job_spec_1));
	v1_job_spec_t* v1_job_spec_2 = v1_job_spec_parseFromJSON(jsonv1_job_spec_1);
	mazu_cJSON* jsonv1_job_spec_2 = v1_job_spec_convertToJSON(v1_job_spec_2);
	printf("repeating v1_job_spec:\n%s\n", mazu_cJSON_Print(jsonv1_job_spec_2));
}

...
void test_v1_windows_security_context_options(int include_optional) {
	...
	mazu_cJSON* jsonv1_windows_security_context_options_1 = v1_windows_security_context_options_convertToJSON(v1_windows_security_context_options_1);
	printf("v1_windows_security_context_options :\n%s\n", mazu_cJSON_Print(jsonv1_windows_security_context_options_1));
	...
	mazu_cJSON* jsonv1_windows_security_context_options_2 = v1_windows_security_context_options_convertToJSON(v1_windows_security_context_options_2);
	printf("repeating v1_windows_security_context_options:\n%s\n", mazu_cJSON_Print(jsonv1_windows_security_context_options_2));
}

...
void test_v1alpha3_device_class_configuration(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_device_class_configuration_1 = v1alpha3_device_class_configuration_convertToJSON(v1alpha3_device_class_configuration_1);
	printf("v1alpha3_device_class_configuration :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_class_configuration_1));
	...
	mazu_cJSON* jsonv1alpha3_device_class_configuration_2 = v1alpha3_device_class_configuration_convertToJSON(v1alpha3_device_class_configuration_2);
	printf("repeating v1alpha3_device_class_configuration:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_class_configuration_2));
}

...
void test_v1alpha3_device_class_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_device_class_spec_1 = v1alpha3_device_class_spec_convertToJSON(v1alpha3_device_class_spec_1);
	printf("v1alpha3_device_class_spec :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_class_spec_1));
	...
	mazu_cJSON* jsonv1alpha3_device_class_spec_2 = v1alpha3_device_class_spec_convertToJSON(v1alpha3_device_class_spec_2);
	printf("repeating v1alpha3_device_class_spec:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_class_spec_2));
}

...
void test_v1alpha3_resource_claim_scheduling_status(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_resource_claim_scheduling_status_1 = v1alpha3_resource_claim_scheduling_status_convertToJSON(v1alpha3_resource_claim_scheduling_status_1);
	printf("v1alpha3_resource_claim_scheduling_status :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_scheduling_status_1));
	...
	mazu_cJSON* jsonv1alpha3_resource_claim_scheduling_status_2 = v1alpha3_resource_claim_scheduling_status_convertToJSON(v1alpha3_resource_claim_scheduling_status_2);
	printf("repeating v1alpha3_resource_claim_scheduling_status:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_scheduling_status_2));
}

...
void test_v1beta1_param_ref(int include_optional) {
	...
	mazu_cJSON* jsonv1beta1_param_ref_1 = v1beta1_param_ref_convertToJSON(v1beta1_param_ref_1);
	printf("v1beta1_param_ref :\n%s\n", mazu_cJSON_Print(jsonv1beta1_param_ref_1));
	v1beta1_param_ref_t* v1beta1_param_ref_2 = v1beta1_param_ref_parseFromJSON(jsonv1beta1_param_ref_1);
	mazu_cJSON* jsonv1beta1_param_ref_2 = v1beta1_param_ref_convertToJSON(v1beta1_param_ref_2);
	printf("repeating v1beta1_param_ref:\n%s\n", mazu_cJSON_Print(jsonv1beta1_param_ref_2));
}

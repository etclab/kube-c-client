...
void test_v1_persistent_volume_claim(int include_optional) {
	...
	mazu_cJSON* jsonv1_persistent_volume_claim_1 = v1_persistent_volume_claim_convertToJSON(v1_persistent_volume_claim_1);
	printf("v1_persistent_volume_claim :\n%s\n", mazu_cJSON_Print(jsonv1_persistent_volume_claim_1));
	...
	mazu_cJSON* jsonv1_persistent_volume_claim_2 = v1_persistent_volume_claim_convertToJSON(v1_persistent_volume_claim_2);
	printf("repeating v1_persistent_volume_claim:\n%s\n", mazu_cJSON_Print(jsonv1_persistent_volume_claim_2));
}

...
void test_v1_mutating_webhook(int include_optional) {
	...
	mazu_cJSON* jsonv1_mutating_webhook_1 = v1_mutating_webhook_convertToJSON(v1_mutating_webhook_1);
	printf("v1_mutating_webhook :\n%s\n", mazu_cJSON_Print(jsonv1_mutating_webhook_1));
	v1_mutating_webhook_t* v1_mutating_webhook_2 = v1_mutating_webhook_parseFromJSON(jsonv1_mutating_webhook_1);
	mazu_cJSON* jsonv1_mutating_webhook_2 = v1_mutating_webhook_convertToJSON(v1_mutating_webhook_2);
	printf("repeating v1_mutating_webhook:\n%s\n", mazu_cJSON_Print(jsonv1_mutating_webhook_2));
}

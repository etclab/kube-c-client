...
void test_v1_seccomp_profile(int include_optional) {
	...
	mazu_cJSON* jsonv1_seccomp_profile_1 = v1_seccomp_profile_convertToJSON(v1_seccomp_profile_1);
	printf("v1_seccomp_profile :\n%s\n", mazu_cJSON_Print(jsonv1_seccomp_profile_1));
	v1_seccomp_profile_t* v1_seccomp_profile_2 = v1_seccomp_profile_parseFromJSON(jsonv1_seccomp_profile_1);
	mazu_cJSON* jsonv1_seccomp_profile_2 = v1_seccomp_profile_convertToJSON(v1_seccomp_profile_2);
	printf("repeating v1_seccomp_profile:\n%s\n", mazu_cJSON_Print(jsonv1_seccomp_profile_2));
}

...
void test_v1_rolling_update_daemon_set(int include_optional) {
	...
	mazu_cJSON* jsonv1_rolling_update_daemon_set_1 = v1_rolling_update_daemon_set_convertToJSON(v1_rolling_update_daemon_set_1);
	printf("v1_rolling_update_daemon_set :\n%s\n", mazu_cJSON_Print(jsonv1_rolling_update_daemon_set_1));
	...
	mazu_cJSON* jsonv1_rolling_update_daemon_set_2 = v1_rolling_update_daemon_set_convertToJSON(v1_rolling_update_daemon_set_2);
	printf("repeating v1_rolling_update_daemon_set:\n%s\n", mazu_cJSON_Print(jsonv1_rolling_update_daemon_set_2));
}

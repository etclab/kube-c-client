...
void test_v1_managed_fields_entry(int include_optional) {
	...
	mazu_cJSON* jsonv1_managed_fields_entry_1 = v1_managed_fields_entry_convertToJSON(v1_managed_fields_entry_1);
	printf("v1_managed_fields_entry :\n%s\n", mazu_cJSON_Print(jsonv1_managed_fields_entry_1));
	v1_managed_fields_entry_t* v1_managed_fields_entry_2 = v1_managed_fields_entry_parseFromJSON(jsonv1_managed_fields_entry_1);
	mazu_cJSON* jsonv1_managed_fields_entry_2 = v1_managed_fields_entry_convertToJSON(v1_managed_fields_entry_2);
	printf("repeating v1_managed_fields_entry:\n%s\n", mazu_cJSON_Print(jsonv1_managed_fields_entry_2));
}

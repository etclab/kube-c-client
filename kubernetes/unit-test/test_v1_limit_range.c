...
void test_v1_limit_range(int include_optional) {
	...
	mazu_cJSON* jsonv1_limit_range_1 = v1_limit_range_convertToJSON(v1_limit_range_1);
	printf("v1_limit_range :\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_1));
	v1_limit_range_t* v1_limit_range_2 = v1_limit_range_parseFromJSON(jsonv1_limit_range_1);
	mazu_cJSON* jsonv1_limit_range_2 = v1_limit_range_convertToJSON(v1_limit_range_2);
	printf("repeating v1_limit_range:\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_2));
}

...
void test_v1_horizontal_pod_autoscaler_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_spec_1 = v1_horizontal_pod_autoscaler_spec_convertToJSON(v1_horizontal_pod_autoscaler_spec_1);
	printf("v1_horizontal_pod_autoscaler_spec :\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_spec_1));
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_spec_2 = v1_horizontal_pod_autoscaler_spec_convertToJSON(v1_horizontal_pod_autoscaler_spec_2);
	printf("repeating v1_horizontal_pod_autoscaler_spec:\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_spec_2));
}

#ifndef v1beta3_flow_schema_TEST
#define v1beta3_flow_schema_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1beta3_flow_schema_MAIN
#endif // TEST_MAIN
...
#include "test_v1beta3_flow_schema_spec.c"
#include "test_v1beta3_flow_schema_status.c"


v1beta3_flow_schema_t* instantiate_v1beta3_flow_schema(int include_optional) {
  v1beta3_flow_schema_t* v1beta3_flow_schema = NULL;
  if (include_optional) {
    v1beta3_flow_schema = v1beta3_flow_schema_create(
      "0",
      "0",
       // false, not to have infinite recursion
      instantiate_v1_object_meta(0),
       // false, not to have infinite recursion
      instantiate_v1beta3_flow_schema_spec(0),
       // false, not to have infinite recursion
      instantiate_v1beta3_flow_schema_status(0)
    );
  } else {
    v1beta3_flow_schema = v1beta3_flow_schema_create(
      "0",
...
int main() {
  test_v1beta3_flow_schema(1);
  test_v1beta3_flow_schema(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1beta3_flow_schema_MAIN
#endif // v1beta3_flow_schema_TEST

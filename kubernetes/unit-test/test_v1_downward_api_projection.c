...
void test_v1_downward_api_projection(int include_optional) {
	...
	mazu_cJSON* jsonv1_downward_api_projection_1 = v1_downward_api_projection_convertToJSON(v1_downward_api_projection_1);
	printf("v1_downward_api_projection :\n%s\n", mazu_cJSON_Print(jsonv1_downward_api_projection_1));
	...
	mazu_cJSON* jsonv1_downward_api_projection_2 = v1_downward_api_projection_convertToJSON(v1_downward_api_projection_2);
	printf("repeating v1_downward_api_projection:\n%s\n", mazu_cJSON_Print(jsonv1_downward_api_projection_2));
}

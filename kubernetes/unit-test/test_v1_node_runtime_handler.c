...
void test_v1_node_runtime_handler(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_runtime_handler_1 = v1_node_runtime_handler_convertToJSON(v1_node_runtime_handler_1);
	printf("v1_node_runtime_handler :\n%s\n", mazu_cJSON_Print(jsonv1_node_runtime_handler_1));
	v1_node_runtime_handler_t* v1_node_runtime_handler_2 = v1_node_runtime_handler_parseFromJSON(jsonv1_node_runtime_handler_1);
	mazu_cJSON* jsonv1_node_runtime_handler_2 = v1_node_runtime_handler_convertToJSON(v1_node_runtime_handler_2);
	printf("repeating v1_node_runtime_handler:\n%s\n", mazu_cJSON_Print(jsonv1_node_runtime_handler_2));
}

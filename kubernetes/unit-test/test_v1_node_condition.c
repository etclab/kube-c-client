...
void test_v1_node_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_condition_1 = v1_node_condition_convertToJSON(v1_node_condition_1);
	printf("v1_node_condition :\n%s\n", mazu_cJSON_Print(jsonv1_node_condition_1));
	v1_node_condition_t* v1_node_condition_2 = v1_node_condition_parseFromJSON(jsonv1_node_condition_1);
	mazu_cJSON* jsonv1_node_condition_2 = v1_node_condition_convertToJSON(v1_node_condition_2);
	printf("repeating v1_node_condition:\n%s\n", mazu_cJSON_Print(jsonv1_node_condition_2));
}

...
void test_v1beta1_parent_reference(int include_optional) {
	...
	mazu_cJSON* jsonv1beta1_parent_reference_1 = v1beta1_parent_reference_convertToJSON(v1beta1_parent_reference_1);
	printf("v1beta1_parent_reference :\n%s\n", mazu_cJSON_Print(jsonv1beta1_parent_reference_1));
	...
	mazu_cJSON* jsonv1beta1_parent_reference_2 = v1beta1_parent_reference_convertToJSON(v1beta1_parent_reference_2);
	printf("repeating v1beta1_parent_reference:\n%s\n", mazu_cJSON_Print(jsonv1beta1_parent_reference_2));
}

...
void test_v1_host_alias(int include_optional) {
	...
	mazu_cJSON* jsonv1_host_alias_1 = v1_host_alias_convertToJSON(v1_host_alias_1);
	printf("v1_host_alias :\n%s\n", mazu_cJSON_Print(jsonv1_host_alias_1));
	v1_host_alias_t* v1_host_alias_2 = v1_host_alias_parseFromJSON(jsonv1_host_alias_1);
	mazu_cJSON* jsonv1_host_alias_2 = v1_host_alias_convertToJSON(v1_host_alias_2);
	printf("repeating v1_host_alias:\n%s\n", mazu_cJSON_Print(jsonv1_host_alias_2));
}

...
void test_v1_ingress_class_parameters_reference(int include_optional) {
	...
	mazu_cJSON* jsonv1_ingress_class_parameters_reference_1 = v1_ingress_class_parameters_reference_convertToJSON(v1_ingress_class_parameters_reference_1);
	printf("v1_ingress_class_parameters_reference :\n%s\n", mazu_cJSON_Print(jsonv1_ingress_class_parameters_reference_1));
	...
	mazu_cJSON* jsonv1_ingress_class_parameters_reference_2 = v1_ingress_class_parameters_reference_convertToJSON(v1_ingress_class_parameters_reference_2);
	printf("repeating v1_ingress_class_parameters_reference:\n%s\n", mazu_cJSON_Print(jsonv1_ingress_class_parameters_reference_2));
}

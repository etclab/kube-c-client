...
void test_v1beta1_validation(int include_optional) {
	...
	mazu_cJSON* jsonv1beta1_validation_1 = v1beta1_validation_convertToJSON(v1beta1_validation_1);
	printf("v1beta1_validation :\n%s\n", mazu_cJSON_Print(jsonv1beta1_validation_1));
	v1beta1_validation_t* v1beta1_validation_2 = v1beta1_validation_parseFromJSON(jsonv1beta1_validation_1);
	mazu_cJSON* jsonv1beta1_validation_2 = v1beta1_validation_convertToJSON(v1beta1_validation_2);
	printf("repeating v1beta1_validation:\n%s\n", mazu_cJSON_Print(jsonv1beta1_validation_2));
}

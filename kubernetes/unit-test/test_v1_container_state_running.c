...
void test_v1_container_state_running(int include_optional) {
	...
	mazu_cJSON* jsonv1_container_state_running_1 = v1_container_state_running_convertToJSON(v1_container_state_running_1);
	printf("v1_container_state_running :\n%s\n", mazu_cJSON_Print(jsonv1_container_state_running_1));
	...
	mazu_cJSON* jsonv1_container_state_running_2 = v1_container_state_running_convertToJSON(v1_container_state_running_2);
	printf("repeating v1_container_state_running:\n%s\n", mazu_cJSON_Print(jsonv1_container_state_running_2));
}

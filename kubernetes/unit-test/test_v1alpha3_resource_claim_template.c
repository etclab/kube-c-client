...
void test_v1alpha3_resource_claim_template(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_resource_claim_template_1 = v1alpha3_resource_claim_template_convertToJSON(v1alpha3_resource_claim_template_1);
	printf("v1alpha3_resource_claim_template :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_template_1));
	...
	mazu_cJSON* jsonv1alpha3_resource_claim_template_2 = v1alpha3_resource_claim_template_convertToJSON(v1alpha3_resource_claim_template_2);
	printf("repeating v1alpha3_resource_claim_template:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_template_2));
}

#ifndef rbac_v1_subject_TEST
#define rbac_v1_subject_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define rbac_v1_subject_MAIN
#endif // TEST_MAIN
...
rbac_v1_subject_t* instantiate_rbac_v1_subject(int include_optional) {
  rbac_v1_subject_t* rbac_v1_subject = NULL;
  if (include_optional) {
    rbac_v1_subject = rbac_v1_subject_create(
      "0",
      "0",
      "0",
      "0"
  ...
  return rbac_v1_subject;
}


#ifdef rbac_v1_subject_MAIN
...
int main() {
  test_rbac_v1_subject(1);
  test_rbac_v1_subject(0);

  printf("Hello world \n");
  return 0;
}

#endif // rbac_v1_subject_MAIN
#endif // rbac_v1_subject_TEST

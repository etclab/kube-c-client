...
void test_v1_validating_webhook_configuration_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_validating_webhook_configuration_list_1 = v1_validating_webhook_configuration_list_convertToJSON(v1_validating_webhook_configuration_list_1);
	printf("v1_validating_webhook_configuration_list :\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_configuration_list_1));
	...
	mazu_cJSON* jsonv1_validating_webhook_configuration_list_2 = v1_validating_webhook_configuration_list_convertToJSON(v1_validating_webhook_configuration_list_2);
	printf("repeating v1_validating_webhook_configuration_list:\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_configuration_list_2));
}

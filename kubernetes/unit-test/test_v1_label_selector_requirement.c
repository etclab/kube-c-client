...
void test_v1_label_selector_requirement(int include_optional) {
	...
	mazu_cJSON* jsonv1_label_selector_requirement_1 = v1_label_selector_requirement_convertToJSON(v1_label_selector_requirement_1);
	printf("v1_label_selector_requirement :\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_requirement_1));
	...
	mazu_cJSON* jsonv1_label_selector_requirement_2 = v1_label_selector_requirement_convertToJSON(v1_label_selector_requirement_2);
	printf("repeating v1_label_selector_requirement:\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_requirement_2));
}

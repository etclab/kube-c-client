...
void test_v1_namespace_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_namespace_list_1 = v1_namespace_list_convertToJSON(v1_namespace_list_1);
	printf("v1_namespace_list :\n%s\n", mazu_cJSON_Print(jsonv1_namespace_list_1));
	v1_namespace_list_t* v1_namespace_list_2 = v1_namespace_list_parseFromJSON(jsonv1_namespace_list_1);
	mazu_cJSON* jsonv1_namespace_list_2 = v1_namespace_list_convertToJSON(v1_namespace_list_2);
	printf("repeating v1_namespace_list:\n%s\n", mazu_cJSON_Print(jsonv1_namespace_list_2));
}

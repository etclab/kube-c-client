...
void test_v1alpha1_audit_annotation(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_audit_annotation_1 = v1alpha1_audit_annotation_convertToJSON(v1alpha1_audit_annotation_1);
	printf("v1alpha1_audit_annotation :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_audit_annotation_1));
	...
	mazu_cJSON* jsonv1alpha1_audit_annotation_2 = v1alpha1_audit_annotation_convertToJSON(v1alpha1_audit_annotation_2);
	printf("repeating v1alpha1_audit_annotation:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_audit_annotation_2));
}

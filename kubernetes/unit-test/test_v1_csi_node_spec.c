...
void test_v1_csi_node_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_csi_node_spec_1 = v1_csi_node_spec_convertToJSON(v1_csi_node_spec_1);
	printf("v1_csi_node_spec :\n%s\n", mazu_cJSON_Print(jsonv1_csi_node_spec_1));
	v1_csi_node_spec_t* v1_csi_node_spec_2 = v1_csi_node_spec_parseFromJSON(jsonv1_csi_node_spec_1);
	mazu_cJSON* jsonv1_csi_node_spec_2 = v1_csi_node_spec_convertToJSON(v1_csi_node_spec_2);
	printf("repeating v1_csi_node_spec:\n%s\n", mazu_cJSON_Print(jsonv1_csi_node_spec_2));
}

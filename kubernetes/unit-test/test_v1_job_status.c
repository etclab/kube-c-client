...
void test_v1_job_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_job_status_1 = v1_job_status_convertToJSON(v1_job_status_1);
	printf("v1_job_status :\n%s\n", mazu_cJSON_Print(jsonv1_job_status_1));
	v1_job_status_t* v1_job_status_2 = v1_job_status_parseFromJSON(jsonv1_job_status_1);
	mazu_cJSON* jsonv1_job_status_2 = v1_job_status_convertToJSON(v1_job_status_2);
	printf("repeating v1_job_status:\n%s\n", mazu_cJSON_Print(jsonv1_job_status_2));
}

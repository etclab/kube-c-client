...
void test_v1_validation_rule(int include_optional) {
	...
	mazu_cJSON* jsonv1_validation_rule_1 = v1_validation_rule_convertToJSON(v1_validation_rule_1);
	printf("v1_validation_rule :\n%s\n", mazu_cJSON_Print(jsonv1_validation_rule_1));
	v1_validation_rule_t* v1_validation_rule_2 = v1_validation_rule_parseFromJSON(jsonv1_validation_rule_1);
	mazu_cJSON* jsonv1_validation_rule_2 = v1_validation_rule_convertToJSON(v1_validation_rule_2);
	printf("repeating v1_validation_rule:\n%s\n", mazu_cJSON_Print(jsonv1_validation_rule_2));
}

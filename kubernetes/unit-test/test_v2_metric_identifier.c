...
void test_v2_metric_identifier(int include_optional) {
	...
	mazu_cJSON* jsonv2_metric_identifier_1 = v2_metric_identifier_convertToJSON(v2_metric_identifier_1);
	printf("v2_metric_identifier :\n%s\n", mazu_cJSON_Print(jsonv2_metric_identifier_1));
	v2_metric_identifier_t* v2_metric_identifier_2 = v2_metric_identifier_parseFromJSON(jsonv2_metric_identifier_1);
	mazu_cJSON* jsonv2_metric_identifier_2 = v2_metric_identifier_convertToJSON(v2_metric_identifier_2);
	printf("repeating v2_metric_identifier:\n%s\n", mazu_cJSON_Print(jsonv2_metric_identifier_2));
}

...
void test_v1alpha3_device_attribute(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_device_attribute_1 = v1alpha3_device_attribute_convertToJSON(v1alpha3_device_attribute_1);
	printf("v1alpha3_device_attribute :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_attribute_1));
	...
	mazu_cJSON* jsonv1alpha3_device_attribute_2 = v1alpha3_device_attribute_convertToJSON(v1alpha3_device_attribute_2);
	printf("repeating v1alpha3_device_attribute:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_device_attribute_2));
}

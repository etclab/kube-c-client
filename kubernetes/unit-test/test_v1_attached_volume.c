...
void test_v1_attached_volume(int include_optional) {
	...
	mazu_cJSON* jsonv1_attached_volume_1 = v1_attached_volume_convertToJSON(v1_attached_volume_1);
	printf("v1_attached_volume :\n%s\n", mazu_cJSON_Print(jsonv1_attached_volume_1));
	v1_attached_volume_t* v1_attached_volume_2 = v1_attached_volume_parseFromJSON(jsonv1_attached_volume_1);
	mazu_cJSON* jsonv1_attached_volume_2 = v1_attached_volume_convertToJSON(v1_attached_volume_2);
	printf("repeating v1_attached_volume:\n%s\n", mazu_cJSON_Print(jsonv1_attached_volume_2));
}

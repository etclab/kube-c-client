...
void test_v1_validating_webhook_configuration(int include_optional) {
	...
	mazu_cJSON* jsonv1_validating_webhook_configuration_1 = v1_validating_webhook_configuration_convertToJSON(v1_validating_webhook_configuration_1);
	printf("v1_validating_webhook_configuration :\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_configuration_1));
	...
	mazu_cJSON* jsonv1_validating_webhook_configuration_2 = v1_validating_webhook_configuration_convertToJSON(v1_validating_webhook_configuration_2);
	printf("repeating v1_validating_webhook_configuration:\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_configuration_2));
}

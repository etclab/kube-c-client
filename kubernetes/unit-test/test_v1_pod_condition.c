...
void test_v1_pod_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_condition_1 = v1_pod_condition_convertToJSON(v1_pod_condition_1);
	printf("v1_pod_condition :\n%s\n", mazu_cJSON_Print(jsonv1_pod_condition_1));
	v1_pod_condition_t* v1_pod_condition_2 = v1_pod_condition_parseFromJSON(jsonv1_pod_condition_1);
	mazu_cJSON* jsonv1_pod_condition_2 = v1_pod_condition_convertToJSON(v1_pod_condition_2);
	printf("repeating v1_pod_condition:\n%s\n", mazu_cJSON_Print(jsonv1_pod_condition_2));
}

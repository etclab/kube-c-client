...
void test_v1_resource_claim(int include_optional) {
	...
	mazu_cJSON* jsonv1_resource_claim_1 = v1_resource_claim_convertToJSON(v1_resource_claim_1);
	printf("v1_resource_claim :\n%s\n", mazu_cJSON_Print(jsonv1_resource_claim_1));
	v1_resource_claim_t* v1_resource_claim_2 = v1_resource_claim_parseFromJSON(jsonv1_resource_claim_1);
	mazu_cJSON* jsonv1_resource_claim_2 = v1_resource_claim_convertToJSON(v1_resource_claim_2);
	printf("repeating v1_resource_claim:\n%s\n", mazu_cJSON_Print(jsonv1_resource_claim_2));
}

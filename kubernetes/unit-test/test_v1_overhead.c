...
void test_v1_overhead(int include_optional) {
	...
	mazu_cJSON* jsonv1_overhead_1 = v1_overhead_convertToJSON(v1_overhead_1);
	printf("v1_overhead :\n%s\n", mazu_cJSON_Print(jsonv1_overhead_1));
	v1_overhead_t* v1_overhead_2 = v1_overhead_parseFromJSON(jsonv1_overhead_1);
	mazu_cJSON* jsonv1_overhead_2 = v1_overhead_convertToJSON(v1_overhead_2);
	printf("repeating v1_overhead:\n%s\n", mazu_cJSON_Print(jsonv1_overhead_2));
}

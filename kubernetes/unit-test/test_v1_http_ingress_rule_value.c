...
void test_v1_http_ingress_rule_value(int include_optional) {
	...
	mazu_cJSON* jsonv1_http_ingress_rule_value_1 = v1_http_ingress_rule_value_convertToJSON(v1_http_ingress_rule_value_1);
	printf("v1_http_ingress_rule_value :\n%s\n", mazu_cJSON_Print(jsonv1_http_ingress_rule_value_1));
	...
	mazu_cJSON* jsonv1_http_ingress_rule_value_2 = v1_http_ingress_rule_value_convertToJSON(v1_http_ingress_rule_value_2);
	printf("repeating v1_http_ingress_rule_value:\n%s\n", mazu_cJSON_Print(jsonv1_http_ingress_rule_value_2));
}

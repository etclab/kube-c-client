...
void test_v1beta3_priority_level_configuration_status(int include_optional) {
	...
	mazu_cJSON* jsonv1beta3_priority_level_configuration_status_1 = v1beta3_priority_level_configuration_status_convertToJSON(v1beta3_priority_level_configuration_status_1);
	printf("v1beta3_priority_level_configuration_status :\n%s\n", mazu_cJSON_Print(jsonv1beta3_priority_level_configuration_status_1));
	...
	mazu_cJSON* jsonv1beta3_priority_level_configuration_status_2 = v1beta3_priority_level_configuration_status_convertToJSON(v1beta3_priority_level_configuration_status_2);
	printf("repeating v1beta3_priority_level_configuration_status:\n%s\n", mazu_cJSON_Print(jsonv1beta3_priority_level_configuration_status_2));
}

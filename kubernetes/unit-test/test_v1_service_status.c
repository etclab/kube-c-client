...
void test_v1_service_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_service_status_1 = v1_service_status_convertToJSON(v1_service_status_1);
	printf("v1_service_status :\n%s\n", mazu_cJSON_Print(jsonv1_service_status_1));
	v1_service_status_t* v1_service_status_2 = v1_service_status_parseFromJSON(jsonv1_service_status_1);
	mazu_cJSON* jsonv1_service_status_2 = v1_service_status_convertToJSON(v1_service_status_2);
	printf("repeating v1_service_status:\n%s\n", mazu_cJSON_Print(jsonv1_service_status_2));
}

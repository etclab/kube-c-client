#ifndef v1_endpoint_conditions_TEST
#define v1_endpoint_conditions_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1_endpoint_conditions_MAIN
#endif // TEST_MAIN
...
v1_endpoint_conditions_t* instantiate_v1_endpoint_conditions(int include_optional) {
  v1_endpoint_conditions_t* v1_endpoint_conditions = NULL;
  if (include_optional) {
    v1_endpoint_conditions = v1_endpoint_conditions_create(
      1,
      1,
      1
    );
  ...
  return v1_endpoint_conditions;
}


#ifdef v1_endpoint_conditions_MAIN
...
int main() {
  test_v1_endpoint_conditions(1);
  test_v1_endpoint_conditions(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1_endpoint_conditions_MAIN
#endif // v1_endpoint_conditions_TEST

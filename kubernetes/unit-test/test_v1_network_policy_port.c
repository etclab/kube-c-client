...
void test_v1_network_policy_port(int include_optional) {
	...
	mazu_cJSON* jsonv1_network_policy_port_1 = v1_network_policy_port_convertToJSON(v1_network_policy_port_1);
	printf("v1_network_policy_port :\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_port_1));
	v1_network_policy_port_t* v1_network_policy_port_2 = v1_network_policy_port_parseFromJSON(jsonv1_network_policy_port_1);
	mazu_cJSON* jsonv1_network_policy_port_2 = v1_network_policy_port_convertToJSON(v1_network_policy_port_2);
	printf("repeating v1_network_policy_port:\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_port_2));
}

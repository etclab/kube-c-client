...
void test_v1_webhook_conversion(int include_optional) {
	...
	mazu_cJSON* jsonv1_webhook_conversion_1 = v1_webhook_conversion_convertToJSON(v1_webhook_conversion_1);
	printf("v1_webhook_conversion :\n%s\n", mazu_cJSON_Print(jsonv1_webhook_conversion_1));
	v1_webhook_conversion_t* v1_webhook_conversion_2 = v1_webhook_conversion_parseFromJSON(jsonv1_webhook_conversion_1);
	mazu_cJSON* jsonv1_webhook_conversion_2 = v1_webhook_conversion_convertToJSON(v1_webhook_conversion_2);
	printf("repeating v1_webhook_conversion:\n%s\n", mazu_cJSON_Print(jsonv1_webhook_conversion_2));
}

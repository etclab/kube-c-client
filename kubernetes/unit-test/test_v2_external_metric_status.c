...
void test_v2_external_metric_status(int include_optional) {
	...
	mazu_cJSON* jsonv2_external_metric_status_1 = v2_external_metric_status_convertToJSON(v2_external_metric_status_1);
	printf("v2_external_metric_status :\n%s\n", mazu_cJSON_Print(jsonv2_external_metric_status_1));
	...
	mazu_cJSON* jsonv2_external_metric_status_2 = v2_external_metric_status_convertToJSON(v2_external_metric_status_2);
	printf("repeating v2_external_metric_status:\n%s\n", mazu_cJSON_Print(jsonv2_external_metric_status_2));
}

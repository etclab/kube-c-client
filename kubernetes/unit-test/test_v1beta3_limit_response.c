#ifndef v1beta3_limit_response_TEST
#define v1beta3_limit_response_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1beta3_limit_response_MAIN
#endif // TEST_MAIN
...
#include "test_v1beta3_queuing_configuration.c"


v1beta3_limit_response_t* instantiate_v1beta3_limit_response(int include_optional) {
  v1beta3_limit_response_t* v1beta3_limit_response = NULL;
  if (include_optional) {
    v1beta3_limit_response = v1beta3_limit_response_create(
       // false, not to have infinite recursion
      instantiate_v1beta3_queuing_configuration(0),
      "0"
    );
  } else {
    v1beta3_limit_response = v1beta3_limit_response_create(
  ...
  return v1beta3_limit_response;
}


#ifdef v1beta3_limit_response_MAIN
...
int main() {
  test_v1beta3_limit_response(1);
  test_v1beta3_limit_response(0);

...
void test_v1_role_binding(int include_optional) {
	...
	mazu_cJSON* jsonv1_role_binding_1 = v1_role_binding_convertToJSON(v1_role_binding_1);
	printf("v1_role_binding :\n%s\n", mazu_cJSON_Print(jsonv1_role_binding_1));
	v1_role_binding_t* v1_role_binding_2 = v1_role_binding_parseFromJSON(jsonv1_role_binding_1);
	mazu_cJSON* jsonv1_role_binding_2 = v1_role_binding_convertToJSON(v1_role_binding_2);
	printf("repeating v1_role_binding:\n%s\n", mazu_cJSON_Print(jsonv1_role_binding_2));
}

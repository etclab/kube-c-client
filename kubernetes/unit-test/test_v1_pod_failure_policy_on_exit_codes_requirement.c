...
void test_v1_pod_failure_policy_on_exit_codes_requirement(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_failure_policy_on_exit_codes_requirement_1 = v1_pod_failure_policy_on_exit_codes_requirement_convertToJSON(v1_pod_failure_policy_on_exit_codes_requirement_1);
	printf("v1_pod_failure_policy_on_exit_codes_requirement :\n%s\n", mazu_cJSON_Print(jsonv1_pod_failure_policy_on_exit_codes_requirement_1));
	...
	mazu_cJSON* jsonv1_pod_failure_policy_on_exit_codes_requirement_2 = v1_pod_failure_policy_on_exit_codes_requirement_convertToJSON(v1_pod_failure_policy_on_exit_codes_requirement_2);
	printf("repeating v1_pod_failure_policy_on_exit_codes_requirement:\n%s\n", mazu_cJSON_Print(jsonv1_pod_failure_policy_on_exit_codes_requirement_2));
}

...
void test_v2_metric_spec(int include_optional) {
	...
	mazu_cJSON* jsonv2_metric_spec_1 = v2_metric_spec_convertToJSON(v2_metric_spec_1);
	printf("v2_metric_spec :\n%s\n", mazu_cJSON_Print(jsonv2_metric_spec_1));
	v2_metric_spec_t* v2_metric_spec_2 = v2_metric_spec_parseFromJSON(jsonv2_metric_spec_1);
	mazu_cJSON* jsonv2_metric_spec_2 = v2_metric_spec_convertToJSON(v2_metric_spec_2);
	printf("repeating v2_metric_spec:\n%s\n", mazu_cJSON_Print(jsonv2_metric_spec_2));
}

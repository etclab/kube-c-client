...
void test_v1_pod_anti_affinity(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_anti_affinity_1 = v1_pod_anti_affinity_convertToJSON(v1_pod_anti_affinity_1);
	printf("v1_pod_anti_affinity :\n%s\n", mazu_cJSON_Print(jsonv1_pod_anti_affinity_1));
	v1_pod_anti_affinity_t* v1_pod_anti_affinity_2 = v1_pod_anti_affinity_parseFromJSON(jsonv1_pod_anti_affinity_1);
	mazu_cJSON* jsonv1_pod_anti_affinity_2 = v1_pod_anti_affinity_convertToJSON(v1_pod_anti_affinity_2);
	printf("repeating v1_pod_anti_affinity:\n%s\n", mazu_cJSON_Print(jsonv1_pod_anti_affinity_2));
}

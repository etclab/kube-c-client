...
void test_v1_eviction(int include_optional) {
	...
	mazu_cJSON* jsonv1_eviction_1 = v1_eviction_convertToJSON(v1_eviction_1);
	printf("v1_eviction :\n%s\n", mazu_cJSON_Print(jsonv1_eviction_1));
	v1_eviction_t* v1_eviction_2 = v1_eviction_parseFromJSON(jsonv1_eviction_1);
	mazu_cJSON* jsonv1_eviction_2 = v1_eviction_convertToJSON(v1_eviction_2);
	printf("repeating v1_eviction:\n%s\n", mazu_cJSON_Print(jsonv1_eviction_2));
}

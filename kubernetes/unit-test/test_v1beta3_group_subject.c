...
void test_v1beta3_group_subject(int include_optional) {
	...
	mazu_cJSON* jsonv1beta3_group_subject_1 = v1beta3_group_subject_convertToJSON(v1beta3_group_subject_1);
	printf("v1beta3_group_subject :\n%s\n", mazu_cJSON_Print(jsonv1beta3_group_subject_1));
	v1beta3_group_subject_t* v1beta3_group_subject_2 = v1beta3_group_subject_parseFromJSON(jsonv1beta3_group_subject_1);
	mazu_cJSON* jsonv1beta3_group_subject_2 = v1beta3_group_subject_convertToJSON(v1beta3_group_subject_2);
	printf("repeating v1beta3_group_subject:\n%s\n", mazu_cJSON_Print(jsonv1beta3_group_subject_2));
}

#ifndef v1beta3_flow_distinguisher_method_TEST
#define v1beta3_flow_distinguisher_method_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1beta3_flow_distinguisher_method_MAIN
#endif // TEST_MAIN
...
v1beta3_flow_distinguisher_method_t* instantiate_v1beta3_flow_distinguisher_method(int include_optional) {
  v1beta3_flow_distinguisher_method_t* v1beta3_flow_distinguisher_method = NULL;
  if (include_optional) {
    v1beta3_flow_distinguisher_method = v1beta3_flow_distinguisher_method_create(
      "0"
    );
  } else {
    v1beta3_flow_distinguisher_method = v1beta3_flow_distinguisher_method_create(
  ...
  return v1beta3_flow_distinguisher_method;
}


#ifdef v1beta3_flow_distinguisher_method_MAIN
...
int main() {
  test_v1beta3_flow_distinguisher_method(1);
  test_v1beta3_flow_distinguisher_method(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1beta3_flow_distinguisher_method_MAIN
#endif // v1beta3_flow_distinguisher_method_TEST

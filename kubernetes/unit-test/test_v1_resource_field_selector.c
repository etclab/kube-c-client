...
void test_v1_resource_field_selector(int include_optional) {
	...
	mazu_cJSON* jsonv1_resource_field_selector_1 = v1_resource_field_selector_convertToJSON(v1_resource_field_selector_1);
	printf("v1_resource_field_selector :\n%s\n", mazu_cJSON_Print(jsonv1_resource_field_selector_1));
	...
	mazu_cJSON* jsonv1_resource_field_selector_2 = v1_resource_field_selector_convertToJSON(v1_resource_field_selector_2);
	printf("repeating v1_resource_field_selector:\n%s\n", mazu_cJSON_Print(jsonv1_resource_field_selector_2));
}

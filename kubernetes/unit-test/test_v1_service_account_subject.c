...
void test_v1_service_account_subject(int include_optional) {
	...
	mazu_cJSON* jsonv1_service_account_subject_1 = v1_service_account_subject_convertToJSON(v1_service_account_subject_1);
	printf("v1_service_account_subject :\n%s\n", mazu_cJSON_Print(jsonv1_service_account_subject_1));
	...
	mazu_cJSON* jsonv1_service_account_subject_2 = v1_service_account_subject_convertToJSON(v1_service_account_subject_2);
	printf("repeating v1_service_account_subject:\n%s\n", mazu_cJSON_Print(jsonv1_service_account_subject_2));
}

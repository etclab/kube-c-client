...
void test_v1_cluster_trust_bundle_projection(int include_optional) {
	...
	mazu_cJSON* jsonv1_cluster_trust_bundle_projection_1 = v1_cluster_trust_bundle_projection_convertToJSON(v1_cluster_trust_bundle_projection_1);
	printf("v1_cluster_trust_bundle_projection :\n%s\n", mazu_cJSON_Print(jsonv1_cluster_trust_bundle_projection_1));
	...
	mazu_cJSON* jsonv1_cluster_trust_bundle_projection_2 = v1_cluster_trust_bundle_projection_convertToJSON(v1_cluster_trust_bundle_projection_2);
	printf("repeating v1_cluster_trust_bundle_projection:\n%s\n", mazu_cJSON_Print(jsonv1_cluster_trust_bundle_projection_2));
}

...
void test_v1_success_policy(int include_optional) {
	...
	mazu_cJSON* jsonv1_success_policy_1 = v1_success_policy_convertToJSON(v1_success_policy_1);
	printf("v1_success_policy :\n%s\n", mazu_cJSON_Print(jsonv1_success_policy_1));
	v1_success_policy_t* v1_success_policy_2 = v1_success_policy_parseFromJSON(jsonv1_success_policy_1);
	mazu_cJSON* jsonv1_success_policy_2 = v1_success_policy_convertToJSON(v1_success_policy_2);
	printf("repeating v1_success_policy:\n%s\n", mazu_cJSON_Print(jsonv1_success_policy_2));
}

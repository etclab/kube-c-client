...
void test_v1_node_daemon_endpoints(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_daemon_endpoints_1 = v1_node_daemon_endpoints_convertToJSON(v1_node_daemon_endpoints_1);
	printf("v1_node_daemon_endpoints :\n%s\n", mazu_cJSON_Print(jsonv1_node_daemon_endpoints_1));
	...
	mazu_cJSON* jsonv1_node_daemon_endpoints_2 = v1_node_daemon_endpoints_convertToJSON(v1_node_daemon_endpoints_2);
	printf("repeating v1_node_daemon_endpoints:\n%s\n", mazu_cJSON_Print(jsonv1_node_daemon_endpoints_2));
}

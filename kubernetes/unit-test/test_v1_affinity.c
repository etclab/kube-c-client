...
void test_v1_affinity(int include_optional) {
	...
	mazu_cJSON* jsonv1_affinity_1 = v1_affinity_convertToJSON(v1_affinity_1);
	printf("v1_affinity :\n%s\n", mazu_cJSON_Print(jsonv1_affinity_1));
	v1_affinity_t* v1_affinity_2 = v1_affinity_parseFromJSON(jsonv1_affinity_1);
	mazu_cJSON* jsonv1_affinity_2 = v1_affinity_convertToJSON(v1_affinity_2);
	printf("repeating v1_affinity:\n%s\n", mazu_cJSON_Print(jsonv1_affinity_2));
}

...
void test_v1_validating_admission_policy_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_validating_admission_policy_spec_1 = v1_validating_admission_policy_spec_convertToJSON(v1_validating_admission_policy_spec_1);
	printf("v1_validating_admission_policy_spec :\n%s\n", mazu_cJSON_Print(jsonv1_validating_admission_policy_spec_1));
	...
	mazu_cJSON* jsonv1_validating_admission_policy_spec_2 = v1_validating_admission_policy_spec_convertToJSON(v1_validating_admission_policy_spec_2);
	printf("repeating v1_validating_admission_policy_spec:\n%s\n", mazu_cJSON_Print(jsonv1_validating_admission_policy_spec_2));
}

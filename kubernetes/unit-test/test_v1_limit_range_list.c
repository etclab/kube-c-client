...
void test_v1_limit_range_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_limit_range_list_1 = v1_limit_range_list_convertToJSON(v1_limit_range_list_1);
	printf("v1_limit_range_list :\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_list_1));
	v1_limit_range_list_t* v1_limit_range_list_2 = v1_limit_range_list_parseFromJSON(jsonv1_limit_range_list_1);
	mazu_cJSON* jsonv1_limit_range_list_2 = v1_limit_range_list_convertToJSON(v1_limit_range_list_2);
	printf("repeating v1_limit_range_list:\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_list_2));
}

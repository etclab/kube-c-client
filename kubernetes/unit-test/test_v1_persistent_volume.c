...
void test_v1_persistent_volume(int include_optional) {
	...
	mazu_cJSON* jsonv1_persistent_volume_1 = v1_persistent_volume_convertToJSON(v1_persistent_volume_1);
	printf("v1_persistent_volume :\n%s\n", mazu_cJSON_Print(jsonv1_persistent_volume_1));
	v1_persistent_volume_t* v1_persistent_volume_2 = v1_persistent_volume_parseFromJSON(jsonv1_persistent_volume_1);
	mazu_cJSON* jsonv1_persistent_volume_2 = v1_persistent_volume_convertToJSON(v1_persistent_volume_2);
	printf("repeating v1_persistent_volume:\n%s\n", mazu_cJSON_Print(jsonv1_persistent_volume_2));
}

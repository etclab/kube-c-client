...
void test_v1_scheduling(int include_optional) {
	...
	mazu_cJSON* jsonv1_scheduling_1 = v1_scheduling_convertToJSON(v1_scheduling_1);
	printf("v1_scheduling :\n%s\n", mazu_cJSON_Print(jsonv1_scheduling_1));
	v1_scheduling_t* v1_scheduling_2 = v1_scheduling_parseFromJSON(jsonv1_scheduling_1);
	mazu_cJSON* jsonv1_scheduling_2 = v1_scheduling_convertToJSON(v1_scheduling_2);
	printf("repeating v1_scheduling:\n%s\n", mazu_cJSON_Print(jsonv1_scheduling_2));
}

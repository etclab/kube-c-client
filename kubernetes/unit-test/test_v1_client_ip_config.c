...
void test_v1_client_ip_config(int include_optional) {
	...
	mazu_cJSON* jsonv1_client_ip_config_1 = v1_client_ip_config_convertToJSON(v1_client_ip_config_1);
	printf("v1_client_ip_config :\n%s\n", mazu_cJSON_Print(jsonv1_client_ip_config_1));
	v1_client_ip_config_t* v1_client_ip_config_2 = v1_client_ip_config_parseFromJSON(jsonv1_client_ip_config_1);
	mazu_cJSON* jsonv1_client_ip_config_2 = v1_client_ip_config_convertToJSON(v1_client_ip_config_2);
	printf("repeating v1_client_ip_config:\n%s\n", mazu_cJSON_Print(jsonv1_client_ip_config_2));
}

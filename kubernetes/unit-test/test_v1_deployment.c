...
void test_v1_deployment(int include_optional) {
	...
	mazu_cJSON* jsonv1_deployment_1 = v1_deployment_convertToJSON(v1_deployment_1);
	printf("v1_deployment :\n%s\n", mazu_cJSON_Print(jsonv1_deployment_1));
	v1_deployment_t* v1_deployment_2 = v1_deployment_parseFromJSON(jsonv1_deployment_1);
	mazu_cJSON* jsonv1_deployment_2 = v1_deployment_convertToJSON(v1_deployment_2);
	printf("repeating v1_deployment:\n%s\n", mazu_cJSON_Print(jsonv1_deployment_2));
}

...
void test_v1_sleep_action(int include_optional) {
	...
	mazu_cJSON* jsonv1_sleep_action_1 = v1_sleep_action_convertToJSON(v1_sleep_action_1);
	printf("v1_sleep_action :\n%s\n", mazu_cJSON_Print(jsonv1_sleep_action_1));
	v1_sleep_action_t* v1_sleep_action_2 = v1_sleep_action_parseFromJSON(jsonv1_sleep_action_1);
	mazu_cJSON* jsonv1_sleep_action_2 = v1_sleep_action_convertToJSON(v1_sleep_action_2);
	printf("repeating v1_sleep_action:\n%s\n", mazu_cJSON_Print(jsonv1_sleep_action_2));
}

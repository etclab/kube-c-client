...
void test_v1_secret_projection(int include_optional) {
	...
	mazu_cJSON* jsonv1_secret_projection_1 = v1_secret_projection_convertToJSON(v1_secret_projection_1);
	printf("v1_secret_projection :\n%s\n", mazu_cJSON_Print(jsonv1_secret_projection_1));
	v1_secret_projection_t* v1_secret_projection_2 = v1_secret_projection_parseFromJSON(jsonv1_secret_projection_1);
	mazu_cJSON* jsonv1_secret_projection_2 = v1_secret_projection_convertToJSON(v1_secret_projection_2);
	printf("repeating v1_secret_projection:\n%s\n", mazu_cJSON_Print(jsonv1_secret_projection_2));
}

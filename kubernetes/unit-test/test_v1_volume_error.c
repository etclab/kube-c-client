...
void test_v1_volume_error(int include_optional) {
	...
	mazu_cJSON* jsonv1_volume_error_1 = v1_volume_error_convertToJSON(v1_volume_error_1);
	printf("v1_volume_error :\n%s\n", mazu_cJSON_Print(jsonv1_volume_error_1));
	v1_volume_error_t* v1_volume_error_2 = v1_volume_error_parseFromJSON(jsonv1_volume_error_1);
	mazu_cJSON* jsonv1_volume_error_2 = v1_volume_error_convertToJSON(v1_volume_error_2);
	printf("repeating v1_volume_error:\n%s\n", mazu_cJSON_Print(jsonv1_volume_error_2));
}

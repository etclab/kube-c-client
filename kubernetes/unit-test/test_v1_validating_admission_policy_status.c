...
void test_v1_validating_admission_policy_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_validating_admission_policy_status_1 = v1_validating_admission_policy_status_convertToJSON(v1_validating_admission_policy_status_1);
	printf("v1_validating_admission_policy_status :\n%s\n", mazu_cJSON_Print(jsonv1_validating_admission_policy_status_1));
	...
	mazu_cJSON* jsonv1_validating_admission_policy_status_2 = v1_validating_admission_policy_status_convertToJSON(v1_validating_admission_policy_status_2);
	printf("repeating v1_validating_admission_policy_status:\n%s\n", mazu_cJSON_Print(jsonv1_validating_admission_policy_status_2));
}

...
void test_v1_tcp_socket_action(int include_optional) {
	...
	mazu_cJSON* jsonv1_tcp_socket_action_1 = v1_tcp_socket_action_convertToJSON(v1_tcp_socket_action_1);
	printf("v1_tcp_socket_action :\n%s\n", mazu_cJSON_Print(jsonv1_tcp_socket_action_1));
	v1_tcp_socket_action_t* v1_tcp_socket_action_2 = v1_tcp_socket_action_parseFromJSON(jsonv1_tcp_socket_action_1);
	mazu_cJSON* jsonv1_tcp_socket_action_2 = v1_tcp_socket_action_convertToJSON(v1_tcp_socket_action_2);
	printf("repeating v1_tcp_socket_action:\n%s\n", mazu_cJSON_Print(jsonv1_tcp_socket_action_2));
}

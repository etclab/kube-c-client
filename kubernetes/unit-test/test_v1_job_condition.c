...
void test_v1_job_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_job_condition_1 = v1_job_condition_convertToJSON(v1_job_condition_1);
	printf("v1_job_condition :\n%s\n", mazu_cJSON_Print(jsonv1_job_condition_1));
	v1_job_condition_t* v1_job_condition_2 = v1_job_condition_parseFromJSON(jsonv1_job_condition_1);
	mazu_cJSON* jsonv1_job_condition_2 = v1_job_condition_convertToJSON(v1_job_condition_2);
	printf("repeating v1_job_condition:\n%s\n", mazu_cJSON_Print(jsonv1_job_condition_2));
}

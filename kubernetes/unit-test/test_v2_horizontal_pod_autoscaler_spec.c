...
void test_v2_horizontal_pod_autoscaler_spec(int include_optional) {
	...
	mazu_cJSON* jsonv2_horizontal_pod_autoscaler_spec_1 = v2_horizontal_pod_autoscaler_spec_convertToJSON(v2_horizontal_pod_autoscaler_spec_1);
	printf("v2_horizontal_pod_autoscaler_spec :\n%s\n", mazu_cJSON_Print(jsonv2_horizontal_pod_autoscaler_spec_1));
	...
	mazu_cJSON* jsonv2_horizontal_pod_autoscaler_spec_2 = v2_horizontal_pod_autoscaler_spec_convertToJSON(v2_horizontal_pod_autoscaler_spec_2);
	printf("repeating v2_horizontal_pod_autoscaler_spec:\n%s\n", mazu_cJSON_Print(jsonv2_horizontal_pod_autoscaler_spec_2));
}

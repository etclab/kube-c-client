...
void test_v1_network_policy_egress_rule(int include_optional) {
	...
	mazu_cJSON* jsonv1_network_policy_egress_rule_1 = v1_network_policy_egress_rule_convertToJSON(v1_network_policy_egress_rule_1);
	printf("v1_network_policy_egress_rule :\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_egress_rule_1));
	...
	mazu_cJSON* jsonv1_network_policy_egress_rule_2 = v1_network_policy_egress_rule_convertToJSON(v1_network_policy_egress_rule_2);
	printf("repeating v1_network_policy_egress_rule:\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_egress_rule_2));
}

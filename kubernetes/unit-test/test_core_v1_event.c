...
void test_core_v1_event(int include_optional) {
	...
	mazu_cJSON* jsoncore_v1_event_1 = core_v1_event_convertToJSON(core_v1_event_1);
	printf("core_v1_event :\n%s\n", mazu_cJSON_Print(jsoncore_v1_event_1));
	core_v1_event_t* core_v1_event_2 = core_v1_event_parseFromJSON(jsoncore_v1_event_1);
	mazu_cJSON* jsoncore_v1_event_2 = core_v1_event_convertToJSON(core_v1_event_2);
	printf("repeating core_v1_event:\n%s\n", mazu_cJSON_Print(jsoncore_v1_event_2));
}

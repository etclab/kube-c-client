...
void test_v1_service_account(int include_optional) {
	...
	mazu_cJSON* jsonv1_service_account_1 = v1_service_account_convertToJSON(v1_service_account_1);
	printf("v1_service_account :\n%s\n", mazu_cJSON_Print(jsonv1_service_account_1));
	v1_service_account_t* v1_service_account_2 = v1_service_account_parseFromJSON(jsonv1_service_account_1);
	mazu_cJSON* jsonv1_service_account_2 = v1_service_account_convertToJSON(v1_service_account_2);
	printf("repeating v1_service_account:\n%s\n", mazu_cJSON_Print(jsonv1_service_account_2));
}

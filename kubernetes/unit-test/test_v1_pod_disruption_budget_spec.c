...
void test_v1_pod_disruption_budget_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_disruption_budget_spec_1 = v1_pod_disruption_budget_spec_convertToJSON(v1_pod_disruption_budget_spec_1);
	printf("v1_pod_disruption_budget_spec :\n%s\n", mazu_cJSON_Print(jsonv1_pod_disruption_budget_spec_1));
	...
	mazu_cJSON* jsonv1_pod_disruption_budget_spec_2 = v1_pod_disruption_budget_spec_convertToJSON(v1_pod_disruption_budget_spec_2);
	printf("repeating v1_pod_disruption_budget_spec:\n%s\n", mazu_cJSON_Print(jsonv1_pod_disruption_budget_spec_2));
}

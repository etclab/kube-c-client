...
void test_v1_pod_os(int include_optional) {
	...
	mazu_cJSON* jsonv1_pod_os_1 = v1_pod_os_convertToJSON(v1_pod_os_1);
	printf("v1_pod_os :\n%s\n", mazu_cJSON_Print(jsonv1_pod_os_1));
	v1_pod_os_t* v1_pod_os_2 = v1_pod_os_parseFromJSON(jsonv1_pod_os_1);
	mazu_cJSON* jsonv1_pod_os_2 = v1_pod_os_convertToJSON(v1_pod_os_2);
	printf("repeating v1_pod_os:\n%s\n", mazu_cJSON_Print(jsonv1_pod_os_2));
}

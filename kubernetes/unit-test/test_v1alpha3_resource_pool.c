...
void test_v1alpha3_resource_pool(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_resource_pool_1 = v1alpha3_resource_pool_convertToJSON(v1alpha3_resource_pool_1);
	printf("v1alpha3_resource_pool :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_pool_1));
	v1alpha3_resource_pool_t* v1alpha3_resource_pool_2 = v1alpha3_resource_pool_parseFromJSON(jsonv1alpha3_resource_pool_1);
	mazu_cJSON* jsonv1alpha3_resource_pool_2 = v1alpha3_resource_pool_convertToJSON(v1alpha3_resource_pool_2);
	printf("repeating v1alpha3_resource_pool:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_pool_2));
}

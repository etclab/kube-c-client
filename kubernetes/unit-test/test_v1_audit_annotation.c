...
void test_v1_audit_annotation(int include_optional) {
	...
	mazu_cJSON* jsonv1_audit_annotation_1 = v1_audit_annotation_convertToJSON(v1_audit_annotation_1);
	printf("v1_audit_annotation :\n%s\n", mazu_cJSON_Print(jsonv1_audit_annotation_1));
	v1_audit_annotation_t* v1_audit_annotation_2 = v1_audit_annotation_parseFromJSON(jsonv1_audit_annotation_1);
	mazu_cJSON* jsonv1_audit_annotation_2 = v1_audit_annotation_convertToJSON(v1_audit_annotation_2);
	printf("repeating v1_audit_annotation:\n%s\n", mazu_cJSON_Print(jsonv1_audit_annotation_2));
}

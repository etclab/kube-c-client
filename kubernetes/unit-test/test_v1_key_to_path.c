...
void test_v1_key_to_path(int include_optional) {
	...
	mazu_cJSON* jsonv1_key_to_path_1 = v1_key_to_path_convertToJSON(v1_key_to_path_1);
	printf("v1_key_to_path :\n%s\n", mazu_cJSON_Print(jsonv1_key_to_path_1));
	v1_key_to_path_t* v1_key_to_path_2 = v1_key_to_path_parseFromJSON(jsonv1_key_to_path_1);
	mazu_cJSON* jsonv1_key_to_path_2 = v1_key_to_path_convertToJSON(v1_key_to_path_2);
	printf("repeating v1_key_to_path:\n%s\n", mazu_cJSON_Print(jsonv1_key_to_path_2));
}

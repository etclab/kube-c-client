...
void test_v1_resource_requirements(int include_optional) {
	...
	mazu_cJSON* jsonv1_resource_requirements_1 = v1_resource_requirements_convertToJSON(v1_resource_requirements_1);
	printf("v1_resource_requirements :\n%s\n", mazu_cJSON_Print(jsonv1_resource_requirements_1));
	...
	mazu_cJSON* jsonv1_resource_requirements_2 = v1_resource_requirements_convertToJSON(v1_resource_requirements_2);
	printf("repeating v1_resource_requirements:\n%s\n", mazu_cJSON_Print(jsonv1_resource_requirements_2));
}

...
void test_v1_stateful_set_persistent_volume_claim_retention_policy(int include_optional) {
	...
	mazu_cJSON* jsonv1_stateful_set_persistent_volume_claim_retention_policy_1 = v1_stateful_set_persistent_volume_claim_retention_policy_convertToJSON(v1_stateful_set_persistent_volume_claim_retention_policy_1);
	printf("v1_stateful_set_persistent_volume_claim_retention_policy :\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_persistent_volume_claim_retention_policy_1));
	...
	mazu_cJSON* jsonv1_stateful_set_persistent_volume_claim_retention_policy_2 = v1_stateful_set_persistent_volume_claim_retention_policy_convertToJSON(v1_stateful_set_persistent_volume_claim_retention_policy_2);
	printf("repeating v1_stateful_set_persistent_volume_claim_retention_policy:\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_persistent_volume_claim_retention_policy_2));
}

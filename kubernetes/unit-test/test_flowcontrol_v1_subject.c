#ifndef flowcontrol_v1_subject_TEST
#define flowcontrol_v1_subject_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define flowcontrol_v1_subject_MAIN
#endif // TEST_MAIN
...
#include "test_v1_group_subject.c"
#include "test_v1_service_account_subject.c"
#include "test_v1_user_subject.c"


flowcontrol_v1_subject_t* instantiate_flowcontrol_v1_subject(int include_optional) {
  flowcontrol_v1_subject_t* flowcontrol_v1_subject = NULL;
  if (include_optional) {
    flowcontrol_v1_subject = flowcontrol_v1_subject_create(
       // false, not to have infinite recursion
      instantiate_v1_group_subject(0),
      "0",
       // false, not to have infinite recursion
      instantiate_v1_service_account_subject(0),
       // false, not to have infinite recursion
      instantiate_v1_user_subject(0)
    );
  } else {
    flowcontrol_v1_subject = flowcontrol_v1_subject_create(
      NULL,
  ...
  return flowcontrol_v1_subject;
}


#ifdef flowcontrol_v1_subject_MAIN
...
int main() {
  test_flowcontrol_v1_subject(1);
  test_flowcontrol_v1_subject(0);

  printf("Hello world \n");
  return 0;
}

#endif // flowcontrol_v1_subject_MAIN
#endif // flowcontrol_v1_subject_TEST

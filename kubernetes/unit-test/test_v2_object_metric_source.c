#ifndef v2_object_metric_source_TEST
#define v2_object_metric_source_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v2_object_metric_source_MAIN
#endif // TEST_MAIN
...
v2_object_metric_source_t* instantiate_v2_object_metric_source(int include_optional) {
  v2_object_metric_source_t* v2_object_metric_source = NULL;
  if (include_optional) {
    v2_object_metric_source = v2_object_metric_source_create(
  ...
  return v2_object_metric_source;
}


#ifdef v2_object_metric_source_MAIN
...
int main() {
  test_v2_object_metric_source(1);
  test_v2_object_metric_source(0);

  printf("Hello world \n");
  return 0;
}

#endif // v2_object_metric_source_MAIN
#endif // v2_object_metric_source_TEST

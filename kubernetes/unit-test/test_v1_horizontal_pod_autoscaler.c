...
void test_v1_horizontal_pod_autoscaler(int include_optional) {
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_1 = v1_horizontal_pod_autoscaler_convertToJSON(v1_horizontal_pod_autoscaler_1);
	printf("v1_horizontal_pod_autoscaler :\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_1));
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_2 = v1_horizontal_pod_autoscaler_convertToJSON(v1_horizontal_pod_autoscaler_2);
	printf("repeating v1_horizontal_pod_autoscaler:\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_2));
}

...
void test_v1_user_subject(int include_optional) {
	...
	mazu_cJSON* jsonv1_user_subject_1 = v1_user_subject_convertToJSON(v1_user_subject_1);
	printf("v1_user_subject :\n%s\n", mazu_cJSON_Print(jsonv1_user_subject_1));
	v1_user_subject_t* v1_user_subject_2 = v1_user_subject_parseFromJSON(jsonv1_user_subject_1);
	mazu_cJSON* jsonv1_user_subject_2 = v1_user_subject_convertToJSON(v1_user_subject_2);
	printf("repeating v1_user_subject:\n%s\n", mazu_cJSON_Print(jsonv1_user_subject_2));
}

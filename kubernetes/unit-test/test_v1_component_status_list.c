...
void test_v1_component_status_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_component_status_list_1 = v1_component_status_list_convertToJSON(v1_component_status_list_1);
	printf("v1_component_status_list :\n%s\n", mazu_cJSON_Print(jsonv1_component_status_list_1));
	...
	mazu_cJSON* jsonv1_component_status_list_2 = v1_component_status_list_convertToJSON(v1_component_status_list_2);
	printf("repeating v1_component_status_list:\n%s\n", mazu_cJSON_Print(jsonv1_component_status_list_2));
}

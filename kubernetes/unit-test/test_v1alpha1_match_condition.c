...
void test_v1alpha1_match_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_match_condition_1 = v1alpha1_match_condition_convertToJSON(v1alpha1_match_condition_1);
	printf("v1alpha1_match_condition :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_match_condition_1));
	...
	mazu_cJSON* jsonv1alpha1_match_condition_2 = v1alpha1_match_condition_convertToJSON(v1alpha1_match_condition_2);
	printf("repeating v1alpha1_match_condition:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_match_condition_2));
}

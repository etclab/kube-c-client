...
void test_v1_stateful_set_update_strategy(int include_optional) {
	...
	mazu_cJSON* jsonv1_stateful_set_update_strategy_1 = v1_stateful_set_update_strategy_convertToJSON(v1_stateful_set_update_strategy_1);
	printf("v1_stateful_set_update_strategy :\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_update_strategy_1));
	...
	mazu_cJSON* jsonv1_stateful_set_update_strategy_2 = v1_stateful_set_update_strategy_convertToJSON(v1_stateful_set_update_strategy_2);
	printf("repeating v1_stateful_set_update_strategy:\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_update_strategy_2));
}

...
void test_v1_projected_volume_source(int include_optional) {
	...
	mazu_cJSON* jsonv1_projected_volume_source_1 = v1_projected_volume_source_convertToJSON(v1_projected_volume_source_1);
	printf("v1_projected_volume_source :\n%s\n", mazu_cJSON_Print(jsonv1_projected_volume_source_1));
	...
	mazu_cJSON* jsonv1_projected_volume_source_2 = v1_projected_volume_source_convertToJSON(v1_projected_volume_source_2);
	printf("repeating v1_projected_volume_source:\n%s\n", mazu_cJSON_Print(jsonv1_projected_volume_source_2));
}

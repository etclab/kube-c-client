...
void test_v1_grpc_action(int include_optional) {
	...
	mazu_cJSON* jsonv1_grpc_action_1 = v1_grpc_action_convertToJSON(v1_grpc_action_1);
	printf("v1_grpc_action :\n%s\n", mazu_cJSON_Print(jsonv1_grpc_action_1));
	v1_grpc_action_t* v1_grpc_action_2 = v1_grpc_action_parseFromJSON(jsonv1_grpc_action_1);
	mazu_cJSON* jsonv1_grpc_action_2 = v1_grpc_action_convertToJSON(v1_grpc_action_2);
	printf("repeating v1_grpc_action:\n%s\n", mazu_cJSON_Print(jsonv1_grpc_action_2));
}

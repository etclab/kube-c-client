#ifndef v1beta3_priority_level_configuration_reference_TEST
#define v1beta3_priority_level_configuration_reference_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1beta3_priority_level_configuration_reference_MAIN
#endif // TEST_MAIN
...
v1beta3_priority_level_configuration_reference_t* instantiate_v1beta3_priority_level_configuration_reference(int include_optional) {
  v1beta3_priority_level_configuration_reference_t* v1beta3_priority_level_configuration_reference = NULL;
  if (include_optional) {
    v1beta3_priority_level_configuration_reference = v1beta3_priority_level_configuration_reference_create(
      "0"
    );
  } else {
    v1beta3_priority_level_configuration_reference = v1beta3_priority_level_configuration_reference_create(
  ...
  return v1beta3_priority_level_configuration_reference;
}


#ifdef v1beta3_priority_level_configuration_reference_MAIN
...
int main() {
  test_v1beta3_priority_level_configuration_reference(1);
  test_v1beta3_priority_level_configuration_reference(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1beta3_priority_level_configuration_reference_MAIN
#endif // v1beta3_priority_level_configuration_reference_TEST

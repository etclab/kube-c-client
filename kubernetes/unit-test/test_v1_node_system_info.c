...
void test_v1_node_system_info(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_system_info_1 = v1_node_system_info_convertToJSON(v1_node_system_info_1);
	printf("v1_node_system_info :\n%s\n", mazu_cJSON_Print(jsonv1_node_system_info_1));
	v1_node_system_info_t* v1_node_system_info_2 = v1_node_system_info_parseFromJSON(jsonv1_node_system_info_1);
	mazu_cJSON* jsonv1_node_system_info_2 = v1_node_system_info_convertToJSON(v1_node_system_info_2);
	printf("repeating v1_node_system_info:\n%s\n", mazu_cJSON_Print(jsonv1_node_system_info_2));
}

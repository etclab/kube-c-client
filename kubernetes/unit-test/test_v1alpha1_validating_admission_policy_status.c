...
void test_v1alpha1_validating_admission_policy_status(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_validating_admission_policy_status_1 = v1alpha1_validating_admission_policy_status_convertToJSON(v1alpha1_validating_admission_policy_status_1);
	printf("v1alpha1_validating_admission_policy_status :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_validating_admission_policy_status_1));
	...
	mazu_cJSON* jsonv1alpha1_validating_admission_policy_status_2 = v1alpha1_validating_admission_policy_status_convertToJSON(v1alpha1_validating_admission_policy_status_2);
	printf("repeating v1alpha1_validating_admission_policy_status:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_validating_admission_policy_status_2));
}

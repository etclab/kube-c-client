...
void test_v1_toleration(int include_optional) {
	...
	mazu_cJSON* jsonv1_toleration_1 = v1_toleration_convertToJSON(v1_toleration_1);
	printf("v1_toleration :\n%s\n", mazu_cJSON_Print(jsonv1_toleration_1));
	v1_toleration_t* v1_toleration_2 = v1_toleration_parseFromJSON(jsonv1_toleration_1);
	mazu_cJSON* jsonv1_toleration_2 = v1_toleration_convertToJSON(v1_toleration_2);
	printf("repeating v1_toleration:\n%s\n", mazu_cJSON_Print(jsonv1_toleration_2));
}

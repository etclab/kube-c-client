...
void test_v1_aggregation_rule(int include_optional) {
	...
	mazu_cJSON* jsonv1_aggregation_rule_1 = v1_aggregation_rule_convertToJSON(v1_aggregation_rule_1);
	printf("v1_aggregation_rule :\n%s\n", mazu_cJSON_Print(jsonv1_aggregation_rule_1));
	v1_aggregation_rule_t* v1_aggregation_rule_2 = v1_aggregation_rule_parseFromJSON(jsonv1_aggregation_rule_1);
	mazu_cJSON* jsonv1_aggregation_rule_2 = v1_aggregation_rule_convertToJSON(v1_aggregation_rule_2);
	printf("repeating v1_aggregation_rule:\n%s\n", mazu_cJSON_Print(jsonv1_aggregation_rule_2));
}

...
void test_v1_preferred_scheduling_term(int include_optional) {
	...
	mazu_cJSON* jsonv1_preferred_scheduling_term_1 = v1_preferred_scheduling_term_convertToJSON(v1_preferred_scheduling_term_1);
	printf("v1_preferred_scheduling_term :\n%s\n", mazu_cJSON_Print(jsonv1_preferred_scheduling_term_1));
	...
	mazu_cJSON* jsonv1_preferred_scheduling_term_2 = v1_preferred_scheduling_term_convertToJSON(v1_preferred_scheduling_term_2);
	printf("repeating v1_preferred_scheduling_term:\n%s\n", mazu_cJSON_Print(jsonv1_preferred_scheduling_term_2));
}

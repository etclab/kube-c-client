...
void test_v1alpha1_validating_admission_policy(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_validating_admission_policy_1 = v1alpha1_validating_admission_policy_convertToJSON(v1alpha1_validating_admission_policy_1);
	printf("v1alpha1_validating_admission_policy :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_validating_admission_policy_1));
	...
	mazu_cJSON* jsonv1alpha1_validating_admission_policy_2 = v1alpha1_validating_admission_policy_convertToJSON(v1alpha1_validating_admission_policy_2);
	printf("repeating v1alpha1_validating_admission_policy:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_validating_admission_policy_2));
}

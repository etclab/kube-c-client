...
void test_v1_network_policy(int include_optional) {
	...
	mazu_cJSON* jsonv1_network_policy_1 = v1_network_policy_convertToJSON(v1_network_policy_1);
	printf("v1_network_policy :\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_1));
	v1_network_policy_t* v1_network_policy_2 = v1_network_policy_parseFromJSON(jsonv1_network_policy_1);
	mazu_cJSON* jsonv1_network_policy_2 = v1_network_policy_convertToJSON(v1_network_policy_2);
	printf("repeating v1_network_policy:\n%s\n", mazu_cJSON_Print(jsonv1_network_policy_2));
}

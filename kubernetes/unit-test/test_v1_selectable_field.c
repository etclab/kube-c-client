...
void test_v1_selectable_field(int include_optional) {
	...
	mazu_cJSON* jsonv1_selectable_field_1 = v1_selectable_field_convertToJSON(v1_selectable_field_1);
	printf("v1_selectable_field :\n%s\n", mazu_cJSON_Print(jsonv1_selectable_field_1));
	v1_selectable_field_t* v1_selectable_field_2 = v1_selectable_field_parseFromJSON(jsonv1_selectable_field_1);
	mazu_cJSON* jsonv1_selectable_field_2 = v1_selectable_field_convertToJSON(v1_selectable_field_2);
	printf("repeating v1_selectable_field:\n%s\n", mazu_cJSON_Print(jsonv1_selectable_field_2));
}

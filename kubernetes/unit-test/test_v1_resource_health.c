...
void test_v1_resource_health(int include_optional) {
	...
	mazu_cJSON* jsonv1_resource_health_1 = v1_resource_health_convertToJSON(v1_resource_health_1);
	printf("v1_resource_health :\n%s\n", mazu_cJSON_Print(jsonv1_resource_health_1));
	v1_resource_health_t* v1_resource_health_2 = v1_resource_health_parseFromJSON(jsonv1_resource_health_1);
	mazu_cJSON* jsonv1_resource_health_2 = v1_resource_health_convertToJSON(v1_resource_health_2);
	printf("repeating v1_resource_health:\n%s\n", mazu_cJSON_Print(jsonv1_resource_health_2));
}

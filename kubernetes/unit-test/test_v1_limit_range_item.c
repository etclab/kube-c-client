...
void test_v1_limit_range_item(int include_optional) {
	...
	mazu_cJSON* jsonv1_limit_range_item_1 = v1_limit_range_item_convertToJSON(v1_limit_range_item_1);
	printf("v1_limit_range_item :\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_item_1));
	v1_limit_range_item_t* v1_limit_range_item_2 = v1_limit_range_item_parseFromJSON(jsonv1_limit_range_item_1);
	mazu_cJSON* jsonv1_limit_range_item_2 = v1_limit_range_item_convertToJSON(v1_limit_range_item_2);
	printf("repeating v1_limit_range_item:\n%s\n", mazu_cJSON_Print(jsonv1_limit_range_item_2));
}

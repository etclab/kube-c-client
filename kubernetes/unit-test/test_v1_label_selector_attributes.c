...
void test_v1_label_selector_attributes(int include_optional) {
	...
	mazu_cJSON* jsonv1_label_selector_attributes_1 = v1_label_selector_attributes_convertToJSON(v1_label_selector_attributes_1);
	printf("v1_label_selector_attributes :\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_attributes_1));
	...
	mazu_cJSON* jsonv1_label_selector_attributes_2 = v1_label_selector_attributes_convertToJSON(v1_label_selector_attributes_2);
	printf("repeating v1_label_selector_attributes:\n%s\n", mazu_cJSON_Print(jsonv1_label_selector_attributes_2));
}

...
void test_v1_flow_schema_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_flow_schema_condition_1 = v1_flow_schema_condition_convertToJSON(v1_flow_schema_condition_1);
	printf("v1_flow_schema_condition :\n%s\n", mazu_cJSON_Print(jsonv1_flow_schema_condition_1));
	...
	mazu_cJSON* jsonv1_flow_schema_condition_2 = v1_flow_schema_condition_convertToJSON(v1_flow_schema_condition_2);
	printf("repeating v1_flow_schema_condition:\n%s\n", mazu_cJSON_Print(jsonv1_flow_schema_condition_2));
}

...
void test_v1_linux_container_user(int include_optional) {
	...
	mazu_cJSON* jsonv1_linux_container_user_1 = v1_linux_container_user_convertToJSON(v1_linux_container_user_1);
	printf("v1_linux_container_user :\n%s\n", mazu_cJSON_Print(jsonv1_linux_container_user_1));
	v1_linux_container_user_t* v1_linux_container_user_2 = v1_linux_container_user_parseFromJSON(jsonv1_linux_container_user_1);
	mazu_cJSON* jsonv1_linux_container_user_2 = v1_linux_container_user_convertToJSON(v1_linux_container_user_2);
	printf("repeating v1_linux_container_user:\n%s\n", mazu_cJSON_Print(jsonv1_linux_container_user_2));
}

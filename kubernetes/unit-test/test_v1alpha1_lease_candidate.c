...
void test_v1alpha1_lease_candidate(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_lease_candidate_1 = v1alpha1_lease_candidate_convertToJSON(v1alpha1_lease_candidate_1);
	printf("v1alpha1_lease_candidate :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_lease_candidate_1));
	...
	mazu_cJSON* jsonv1alpha1_lease_candidate_2 = v1alpha1_lease_candidate_convertToJSON(v1alpha1_lease_candidate_2);
	printf("repeating v1alpha1_lease_candidate:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_lease_candidate_2));
}

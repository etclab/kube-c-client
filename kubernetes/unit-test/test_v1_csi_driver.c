...
void test_v1_csi_driver(int include_optional) {
	...
	mazu_cJSON* jsonv1_csi_driver_1 = v1_csi_driver_convertToJSON(v1_csi_driver_1);
	printf("v1_csi_driver :\n%s\n", mazu_cJSON_Print(jsonv1_csi_driver_1));
	v1_csi_driver_t* v1_csi_driver_2 = v1_csi_driver_parseFromJSON(jsonv1_csi_driver_1);
	mazu_cJSON* jsonv1_csi_driver_2 = v1_csi_driver_convertToJSON(v1_csi_driver_2);
	printf("repeating v1_csi_driver:\n%s\n", mazu_cJSON_Print(jsonv1_csi_driver_2));
}

...
void test_v1_scale_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_scale_spec_1 = v1_scale_spec_convertToJSON(v1_scale_spec_1);
	printf("v1_scale_spec :\n%s\n", mazu_cJSON_Print(jsonv1_scale_spec_1));
	v1_scale_spec_t* v1_scale_spec_2 = v1_scale_spec_parseFromJSON(jsonv1_scale_spec_1);
	mazu_cJSON* jsonv1_scale_spec_2 = v1_scale_spec_convertToJSON(v1_scale_spec_2);
	printf("repeating v1_scale_spec:\n%s\n", mazu_cJSON_Print(jsonv1_scale_spec_2));
}

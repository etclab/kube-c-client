...
void test_v1_service_account_token_projection(int include_optional) {
	...
	mazu_cJSON* jsonv1_service_account_token_projection_1 = v1_service_account_token_projection_convertToJSON(v1_service_account_token_projection_1);
	printf("v1_service_account_token_projection :\n%s\n", mazu_cJSON_Print(jsonv1_service_account_token_projection_1));
	...
	mazu_cJSON* jsonv1_service_account_token_projection_2 = v1_service_account_token_projection_convertToJSON(v1_service_account_token_projection_2);
	printf("repeating v1_service_account_token_projection:\n%s\n", mazu_cJSON_Print(jsonv1_service_account_token_projection_2));
}

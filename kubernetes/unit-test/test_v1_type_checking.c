...
void test_v1_type_checking(int include_optional) {
	...
	mazu_cJSON* jsonv1_type_checking_1 = v1_type_checking_convertToJSON(v1_type_checking_1);
	printf("v1_type_checking :\n%s\n", mazu_cJSON_Print(jsonv1_type_checking_1));
	v1_type_checking_t* v1_type_checking_2 = v1_type_checking_parseFromJSON(jsonv1_type_checking_1);
	mazu_cJSON* jsonv1_type_checking_2 = v1_type_checking_convertToJSON(v1_type_checking_2);
	printf("repeating v1_type_checking:\n%s\n", mazu_cJSON_Print(jsonv1_type_checking_2));
}

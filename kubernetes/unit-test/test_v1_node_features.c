...
void test_v1_node_features(int include_optional) {
	...
	mazu_cJSON* jsonv1_node_features_1 = v1_node_features_convertToJSON(v1_node_features_1);
	printf("v1_node_features :\n%s\n", mazu_cJSON_Print(jsonv1_node_features_1));
	v1_node_features_t* v1_node_features_2 = v1_node_features_parseFromJSON(jsonv1_node_features_1);
	mazu_cJSON* jsonv1_node_features_2 = v1_node_features_convertToJSON(v1_node_features_2);
	printf("repeating v1_node_features:\n%s\n", mazu_cJSON_Print(jsonv1_node_features_2));
}

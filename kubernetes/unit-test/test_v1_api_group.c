...
void test_v1_api_group(int include_optional) {
	...
	mazu_cJSON* jsonv1_api_group_1 = v1_api_group_convertToJSON(v1_api_group_1);
	printf("v1_api_group :\n%s\n", mazu_cJSON_Print(jsonv1_api_group_1));
	v1_api_group_t* v1_api_group_2 = v1_api_group_parseFromJSON(jsonv1_api_group_1);
	mazu_cJSON* jsonv1_api_group_2 = v1_api_group_convertToJSON(v1_api_group_2);
	printf("repeating v1_api_group:\n%s\n", mazu_cJSON_Print(jsonv1_api_group_2));
}

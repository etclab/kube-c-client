...
void test_v1_named_rule_with_operations(int include_optional) {
	...
	mazu_cJSON* jsonv1_named_rule_with_operations_1 = v1_named_rule_with_operations_convertToJSON(v1_named_rule_with_operations_1);
	printf("v1_named_rule_with_operations :\n%s\n", mazu_cJSON_Print(jsonv1_named_rule_with_operations_1));
	...
	mazu_cJSON* jsonv1_named_rule_with_operations_2 = v1_named_rule_with_operations_convertToJSON(v1_named_rule_with_operations_2);
	printf("repeating v1_named_rule_with_operations:\n%s\n", mazu_cJSON_Print(jsonv1_named_rule_with_operations_2));
}

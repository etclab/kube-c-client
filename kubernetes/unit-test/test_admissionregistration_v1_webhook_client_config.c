#ifndef admissionregistration_v1_webhook_client_config_TEST
#define admissionregistration_v1_webhook_client_config_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define admissionregistration_v1_webhook_client_config_MAIN
#endif // TEST_MAIN
...
#include "test_admissionregistration_v1_service_reference.c"


admissionregistration_v1_webhook_client_config_t* instantiate_admissionregistration_v1_webhook_client_config(int include_optional) {
  admissionregistration_v1_webhook_client_config_t* admissionregistration_v1_webhook_client_config = NULL;
  if (include_optional) {
    admissionregistration_v1_webhook_client_config = admissionregistration_v1_webhook_client_config_create(
      "YQ==",
       // false, not to have infinite recursion
      instantiate_admissionregistration_v1_service_reference(0),
      "0"
    );
  } else {
    admissionregistration_v1_webhook_client_config = admissionregistration_v1_webhook_client_config_create(
  ...
  return admissionregistration_v1_webhook_client_config;
}


#ifdef admissionregistration_v1_webhook_client_config_MAIN
...
int main() {
  test_admissionregistration_v1_webhook_client_config(1);
  test_admissionregistration_v1_webhook_client_config(0);

  printf("Hello world \n");
  return 0;
}

#endif // admissionregistration_v1_webhook_client_config_MAIN
#endif // admissionregistration_v1_webhook_client_config_TEST

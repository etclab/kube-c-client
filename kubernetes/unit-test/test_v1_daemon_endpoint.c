...
void test_v1_daemon_endpoint(int include_optional) {
	...
	mazu_cJSON* jsonv1_daemon_endpoint_1 = v1_daemon_endpoint_convertToJSON(v1_daemon_endpoint_1);
	printf("v1_daemon_endpoint :\n%s\n", mazu_cJSON_Print(jsonv1_daemon_endpoint_1));
	v1_daemon_endpoint_t* v1_daemon_endpoint_2 = v1_daemon_endpoint_parseFromJSON(jsonv1_daemon_endpoint_1);
	mazu_cJSON* jsonv1_daemon_endpoint_2 = v1_daemon_endpoint_convertToJSON(v1_daemon_endpoint_2);
	printf("repeating v1_daemon_endpoint:\n%s\n", mazu_cJSON_Print(jsonv1_daemon_endpoint_2));
}

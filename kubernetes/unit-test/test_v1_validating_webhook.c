...
void test_v1_validating_webhook(int include_optional) {
	...
	mazu_cJSON* jsonv1_validating_webhook_1 = v1_validating_webhook_convertToJSON(v1_validating_webhook_1);
	printf("v1_validating_webhook :\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_1));
	v1_validating_webhook_t* v1_validating_webhook_2 = v1_validating_webhook_parseFromJSON(jsonv1_validating_webhook_1);
	mazu_cJSON* jsonv1_validating_webhook_2 = v1_validating_webhook_convertToJSON(v1_validating_webhook_2);
	printf("repeating v1_validating_webhook:\n%s\n", mazu_cJSON_Print(jsonv1_validating_webhook_2));
}

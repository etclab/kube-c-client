...
void test_v1_ingress_class(int include_optional) {
	...
	mazu_cJSON* jsonv1_ingress_class_1 = v1_ingress_class_convertToJSON(v1_ingress_class_1);
	printf("v1_ingress_class :\n%s\n", mazu_cJSON_Print(jsonv1_ingress_class_1));
	v1_ingress_class_t* v1_ingress_class_2 = v1_ingress_class_parseFromJSON(jsonv1_ingress_class_1);
	mazu_cJSON* jsonv1_ingress_class_2 = v1_ingress_class_convertToJSON(v1_ingress_class_2);
	printf("repeating v1_ingress_class:\n%s\n", mazu_cJSON_Print(jsonv1_ingress_class_2));
}

...
void test_events_v1_event_list(int include_optional) {
	...
	mazu_cJSON* jsonevents_v1_event_list_1 = events_v1_event_list_convertToJSON(events_v1_event_list_1);
	printf("events_v1_event_list :\n%s\n", mazu_cJSON_Print(jsonevents_v1_event_list_1));
	events_v1_event_list_t* events_v1_event_list_2 = events_v1_event_list_parseFromJSON(jsonevents_v1_event_list_1);
	mazu_cJSON* jsonevents_v1_event_list_2 = events_v1_event_list_convertToJSON(events_v1_event_list_2);
	printf("repeating events_v1_event_list:\n%s\n", mazu_cJSON_Print(jsonevents_v1_event_list_2));
}

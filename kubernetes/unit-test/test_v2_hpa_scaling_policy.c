...
void test_v2_hpa_scaling_policy(int include_optional) {
	...
	mazu_cJSON* jsonv2_hpa_scaling_policy_1 = v2_hpa_scaling_policy_convertToJSON(v2_hpa_scaling_policy_1);
	printf("v2_hpa_scaling_policy :\n%s\n", mazu_cJSON_Print(jsonv2_hpa_scaling_policy_1));
	v2_hpa_scaling_policy_t* v2_hpa_scaling_policy_2 = v2_hpa_scaling_policy_parseFromJSON(jsonv2_hpa_scaling_policy_1);
	mazu_cJSON* jsonv2_hpa_scaling_policy_2 = v2_hpa_scaling_policy_convertToJSON(v2_hpa_scaling_policy_2);
	printf("repeating v2_hpa_scaling_policy:\n%s\n", mazu_cJSON_Print(jsonv2_hpa_scaling_policy_2));
}

...
void test_v1_config_map(int include_optional) {
	...
	mazu_cJSON* jsonv1_config_map_1 = v1_config_map_convertToJSON(v1_config_map_1);
	printf("v1_config_map :\n%s\n", mazu_cJSON_Print(jsonv1_config_map_1));
	v1_config_map_t* v1_config_map_2 = v1_config_map_parseFromJSON(jsonv1_config_map_1);
	mazu_cJSON* jsonv1_config_map_2 = v1_config_map_convertToJSON(v1_config_map_2);
	printf("repeating v1_config_map:\n%s\n", mazu_cJSON_Print(jsonv1_config_map_2));
}

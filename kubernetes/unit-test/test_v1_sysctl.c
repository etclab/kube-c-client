...
void test_v1_sysctl(int include_optional) {
	...
	mazu_cJSON* jsonv1_sysctl_1 = v1_sysctl_convertToJSON(v1_sysctl_1);
	printf("v1_sysctl :\n%s\n", mazu_cJSON_Print(jsonv1_sysctl_1));
	v1_sysctl_t* v1_sysctl_2 = v1_sysctl_parseFromJSON(jsonv1_sysctl_1);
	mazu_cJSON* jsonv1_sysctl_2 = v1_sysctl_convertToJSON(v1_sysctl_2);
	printf("repeating v1_sysctl:\n%s\n", mazu_cJSON_Print(jsonv1_sysctl_2));
}

...
void test_v1_endpoint_subset(int include_optional) {
	...
	mazu_cJSON* jsonv1_endpoint_subset_1 = v1_endpoint_subset_convertToJSON(v1_endpoint_subset_1);
	printf("v1_endpoint_subset :\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_subset_1));
	v1_endpoint_subset_t* v1_endpoint_subset_2 = v1_endpoint_subset_parseFromJSON(jsonv1_endpoint_subset_1);
	mazu_cJSON* jsonv1_endpoint_subset_2 = v1_endpoint_subset_convertToJSON(v1_endpoint_subset_2);
	printf("repeating v1_endpoint_subset:\n%s\n", mazu_cJSON_Print(jsonv1_endpoint_subset_2));
}

...
void test_v1_session_affinity_config(int include_optional) {
	...
	mazu_cJSON* jsonv1_session_affinity_config_1 = v1_session_affinity_config_convertToJSON(v1_session_affinity_config_1);
	printf("v1_session_affinity_config :\n%s\n", mazu_cJSON_Print(jsonv1_session_affinity_config_1));
	...
	mazu_cJSON* jsonv1_session_affinity_config_2 = v1_session_affinity_config_convertToJSON(v1_session_affinity_config_2);
	printf("repeating v1_session_affinity_config:\n%s\n", mazu_cJSON_Print(jsonv1_session_affinity_config_2));
}

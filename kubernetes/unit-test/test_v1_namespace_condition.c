...
void test_v1_namespace_condition(int include_optional) {
	...
	mazu_cJSON* jsonv1_namespace_condition_1 = v1_namespace_condition_convertToJSON(v1_namespace_condition_1);
	printf("v1_namespace_condition :\n%s\n", mazu_cJSON_Print(jsonv1_namespace_condition_1));
	v1_namespace_condition_t* v1_namespace_condition_2 = v1_namespace_condition_parseFromJSON(jsonv1_namespace_condition_1);
	mazu_cJSON* jsonv1_namespace_condition_2 = v1_namespace_condition_convertToJSON(v1_namespace_condition_2);
	printf("repeating v1_namespace_condition:\n%s\n", mazu_cJSON_Print(jsonv1_namespace_condition_2));
}

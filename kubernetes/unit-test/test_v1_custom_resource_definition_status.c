...
void test_v1_custom_resource_definition_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_custom_resource_definition_status_1 = v1_custom_resource_definition_status_convertToJSON(v1_custom_resource_definition_status_1);
	printf("v1_custom_resource_definition_status :\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_definition_status_1));
	...
	mazu_cJSON* jsonv1_custom_resource_definition_status_2 = v1_custom_resource_definition_status_convertToJSON(v1_custom_resource_definition_status_2);
	printf("repeating v1_custom_resource_definition_status:\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_definition_status_2));
}

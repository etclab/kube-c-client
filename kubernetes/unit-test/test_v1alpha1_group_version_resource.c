...
void test_v1alpha1_group_version_resource(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_group_version_resource_1 = v1alpha1_group_version_resource_convertToJSON(v1alpha1_group_version_resource_1);
	printf("v1alpha1_group_version_resource :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_group_version_resource_1));
	...
	mazu_cJSON* jsonv1alpha1_group_version_resource_2 = v1alpha1_group_version_resource_convertToJSON(v1alpha1_group_version_resource_2);
	printf("repeating v1alpha1_group_version_resource:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_group_version_resource_2));
}

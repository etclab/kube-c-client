...
void test_v1_object_meta(int include_optional) {
	...
	mazu_cJSON* jsonv1_object_meta_1 = v1_object_meta_convertToJSON(v1_object_meta_1);
	printf("v1_object_meta :\n%s\n", mazu_cJSON_Print(jsonv1_object_meta_1));
	v1_object_meta_t* v1_object_meta_2 = v1_object_meta_parseFromJSON(jsonv1_object_meta_1);
	mazu_cJSON* jsonv1_object_meta_2 = v1_object_meta_convertToJSON(v1_object_meta_2);
	printf("repeating v1_object_meta:\n%s\n", mazu_cJSON_Print(jsonv1_object_meta_2));
}

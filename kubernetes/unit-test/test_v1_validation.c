#ifndef v1_validation_TEST
#define v1_validation_TEST

// the following is to include only the main from the first c file
#ifndef TEST_MAIN
#define TEST_MAIN
#define v1_validation_MAIN
#endif // TEST_MAIN
...
v1_validation_t* instantiate_v1_validation(int include_optional) {
  v1_validation_t* v1_validation = NULL;
  if (include_optional) {
    v1_validation = v1_validation_create(
      "0",
      "0",
      "0",
      "0"
  ...
  return v1_validation;
}


#ifdef v1_validation_MAIN
...
int main() {
  test_v1_validation(1);
  test_v1_validation(0);

  printf("Hello world \n");
  return 0;
}

#endif // v1_validation_MAIN
#endif // v1_validation_TEST

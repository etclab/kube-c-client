...
void test_v1_volume_projection(int include_optional) {
	...
	mazu_cJSON* jsonv1_volume_projection_1 = v1_volume_projection_convertToJSON(v1_volume_projection_1);
	printf("v1_volume_projection :\n%s\n", mazu_cJSON_Print(jsonv1_volume_projection_1));
	v1_volume_projection_t* v1_volume_projection_2 = v1_volume_projection_parseFromJSON(jsonv1_volume_projection_1);
	mazu_cJSON* jsonv1_volume_projection_2 = v1_volume_projection_convertToJSON(v1_volume_projection_2);
	printf("repeating v1_volume_projection:\n%s\n", mazu_cJSON_Print(jsonv1_volume_projection_2));
}

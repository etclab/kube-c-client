...
void test_v1_volume_node_affinity(int include_optional) {
	...
	mazu_cJSON* jsonv1_volume_node_affinity_1 = v1_volume_node_affinity_convertToJSON(v1_volume_node_affinity_1);
	printf("v1_volume_node_affinity :\n%s\n", mazu_cJSON_Print(jsonv1_volume_node_affinity_1));
	v1_volume_node_affinity_t* v1_volume_node_affinity_2 = v1_volume_node_affinity_parseFromJSON(jsonv1_volume_node_affinity_1);
	mazu_cJSON* jsonv1_volume_node_affinity_2 = v1_volume_node_affinity_convertToJSON(v1_volume_node_affinity_2);
	printf("repeating v1_volume_node_affinity:\n%s\n", mazu_cJSON_Print(jsonv1_volume_node_affinity_2));
}

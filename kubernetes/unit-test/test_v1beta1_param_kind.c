...
void test_v1beta1_param_kind(int include_optional) {
	...
	mazu_cJSON* jsonv1beta1_param_kind_1 = v1beta1_param_kind_convertToJSON(v1beta1_param_kind_1);
	printf("v1beta1_param_kind :\n%s\n", mazu_cJSON_Print(jsonv1beta1_param_kind_1));
	v1beta1_param_kind_t* v1beta1_param_kind_2 = v1beta1_param_kind_parseFromJSON(jsonv1beta1_param_kind_1);
	mazu_cJSON* jsonv1beta1_param_kind_2 = v1beta1_param_kind_convertToJSON(v1beta1_param_kind_2);
	printf("repeating v1beta1_param_kind:\n%s\n", mazu_cJSON_Print(jsonv1beta1_param_kind_2));
}

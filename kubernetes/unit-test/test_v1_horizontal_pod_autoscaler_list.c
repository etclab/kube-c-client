...
void test_v1_horizontal_pod_autoscaler_list(int include_optional) {
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_list_1 = v1_horizontal_pod_autoscaler_list_convertToJSON(v1_horizontal_pod_autoscaler_list_1);
	printf("v1_horizontal_pod_autoscaler_list :\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_list_1));
	...
	mazu_cJSON* jsonv1_horizontal_pod_autoscaler_list_2 = v1_horizontal_pod_autoscaler_list_convertToJSON(v1_horizontal_pod_autoscaler_list_2);
	printf("repeating v1_horizontal_pod_autoscaler_list:\n%s\n", mazu_cJSON_Print(jsonv1_horizontal_pod_autoscaler_list_2));
}

...
void test_v1_self_subject_access_review_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_self_subject_access_review_spec_1 = v1_self_subject_access_review_spec_convertToJSON(v1_self_subject_access_review_spec_1);
	printf("v1_self_subject_access_review_spec :\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_access_review_spec_1));
	...
	mazu_cJSON* jsonv1_self_subject_access_review_spec_2 = v1_self_subject_access_review_spec_convertToJSON(v1_self_subject_access_review_spec_2);
	printf("repeating v1_self_subject_access_review_spec:\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_access_review_spec_2));
}

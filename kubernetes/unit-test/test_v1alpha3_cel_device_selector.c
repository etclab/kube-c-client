...
void test_v1alpha3_cel_device_selector(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_cel_device_selector_1 = v1alpha3_cel_device_selector_convertToJSON(v1alpha3_cel_device_selector_1);
	printf("v1alpha3_cel_device_selector :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_cel_device_selector_1));
	...
	mazu_cJSON* jsonv1alpha3_cel_device_selector_2 = v1alpha3_cel_device_selector_convertToJSON(v1alpha3_cel_device_selector_2);
	printf("repeating v1alpha3_cel_device_selector:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_cel_device_selector_2));
}

...
void test_v1_container(int include_optional) {
	...
	mazu_cJSON* jsonv1_container_1 = v1_container_convertToJSON(v1_container_1);
	printf("v1_container :\n%s\n", mazu_cJSON_Print(jsonv1_container_1));
	v1_container_t* v1_container_2 = v1_container_parseFromJSON(jsonv1_container_1);
	mazu_cJSON* jsonv1_container_2 = v1_container_convertToJSON(v1_container_2);
	printf("repeating v1_container:\n%s\n", mazu_cJSON_Print(jsonv1_container_2));
}

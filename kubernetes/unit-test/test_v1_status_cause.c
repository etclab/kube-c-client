...
void test_v1_status_cause(int include_optional) {
	...
	mazu_cJSON* jsonv1_status_cause_1 = v1_status_cause_convertToJSON(v1_status_cause_1);
	printf("v1_status_cause :\n%s\n", mazu_cJSON_Print(jsonv1_status_cause_1));
	v1_status_cause_t* v1_status_cause_2 = v1_status_cause_parseFromJSON(jsonv1_status_cause_1);
	mazu_cJSON* jsonv1_status_cause_2 = v1_status_cause_convertToJSON(v1_status_cause_2);
	printf("repeating v1_status_cause:\n%s\n", mazu_cJSON_Print(jsonv1_status_cause_2));
}

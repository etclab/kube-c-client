...
void test_v1alpha1_param_kind(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_param_kind_1 = v1alpha1_param_kind_convertToJSON(v1alpha1_param_kind_1);
	printf("v1alpha1_param_kind :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_param_kind_1));
	v1alpha1_param_kind_t* v1alpha1_param_kind_2 = v1alpha1_param_kind_parseFromJSON(jsonv1alpha1_param_kind_1);
	mazu_cJSON* jsonv1alpha1_param_kind_2 = v1alpha1_param_kind_convertToJSON(v1alpha1_param_kind_2);
	printf("repeating v1alpha1_param_kind:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_param_kind_2));
}

...
void test_v1_custom_resource_subresource_scale(int include_optional) {
	...
	mazu_cJSON* jsonv1_custom_resource_subresource_scale_1 = v1_custom_resource_subresource_scale_convertToJSON(v1_custom_resource_subresource_scale_1);
	printf("v1_custom_resource_subresource_scale :\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_subresource_scale_1));
	...
	mazu_cJSON* jsonv1_custom_resource_subresource_scale_2 = v1_custom_resource_subresource_scale_convertToJSON(v1_custom_resource_subresource_scale_2);
	printf("repeating v1_custom_resource_subresource_scale:\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_subresource_scale_2));
}

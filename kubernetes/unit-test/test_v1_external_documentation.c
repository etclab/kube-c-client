...
void test_v1_external_documentation(int include_optional) {
	...
	mazu_cJSON* jsonv1_external_documentation_1 = v1_external_documentation_convertToJSON(v1_external_documentation_1);
	printf("v1_external_documentation :\n%s\n", mazu_cJSON_Print(jsonv1_external_documentation_1));
	...
	mazu_cJSON* jsonv1_external_documentation_2 = v1_external_documentation_convertToJSON(v1_external_documentation_2);
	printf("repeating v1_external_documentation:\n%s\n", mazu_cJSON_Print(jsonv1_external_documentation_2));
}

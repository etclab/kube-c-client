...
void test_v1_cluster_role(int include_optional) {
	...
	mazu_cJSON* jsonv1_cluster_role_1 = v1_cluster_role_convertToJSON(v1_cluster_role_1);
	printf("v1_cluster_role :\n%s\n", mazu_cJSON_Print(jsonv1_cluster_role_1));
	v1_cluster_role_t* v1_cluster_role_2 = v1_cluster_role_parseFromJSON(jsonv1_cluster_role_1);
	mazu_cJSON* jsonv1_cluster_role_2 = v1_cluster_role_convertToJSON(v1_cluster_role_2);
	printf("repeating v1_cluster_role:\n%s\n", mazu_cJSON_Print(jsonv1_cluster_role_2));
}

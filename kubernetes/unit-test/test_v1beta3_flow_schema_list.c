...
void test_v1beta3_flow_schema_list(int include_optional) {
	...
	mazu_cJSON* jsonv1beta3_flow_schema_list_1 = v1beta3_flow_schema_list_convertToJSON(v1beta3_flow_schema_list_1);
	printf("v1beta3_flow_schema_list :\n%s\n", mazu_cJSON_Print(jsonv1beta3_flow_schema_list_1));
	...
	mazu_cJSON* jsonv1beta3_flow_schema_list_2 = v1beta3_flow_schema_list_convertToJSON(v1beta3_flow_schema_list_2);
	printf("repeating v1beta3_flow_schema_list:\n%s\n", mazu_cJSON_Print(jsonv1beta3_flow_schema_list_2));
}

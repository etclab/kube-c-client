...
void test_v1_volume_attachment_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_volume_attachment_spec_1 = v1_volume_attachment_spec_convertToJSON(v1_volume_attachment_spec_1);
	printf("v1_volume_attachment_spec :\n%s\n", mazu_cJSON_Print(jsonv1_volume_attachment_spec_1));
	...
	mazu_cJSON* jsonv1_volume_attachment_spec_2 = v1_volume_attachment_spec_convertToJSON(v1_volume_attachment_spec_2);
	printf("repeating v1_volume_attachment_spec:\n%s\n", mazu_cJSON_Print(jsonv1_volume_attachment_spec_2));
}

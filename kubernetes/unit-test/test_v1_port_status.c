...
void test_v1_port_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_port_status_1 = v1_port_status_convertToJSON(v1_port_status_1);
	printf("v1_port_status :\n%s\n", mazu_cJSON_Print(jsonv1_port_status_1));
	v1_port_status_t* v1_port_status_2 = v1_port_status_parseFromJSON(jsonv1_port_status_1);
	mazu_cJSON* jsonv1_port_status_2 = v1_port_status_convertToJSON(v1_port_status_2);
	printf("repeating v1_port_status:\n%s\n", mazu_cJSON_Print(jsonv1_port_status_2));
}

...
void test_v1_self_subject_review_status(int include_optional) {
	...
	mazu_cJSON* jsonv1_self_subject_review_status_1 = v1_self_subject_review_status_convertToJSON(v1_self_subject_review_status_1);
	printf("v1_self_subject_review_status :\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_review_status_1));
	...
	mazu_cJSON* jsonv1_self_subject_review_status_2 = v1_self_subject_review_status_convertToJSON(v1_self_subject_review_status_2);
	printf("repeating v1_self_subject_review_status:\n%s\n", mazu_cJSON_Print(jsonv1_self_subject_review_status_2));
}

...
void test_v1_custom_resource_validation(int include_optional) {
	...
	mazu_cJSON* jsonv1_custom_resource_validation_1 = v1_custom_resource_validation_convertToJSON(v1_custom_resource_validation_1);
	printf("v1_custom_resource_validation :\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_validation_1));
	...
	mazu_cJSON* jsonv1_custom_resource_validation_2 = v1_custom_resource_validation_convertToJSON(v1_custom_resource_validation_2);
	printf("repeating v1_custom_resource_validation:\n%s\n", mazu_cJSON_Print(jsonv1_custom_resource_validation_2));
}

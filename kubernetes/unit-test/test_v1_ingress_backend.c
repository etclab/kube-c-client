...
void test_v1_ingress_backend(int include_optional) {
	...
	mazu_cJSON* jsonv1_ingress_backend_1 = v1_ingress_backend_convertToJSON(v1_ingress_backend_1);
	printf("v1_ingress_backend :\n%s\n", mazu_cJSON_Print(jsonv1_ingress_backend_1));
	v1_ingress_backend_t* v1_ingress_backend_2 = v1_ingress_backend_parseFromJSON(jsonv1_ingress_backend_1);
	mazu_cJSON* jsonv1_ingress_backend_2 = v1_ingress_backend_convertToJSON(v1_ingress_backend_2);
	printf("repeating v1_ingress_backend:\n%s\n", mazu_cJSON_Print(jsonv1_ingress_backend_2));
}

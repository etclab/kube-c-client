...
void test_v2_container_resource_metric_source(int include_optional) {
	...
	mazu_cJSON* jsonv2_container_resource_metric_source_1 = v2_container_resource_metric_source_convertToJSON(v2_container_resource_metric_source_1);
	printf("v2_container_resource_metric_source :\n%s\n", mazu_cJSON_Print(jsonv2_container_resource_metric_source_1));
	...
	mazu_cJSON* jsonv2_container_resource_metric_source_2 = v2_container_resource_metric_source_convertToJSON(v2_container_resource_metric_source_2);
	printf("repeating v2_container_resource_metric_source:\n%s\n", mazu_cJSON_Print(jsonv2_container_resource_metric_source_2));
}

...
void test_v1_role(int include_optional) {
	...
	mazu_cJSON* jsonv1_role_1 = v1_role_convertToJSON(v1_role_1);
	printf("v1_role :\n%s\n", mazu_cJSON_Print(jsonv1_role_1));
	v1_role_t* v1_role_2 = v1_role_parseFromJSON(jsonv1_role_1);
	mazu_cJSON* jsonv1_role_2 = v1_role_convertToJSON(v1_role_2);
	printf("repeating v1_role:\n%s\n", mazu_cJSON_Print(jsonv1_role_2));
}

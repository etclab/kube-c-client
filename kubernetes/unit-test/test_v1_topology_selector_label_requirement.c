...
void test_v1_topology_selector_label_requirement(int include_optional) {
	...
	mazu_cJSON* jsonv1_topology_selector_label_requirement_1 = v1_topology_selector_label_requirement_convertToJSON(v1_topology_selector_label_requirement_1);
	printf("v1_topology_selector_label_requirement :\n%s\n", mazu_cJSON_Print(jsonv1_topology_selector_label_requirement_1));
	...
	mazu_cJSON* jsonv1_topology_selector_label_requirement_2 = v1_topology_selector_label_requirement_convertToJSON(v1_topology_selector_label_requirement_2);
	printf("repeating v1_topology_selector_label_requirement:\n%s\n", mazu_cJSON_Print(jsonv1_topology_selector_label_requirement_2));
}

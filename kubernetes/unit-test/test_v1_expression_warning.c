...
void test_v1_expression_warning(int include_optional) {
	...
	mazu_cJSON* jsonv1_expression_warning_1 = v1_expression_warning_convertToJSON(v1_expression_warning_1);
	printf("v1_expression_warning :\n%s\n", mazu_cJSON_Print(jsonv1_expression_warning_1));
	v1_expression_warning_t* v1_expression_warning_2 = v1_expression_warning_parseFromJSON(jsonv1_expression_warning_1);
	mazu_cJSON* jsonv1_expression_warning_2 = v1_expression_warning_convertToJSON(v1_expression_warning_2);
	printf("repeating v1_expression_warning:\n%s\n", mazu_cJSON_Print(jsonv1_expression_warning_2));
}

...
void test_v1_http_header(int include_optional) {
	...
	mazu_cJSON* jsonv1_http_header_1 = v1_http_header_convertToJSON(v1_http_header_1);
	printf("v1_http_header :\n%s\n", mazu_cJSON_Print(jsonv1_http_header_1));
	v1_http_header_t* v1_http_header_2 = v1_http_header_parseFromJSON(jsonv1_http_header_1);
	mazu_cJSON* jsonv1_http_header_2 = v1_http_header_convertToJSON(v1_http_header_2);
	printf("repeating v1_http_header:\n%s\n", mazu_cJSON_Print(jsonv1_http_header_2));
}

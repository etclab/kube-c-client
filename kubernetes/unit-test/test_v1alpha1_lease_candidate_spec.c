...
void test_v1alpha1_lease_candidate_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha1_lease_candidate_spec_1 = v1alpha1_lease_candidate_spec_convertToJSON(v1alpha1_lease_candidate_spec_1);
	printf("v1alpha1_lease_candidate_spec :\n%s\n", mazu_cJSON_Print(jsonv1alpha1_lease_candidate_spec_1));
	...
	mazu_cJSON* jsonv1alpha1_lease_candidate_spec_2 = v1alpha1_lease_candidate_spec_convertToJSON(v1alpha1_lease_candidate_spec_2);
	printf("repeating v1alpha1_lease_candidate_spec:\n%s\n", mazu_cJSON_Print(jsonv1alpha1_lease_candidate_spec_2));
}

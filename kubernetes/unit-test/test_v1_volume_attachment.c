...
void test_v1_volume_attachment(int include_optional) {
	...
	mazu_cJSON* jsonv1_volume_attachment_1 = v1_volume_attachment_convertToJSON(v1_volume_attachment_1);
	printf("v1_volume_attachment :\n%s\n", mazu_cJSON_Print(jsonv1_volume_attachment_1));
	v1_volume_attachment_t* v1_volume_attachment_2 = v1_volume_attachment_parseFromJSON(jsonv1_volume_attachment_1);
	mazu_cJSON* jsonv1_volume_attachment_2 = v1_volume_attachment_convertToJSON(v1_volume_attachment_2);
	printf("repeating v1_volume_attachment:\n%s\n", mazu_cJSON_Print(jsonv1_volume_attachment_2));
}

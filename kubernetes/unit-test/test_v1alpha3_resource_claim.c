...
void test_v1alpha3_resource_claim(int include_optional) {
	...
	mazu_cJSON* jsonv1alpha3_resource_claim_1 = v1alpha3_resource_claim_convertToJSON(v1alpha3_resource_claim_1);
	printf("v1alpha3_resource_claim :\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_1));
	v1alpha3_resource_claim_t* v1alpha3_resource_claim_2 = v1alpha3_resource_claim_parseFromJSON(jsonv1alpha3_resource_claim_1);
	mazu_cJSON* jsonv1alpha3_resource_claim_2 = v1alpha3_resource_claim_convertToJSON(v1alpha3_resource_claim_2);
	printf("repeating v1alpha3_resource_claim:\n%s\n", mazu_cJSON_Print(jsonv1alpha3_resource_claim_2));
}

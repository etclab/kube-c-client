...
#include "test_v1_stateful_set_ordinals.c"
...
v1_stateful_set_spec_t* instantiate_v1_stateful_set_spec(int include_optional) {
  ...
  if (include_optional) {
    v1_stateful_set_spec = v1_stateful_set_spec_create(
      ...
      instantiate_v1_stateful_set_ordinals(0),
       // false, not to have infinite recursion
...
void test_v1_stateful_set_spec(int include_optional) {
	...
	mazu_cJSON* jsonv1_stateful_set_spec_1 = v1_stateful_set_spec_convertToJSON(v1_stateful_set_spec_1);
	printf("v1_stateful_set_spec :\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_spec_1));
	v1_stateful_set_spec_t* v1_stateful_set_spec_2 = v1_stateful_set_spec_parseFromJSON(jsonv1_stateful_set_spec_1);
	mazu_cJSON* jsonv1_stateful_set_spec_2 = v1_stateful_set_spec_convertToJSON(v1_stateful_set_spec_2);
	printf("repeating v1_stateful_set_spec:\n%s\n", mazu_cJSON_Print(jsonv1_stateful_set_spec_2));
}

...
#include <stdio.h>
#include <ctype.h>
#include "CoordinationV1alpha1API.h"
...
CoordinationV1alpha1API_createNamespacedLeaseCandidate(apiClient_t *apiClient, char *_namespace, v1alpha1_lease_candidate_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_lease_candidate_convertToJSON(body);
    ...
    mazu_cJSON *CoordinationV1alpha1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1alpha1_lease_candidate_t *elementToReturn = v1alpha1_lease_candidate_parseFromJSON(CoordinationV1alpha1APIlocalVarJSON);
    mazu_cJSON_Delete(CoordinationV1alpha1APIlocalVarJSON);
...
CoordinationV1alpha1API_deleteCollectionNamespacedLeaseCandidate(apiClient_t *apiClient, char *_namespace, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    ...
    //nonprimitive not container
    mazu_cJSON *CoordinationV1alpha1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(CoordinationV1alpha1APIlocalVarJSON);
    mazu_cJSON_Delete(CoordinationV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CoordinationV1alpha1API_deleteNamespacedLeaseCandidate(apiClient_t *apiClient, char *name, char *_namespace, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1alpha1/namespaces/{namespace}/leasecandidates/{name}");
...
CoordinationV1alpha1API_getAPIResources_16(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1alpha1/");
    ...
    //nonprimitive not container
    mazu_cJSON *CoordinationV1alpha1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(CoordinationV1alpha1APIlocalVarJSON);
    mazu_cJSON_Delete(CoordinationV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CoordinationV1alpha1API_listLeaseCandidateForAllNamespaces(apiClient_t *apiClient, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *pretty, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1alpha1/leasecandidates")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1alpha1/leasecandidates");
    ...
    //nonprimitive not container
    mazu_cJSON *CoordinationV1alpha1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1alpha1_lease_candidate_list_t *elementToReturn = v1alpha1_lease_candidate_list_parseFromJSON(CoordinationV1alpha1APIlocalVarJSON);
    mazu_cJSON_Delete(CoordinationV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }

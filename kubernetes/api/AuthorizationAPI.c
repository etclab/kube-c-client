...
//
v1_api_group_t*
AuthorizationAPI_getAPIGroup_4(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/");

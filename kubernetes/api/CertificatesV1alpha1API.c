...
#include <stdio.h>
#include <ctype.h>
#include "CertificatesV1alpha1API.h"
...
CertificatesV1alpha1API_createClusterTrustBundle(apiClient_t *apiClient, v1alpha1_cluster_trust_bundle_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1alpha1/clustertrustbundles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles");
...
CertificatesV1alpha1API_deleteClusterTrustBundle(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}");
...
CertificatesV1alpha1API_getAPIResources_14(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1alpha1/");

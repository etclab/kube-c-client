...
#include <stdio.h>
#include <ctype.h>
#include "InternalApiserverAPI.h"
...
//
v1_api_group_t*
InternalApiserverAPI_getAPIGroup_12(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/internal.apiserver.k8s.io/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/internal.apiserver.k8s.io/");

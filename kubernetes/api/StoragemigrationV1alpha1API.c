...
#include <stdio.h>
#include <ctype.h>
#include "StoragemigrationV1alpha1API.h"
...
StoragemigrationV1alpha1API_createStorageVersionMigration(apiClient_t *apiClient, v1alpha1_storage_version_migration_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations");
...
StoragemigrationV1alpha1API_deleteStorageVersionMigration(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}");
...
StoragemigrationV1alpha1API_getAPIResources_32(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storagemigration.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storagemigration.k8s.io/v1alpha1/");
...
StoragemigrationV1alpha1API_patchStorageVersionMigrationStatus(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storagemigration.k8s.io/v1alpha1/storageversionmigrations/{name}/status");

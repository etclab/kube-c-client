...
#include <stdio.h>
#include <ctype.h>
#include "AdmissionregistrationV1beta1API.h"
...
AdmissionregistrationV1beta1API_createValidatingAdmissionPolicyBinding_1(apiClient_t *apiClient, v1beta1_validating_admission_policy_binding_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_validating_admission_policy_binding_convertToJSON(body);
    ...
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_admission_policy_binding_t *elementToReturn = v1beta1_validating_admission_policy_binding_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
...
AdmissionregistrationV1beta1API_createValidatingAdmissionPolicy_1(apiClient_t *apiClient, v1beta1_validating_admission_policy_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_validating_admission_policy_convertToJSON(body);
        localVarBodyParameters = mazu_cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not container
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_admission_policy_t *elementToReturn = v1beta1_validating_admission_policy_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_deleteCollectionValidatingAdmissionPolicyBinding_1(apiClient_t *apiClient, char *pretty, char *_continue, char *dryRun, char *fieldSelector, int *gracePeriodSeconds, char *labelSelector, int *limit, int *orphanDependents, char *propagationPolicy, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, v1_delete_options_t *body)
{
    ...
    //nonprimitive not container
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_deleteValidatingAdmissionPolicyBinding_1(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicybindings/{name}");
...
AdmissionregistrationV1beta1API_deleteValidatingAdmissionPolicy_1(apiClient_t *apiClient, char *name, char *pretty, char *dryRun, int *gracePeriodSeconds, int *orphanDependents, char *propagationPolicy, v1_delete_options_t *body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}");
...
AdmissionregistrationV1beta1API_getAPIResources_2(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/");
    ...
    //nonprimitive not container
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_listValidatingAdmissionPolicyBinding_1(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_admission_policy_binding_list_t *elementToReturn = v1beta1_validating_admission_policy_binding_list_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_listValidatingAdmissionPolicy_1(apiClient_t *apiClient, char *pretty, int *allowWatchBookmarks, char *_continue, char *fieldSelector, char *labelSelector, int *limit, char *resourceVersion, char *resourceVersionMatch, int *sendInitialEvents, int *timeoutSeconds, int *watch)
{
    ...
    //nonprimitive not container
    mazu_cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = mazu_cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_admission_policy_list_t *elementToReturn = v1beta1_validating_admission_policy_list_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    mazu_cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_patchValidatingAdmissionPolicyStatus_1(apiClient_t *apiClient, char *name, object_t *body, char *pretty, char *dryRun, char *fieldManager, char *fieldValidation, int *force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingadmissionpolicies/{name}/status");

...
mazu_cJSON *v1_policy_rules_with_subjects_convertToJSON(v1_policy_rules_with_subjects_t *v1_policy_rules_with_subjects) {
    ...
    mazu_cJSON *itemLocal = v1_non_resource_policy_rule_convertToJSON(non_resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    mazu_cJSON *itemLocal = v1_resource_policy_rule_convertToJSON(resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    mazu_cJSON *itemLocal = flowcontrol_v1_subject_convertToJSON(subjectsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_policy_rules_with_subjects_t *v1_policy_rules_with_subjects_parseFromJSON(mazu_cJSON *v1_policy_rules_with_subjectsJSON){
    ...
    // v1_policy_rules_with_subjects->non_resource_rules
    mazu_cJSON *non_resource_rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_policy_rules_with_subjectsJSON, "nonResourceRules");
    ...
    // v1_policy_rules_with_subjects->resource_rules
    mazu_cJSON *resource_rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_policy_rules_with_subjectsJSON, "resourceRules");
    if (resource_rules) { 
    ...
    // v1_policy_rules_with_subjects->subjects
    mazu_cJSON *subjects = mazu_cJSON_GetObjectItemCaseSensitive(v1_policy_rules_with_subjectsJSON, "subjects");
    if (!subjects) {
        goto end;
    }

...
mazu_cJSON *v1_pod_resource_claim_status_convertToJSON(v1_pod_resource_claim_status_t *v1_pod_resource_claim_status) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1_pod_resource_claim_status->name) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_pod_resource_claim_status->resource_claim_name) {
    if(mazu_cJSON_AddStringToObject(item, "resourceClaimName", v1_pod_resource_claim_status->resource_claim_name) == NULL) {
    goto fail; //String
    }
    }
...
v1_pod_resource_claim_status_t *v1_pod_resource_claim_status_parseFromJSON(mazu_cJSON *v1_pod_resource_claim_statusJSON){

    v1_pod_resource_claim_status_t *v1_pod_resource_claim_status_local_var = NULL;

    // v1_pod_resource_claim_status->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_resource_claim_statusJSON, "name");
    if (!name) {
        goto end;
    }
    ...
    // v1_pod_resource_claim_status->resource_claim_name
    mazu_cJSON *resource_claim_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_resource_claim_statusJSON, "resourceClaimName");

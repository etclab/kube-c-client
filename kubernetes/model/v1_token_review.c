...
mazu_cJSON *v1_token_review_convertToJSON(v1_token_review_t *v1_token_review) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_token_review->api_version
    if(v1_token_review->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_token_review->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_token_review->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_token_review->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_token_review->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_token_review->metadata);
    ...
    mazu_cJSON *spec_local_JSON = v1_token_review_spec_convertToJSON(v1_token_review->spec);
    ...
    if(v1_token_review->status) {
    mazu_cJSON *status_local_JSON = v1_token_review_status_convertToJSON(v1_token_review->status);
...
v1_token_review_t *v1_token_review_parseFromJSON(mazu_cJSON *v1_token_reviewJSON){
    ...
    // v1_token_review->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_token_reviewJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_token_review->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_token_reviewJSON, "kind");
    if (kind) { 
    ...
    // v1_token_review->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_token_reviewJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_token_review->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_token_reviewJSON, "spec");
    if (!spec) {
        goto end;
    }
    ...
    // v1_token_review->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_token_reviewJSON, "status");
    if (status) { 

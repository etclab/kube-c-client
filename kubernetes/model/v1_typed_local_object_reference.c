...
mazu_cJSON *v1_typed_local_object_reference_convertToJSON(v1_typed_local_object_reference_t *v1_typed_local_object_reference) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_typed_local_object_reference->api_group
    if(v1_typed_local_object_reference->api_group) {
    if(mazu_cJSON_AddStringToObject(item, "apiGroup", v1_typed_local_object_reference->api_group) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_typed_local_object_reference->kind) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1_typed_local_object_reference->name) == NULL) {
    goto fail; //String
    }
...
v1_typed_local_object_reference_t *v1_typed_local_object_reference_parseFromJSON(mazu_cJSON *v1_typed_local_object_referenceJSON){

    v1_typed_local_object_reference_t *v1_typed_local_object_reference_local_var = NULL;

    // v1_typed_local_object_reference->api_group
    mazu_cJSON *api_group = mazu_cJSON_GetObjectItemCaseSensitive(v1_typed_local_object_referenceJSON, "apiGroup");
    if (api_group) { 
    ...
    // v1_typed_local_object_reference->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_typed_local_object_referenceJSON, "kind");
    if (!kind) {
        goto end;
    }
    ...
    // v1_typed_local_object_reference->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_typed_local_object_referenceJSON, "name");
    if (!name) {
        goto end;
    }

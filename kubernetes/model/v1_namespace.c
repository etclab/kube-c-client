...
mazu_cJSON *v1_namespace_convertToJSON(v1_namespace_t *v1_namespace) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_namespace->api_version
    if(v1_namespace->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_namespace->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_namespace->kind
    if(v1_namespace->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_namespace->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_namespace->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_namespace->metadata);
    ...
    // v1_namespace->spec
    if(v1_namespace->spec) {
    mazu_cJSON *spec_local_JSON = v1_namespace_spec_convertToJSON(v1_namespace->spec);
    ...
    // v1_namespace->status
    if(v1_namespace->status) {
    mazu_cJSON *status_local_JSON = v1_namespace_status_convertToJSON(v1_namespace->status);
...
v1_namespace_t *v1_namespace_parseFromJSON(mazu_cJSON *v1_namespaceJSON){
    ...
    // v1_namespace->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_namespaceJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_namespace->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_namespaceJSON, "kind");
    if (kind) { 
    ...
    // v1_namespace->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_namespaceJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_namespace->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_namespaceJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_namespace_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_namespace->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_namespaceJSON, "status");
    if (status) { 

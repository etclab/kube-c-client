...
mazu_cJSON *v1_custom_resource_definition_names_convertToJSON(v1_custom_resource_definition_names_t *v1_custom_resource_definition_names) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_custom_resource_definition_names->kind) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_custom_resource_definition_names->list_kind) {
    if(mazu_cJSON_AddStringToObject(item, "listKind", v1_custom_resource_definition_names->list_kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "plural", v1_custom_resource_definition_names->plural) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_custom_resource_definition_names->singular) {
    if(mazu_cJSON_AddStringToObject(item, "singular", v1_custom_resource_definition_names->singular) == NULL) {
    goto fail; //String
    }
    }
...
v1_custom_resource_definition_names_t *v1_custom_resource_definition_names_parseFromJSON(mazu_cJSON *v1_custom_resource_definition_namesJSON){
    ...
    // v1_custom_resource_definition_names->categories
    mazu_cJSON *categories = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "categories");
    if (categories) { 
    ...
    // v1_custom_resource_definition_names->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "kind");
    if (!kind) {
        goto end;
    }
    ...
    // v1_custom_resource_definition_names->list_kind
    mazu_cJSON *list_kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "listKind");
    if (list_kind) { 
    if(!mazu_cJSON_IsString(list_kind) && !mazu_cJSON_IsNull(list_kind))
    {
    goto end; //String
    }
    }
    ...
    // v1_custom_resource_definition_names->plural
    mazu_cJSON *plural = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "plural");
    if (!plural) {
        goto end;
    }

    
    if(!mazu_cJSON_IsString(plural))
    {
    goto end; //String
    }

    // v1_custom_resource_definition_names->short_names
    mazu_cJSON *short_names = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "shortNames");
    if (short_names) { 
    ...
    // v1_custom_resource_definition_names->singular
    mazu_cJSON *singular = mazu_cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_namesJSON, "singular");
    if (singular) { 
    if(!mazu_cJSON_IsString(singular) && !mazu_cJSON_IsNull(singular))
    {
    goto end; //String
    }
    }
    ...
    v1_custom_resource_definition_names_local_var = v1_custom_resource_definition_names_create (
        ...
        list_kind && !mazu_cJSON_IsNull(list_kind) ? strdup(list_kind->valuestring) : NULL,
        strdup(plural->valuestring),
        short_names ? short_namesList : NULL,
        singular && !mazu_cJSON_IsNull(singular) ? strdup(singular->valuestring) : NULL
        );

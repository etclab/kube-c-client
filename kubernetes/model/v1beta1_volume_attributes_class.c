...
mazu_cJSON *v1beta1_volume_attributes_class_convertToJSON(v1beta1_volume_attributes_class_t *v1beta1_volume_attributes_class) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1beta1_volume_attributes_class->api_version
    if(v1beta1_volume_attributes_class->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta1_volume_attributes_class->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "driverName", v1beta1_volume_attributes_class->driver_name) == NULL) {
    goto fail; //String
    }
    ...
    if(v1beta1_volume_attributes_class->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta1_volume_attributes_class->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_volume_attributes_class->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1beta1_volume_attributes_class->metadata);
...
v1beta1_volume_attributes_class_t *v1beta1_volume_attributes_class_parseFromJSON(mazu_cJSON *v1beta1_volume_attributes_classJSON){
    ...
    // v1beta1_volume_attributes_class->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_classJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta1_volume_attributes_class->driver_name
    mazu_cJSON *driver_name = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_classJSON, "driverName");
    if (!driver_name) {
        goto end;
    }
    ...
    // v1beta1_volume_attributes_class->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_classJSON, "kind");
    if (kind) { 
    ...
    // v1beta1_volume_attributes_class->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_classJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1beta1_volume_attributes_class->parameters
    mazu_cJSON *parameters = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attributes_classJSON, "parameters");
    if (parameters) { 

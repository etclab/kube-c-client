...
v1_role_binding_list_t *v1_role_binding_list_create(
    ...
    v1_role_binding_list_local_var->api_version = api_version;
...
void v1_role_binding_list_free(v1_role_binding_list_t *v1_role_binding_list) {
    if(NULL == v1_role_binding_list){
        return ;
    }
    listEntry_t *listEntry;
    if (v1_role_binding_list->api_version) {
        free(v1_role_binding_list->api_version);
        v1_role_binding_list->api_version = NULL;
    }
    if (v1_role_binding_list->items) {
        list_ForEach(listEntry, v1_role_binding_list->items) {
            v1_role_binding_free(listEntry->data);
        }
        list_freeList(v1_role_binding_list->items);
        v1_role_binding_list->items = NULL;
    }
    if (v1_role_binding_list->kind) {
        free(v1_role_binding_list->kind);
        v1_role_binding_list->kind = NULL;
    }
    if (v1_role_binding_list->metadata) {
        v1_list_meta_free(v1_role_binding_list->metadata);
        v1_role_binding_list->metadata = NULL;
    }
    free(v1_role_binding_list);
}

mazu_cJSON *v1_role_binding_list_convertToJSON(v1_role_binding_list_t *v1_role_binding_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_role_binding_list->api_version
    if(v1_role_binding_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_role_binding_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_role_binding_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_role_binding_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_role_binding_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_role_binding_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1_role_binding_list->metadata);
...
v1_role_binding_list_t *v1_role_binding_list_parseFromJSON(mazu_cJSON *v1_role_binding_listJSON){

    v1_role_binding_list_t *v1_role_binding_list_local_var = NULL;

    // define the local list for v1_role_binding_list->items
    ...
    // v1_role_binding_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_role_binding_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_role_binding_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_role_binding_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_role_binding_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_role_binding_listJSON, "kind");
    if (kind) { 
    ...
    // v1_role_binding_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_role_binding_listJSON, "metadata");
    if (metadata) { 

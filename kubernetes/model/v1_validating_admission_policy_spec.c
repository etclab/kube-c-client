...
mazu_cJSON *v1_validating_admission_policy_spec_convertToJSON(v1_validating_admission_policy_spec_t *v1_validating_admission_policy_spec) {
    ...
    mazu_cJSON *itemLocal = v1_audit_annotation_convertToJSON(audit_annotationsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_validating_admission_policy_spec->failure_policy) {
    if(mazu_cJSON_AddStringToObject(item, "failurePolicy", v1_validating_admission_policy_spec->failure_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_validating_admission_policy_spec->match_constraints) {
    mazu_cJSON *match_constraints_local_JSON = v1_match_resources_convertToJSON(v1_validating_admission_policy_spec->match_constraints);
    ...
    if(v1_validating_admission_policy_spec->param_kind) {
    mazu_cJSON *param_kind_local_JSON = v1_param_kind_convertToJSON(v1_validating_admission_policy_spec->param_kind);
    ...
    mazu_cJSON *itemLocal = v1_validation_convertToJSON(validationsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    mazu_cJSON *itemLocal = v1_variable_convertToJSON(variablesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_validating_admission_policy_spec_t *v1_validating_admission_policy_spec_parseFromJSON(mazu_cJSON *v1_validating_admission_policy_specJSON){
    ...
    // v1_validating_admission_policy_spec->audit_annotations
    mazu_cJSON *audit_annotations = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "auditAnnotations");
    ...
    // v1_validating_admission_policy_spec->failure_policy
    mazu_cJSON *failure_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "failurePolicy");
    if (failure_policy) { 
    ...
    // v1_validating_admission_policy_spec->match_conditions
    mazu_cJSON *match_conditions = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "matchConditions");
    if (match_conditions) { 
    ...
    // v1_validating_admission_policy_spec->match_constraints
    mazu_cJSON *match_constraints = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "matchConstraints");
    if (match_constraints) { 
    match_constraints_local_nonprim = v1_match_resources_parseFromJSON(match_constraints); //nonprimitive
    }

    // v1_validating_admission_policy_spec->param_kind
    mazu_cJSON *param_kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "paramKind");
    if (param_kind) { 
    param_kind_local_nonprim = v1_param_kind_parseFromJSON(param_kind); //nonprimitive
    }

    // v1_validating_admission_policy_spec->validations
    mazu_cJSON *validations = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "validations");
    if (validations) { 
    ...
    // v1_validating_admission_policy_spec->variables
    mazu_cJSON *variables = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_specJSON, "variables");
    if (variables) { 

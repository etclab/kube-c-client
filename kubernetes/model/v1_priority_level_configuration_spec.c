...
mazu_cJSON *v1_priority_level_configuration_spec_convertToJSON(v1_priority_level_configuration_spec_t *v1_priority_level_configuration_spec) {
    ...
    if(v1_priority_level_configuration_spec->exempt) {
    mazu_cJSON *exempt_local_JSON = v1_exempt_priority_level_configuration_convertToJSON(v1_priority_level_configuration_spec->exempt);
    ...
    if(v1_priority_level_configuration_spec->limited) {
    mazu_cJSON *limited_local_JSON = v1_limited_priority_level_configuration_convertToJSON(v1_priority_level_configuration_spec->limited);
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_priority_level_configuration_spec->type) == NULL) {
    goto fail; //String
    }
...
v1_priority_level_configuration_spec_t *v1_priority_level_configuration_spec_parseFromJSON(mazu_cJSON *v1_priority_level_configuration_specJSON){
    ...
    // v1_priority_level_configuration_spec->exempt
    mazu_cJSON *exempt = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configuration_specJSON, "exempt");
    if (exempt) { 
    exempt_local_nonprim = v1_exempt_priority_level_configuration_parseFromJSON(exempt); //nonprimitive
    }

    // v1_priority_level_configuration_spec->limited
    mazu_cJSON *limited = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configuration_specJSON, "limited");
    if (limited) { 
    limited_local_nonprim = v1_limited_priority_level_configuration_parseFromJSON(limited); //nonprimitive
    }

    // v1_priority_level_configuration_spec->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configuration_specJSON, "type");
    if (!type) {
        goto end;
    }

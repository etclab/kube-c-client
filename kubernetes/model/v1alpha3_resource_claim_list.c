...
mazu_cJSON *v1alpha3_resource_claim_list_convertToJSON(v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1alpha3_resource_claim_list->api_version
    if(v1alpha3_resource_claim_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1alpha3_resource_claim_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1alpha3_resource_claim_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1alpha3_resource_claim_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1alpha3_resource_claim_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha3_resource_claim_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1alpha3_resource_claim_list->metadata);
...
v1alpha3_resource_claim_list_t *v1alpha3_resource_claim_list_parseFromJSON(mazu_cJSON *v1alpha3_resource_claim_listJSON){
    ...
    // v1alpha3_resource_claim_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1alpha3_resource_claim_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1alpha3_resource_claim_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_listJSON, "kind");
    if (kind) { 
    ...
    // v1alpha3_resource_claim_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_listJSON, "metadata");
    if (metadata) { 

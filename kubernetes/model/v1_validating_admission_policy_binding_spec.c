...
mazu_cJSON *v1_validating_admission_policy_binding_spec_convertToJSON(v1_validating_admission_policy_binding_spec_t *v1_validating_admission_policy_binding_spec) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_validating_admission_policy_binding_spec->match_resources
    if(v1_validating_admission_policy_binding_spec->match_resources) {
    mazu_cJSON *match_resources_local_JSON = v1_match_resources_convertToJSON(v1_validating_admission_policy_binding_spec->match_resources);
    if(match_resources_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "matchResources", match_resources_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    if(v1_validating_admission_policy_binding_spec->param_ref) {
    mazu_cJSON *param_ref_local_JSON = v1_param_ref_convertToJSON(v1_validating_admission_policy_binding_spec->param_ref);
    if(param_ref_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "paramRef", param_ref_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    if(v1_validating_admission_policy_binding_spec->policy_name) {
    if(mazu_cJSON_AddStringToObject(item, "policyName", v1_validating_admission_policy_binding_spec->policy_name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_validating_admission_policy_binding_spec->validation_actions) {
    mazu_cJSON *validation_actions = mazu_cJSON_AddArrayToObject(item, "validationActions");
    ...
    if(mazu_cJSON_AddStringToObject(validation_actions, "", (char*)validation_actionsListEntry->data) == NULL)
    {
        goto fail;
    }
    }
...
v1_validating_admission_policy_binding_spec_t *v1_validating_admission_policy_binding_spec_parseFromJSON(mazu_cJSON *v1_validating_admission_policy_binding_specJSON){
    ...
    // v1_validating_admission_policy_binding_spec->match_resources
    mazu_cJSON *match_resources = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_binding_specJSON, "matchResources");
    if (match_resources) { 
    match_resources_local_nonprim = v1_match_resources_parseFromJSON(match_resources); //nonprimitive
    }

    // v1_validating_admission_policy_binding_spec->param_ref
    mazu_cJSON *param_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_binding_specJSON, "paramRef");
    if (param_ref) { 
    param_ref_local_nonprim = v1_param_ref_parseFromJSON(param_ref); //nonprimitive
    }

    // v1_validating_admission_policy_binding_spec->policy_name
    mazu_cJSON *policy_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_binding_specJSON, "policyName");
    if (policy_name) { 
    if(!mazu_cJSON_IsString(policy_name) && !mazu_cJSON_IsNull(policy_name))
    {
    goto end; //String
    }
    }
    ...
    // v1_validating_admission_policy_binding_spec->validation_actions
    mazu_cJSON *validation_actions = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_binding_specJSON, "validationActions");
    if (validation_actions) { 
    mazu_cJSON *validation_actions_local = NULL;
    if(!mazu_cJSON_IsArray(validation_actions)) {
        goto end;//primitive container
    }
    validation_actionsList = list_createList();

    mazu_cJSON_ArrayForEach(validation_actions_local, validation_actions)
    {
        if(!mazu_cJSON_IsString(validation_actions_local))
        {
            goto end;
        }
    ...
    v1_validating_admission_policy_binding_spec_local_var = v1_validating_admission_policy_binding_spec_create (
        match_resources ? match_resources_local_nonprim : NULL,
        param_ref ? param_ref_local_nonprim : NULL,
        policy_name && !mazu_cJSON_IsNull(policy_name) ? strdup(policy_name->valuestring) : NULL,

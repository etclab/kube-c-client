/*
 * v1alpha1_self_subject_review_status.h
 *
 * SelfSubjectReviewStatus is filled by the kube-apiserver and sent back to a user.
 */

#ifndef _v1alpha1_self_subject_review_status_H_
#define _v1alpha1_self_subject_review_status_H_
...
typedef struct v1alpha1_self_subject_review_status_t v1alpha1_self_subject_review_status_t;

#include "v1_user_info.h"



typedef struct v1alpha1_self_subject_review_status_t {
...
#endif /* _v1alpha1_self_subject_review_status_H_ */

...
mazu_cJSON *v1_azure_file_volume_source_convertToJSON(v1_azure_file_volume_source_t *v1_azure_file_volume_source) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_azure_file_volume_source->read_only
    if(v1_azure_file_volume_source->read_only) {
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_azure_file_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "secretName", v1_azure_file_volume_source->secret_name) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "shareName", v1_azure_file_volume_source->share_name) == NULL) {
    goto fail; //String
    }
...
v1_azure_file_volume_source_t *v1_azure_file_volume_source_parseFromJSON(mazu_cJSON *v1_azure_file_volume_sourceJSON){

    v1_azure_file_volume_source_t *v1_azure_file_volume_source_local_var = NULL;

    // v1_azure_file_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_azure_file_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    // v1_azure_file_volume_source->secret_name
    mazu_cJSON *secret_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_azure_file_volume_sourceJSON, "secretName");
    if (!secret_name) {
        goto end;
    }
    ...
    // v1_azure_file_volume_source->share_name
    mazu_cJSON *share_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_azure_file_volume_sourceJSON, "shareName");
    if (!share_name) {
        goto end;
    }

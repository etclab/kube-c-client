...
v1_priority_level_configuration_t *v1_priority_level_configuration_create(
    char *api_version,
    char *kind,
...
mazu_cJSON *v1_priority_level_configuration_convertToJSON(v1_priority_level_configuration_t *v1_priority_level_configuration) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_priority_level_configuration->api_version
    if(v1_priority_level_configuration->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_priority_level_configuration->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_priority_level_configuration->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_priority_level_configuration->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_priority_level_configuration->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_priority_level_configuration->metadata);
    ...
    if(v1_priority_level_configuration->spec) {
    mazu_cJSON *spec_local_JSON = v1_priority_level_configuration_spec_convertToJSON(v1_priority_level_configuration->spec);
    ...
    if(v1_priority_level_configuration->status) {
    mazu_cJSON *status_local_JSON = v1_priority_level_configuration_status_convertToJSON(v1_priority_level_configuration->status);
...
v1_priority_level_configuration_t *v1_priority_level_configuration_parseFromJSON(mazu_cJSON *v1_priority_level_configurationJSON){
    ...
    // v1_priority_level_configuration->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configurationJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_priority_level_configuration->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configurationJSON, "kind");
    if (kind) { 
    ...
    // v1_priority_level_configuration->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configurationJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_priority_level_configuration->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configurationJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_priority_level_configuration_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_priority_level_configuration->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configurationJSON, "status");
    if (status) { 
    status_local_nonprim = v1_priority_level_configuration_status_parseFromJSON(status); //nonprimitive
    }


    v1_priority_level_configuration_local_var = v1_priority_level_configuration_create (

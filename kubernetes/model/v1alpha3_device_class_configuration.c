...
mazu_cJSON *v1alpha3_device_class_configuration_convertToJSON(v1alpha3_device_class_configuration_t *v1alpha3_device_class_configuration) {
    ...
    if(v1alpha3_device_class_configuration->opaque) {
    mazu_cJSON *opaque_local_JSON = v1alpha3_opaque_device_configuration_convertToJSON(v1alpha3_device_class_configuration->opaque);
...
v1alpha3_device_class_configuration_t *v1alpha3_device_class_configuration_parseFromJSON(mazu_cJSON *v1alpha3_device_class_configurationJSON){
    ...
    // v1alpha3_device_class_configuration->opaque
    mazu_cJSON *opaque = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_device_class_configurationJSON, "opaque");
    if (opaque) { 

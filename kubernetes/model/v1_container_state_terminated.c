...
mazu_cJSON *v1_container_state_terminated_convertToJSON(v1_container_state_terminated_t *v1_container_state_terminated) {
    ...
    if(v1_container_state_terminated->container_id) {
    if(mazu_cJSON_AddStringToObject(item, "containerID", v1_container_state_terminated->container_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "exitCode", v1_container_state_terminated->exit_code) == NULL) {
    goto fail; //Numeric
    }
    ...
    if(v1_container_state_terminated->finished_at) {
    if(mazu_cJSON_AddStringToObject(item, "finishedAt", v1_container_state_terminated->finished_at) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_container_state_terminated->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_container_state_terminated->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_container_state_terminated->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_container_state_terminated->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "signal", v1_container_state_terminated->signal) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(v1_container_state_terminated->started_at) {
    if(mazu_cJSON_AddStringToObject(item, "startedAt", v1_container_state_terminated->started_at) == NULL) {
    goto fail; //Date-Time
    }
    }
...
v1_container_state_terminated_t *v1_container_state_terminated_parseFromJSON(mazu_cJSON *v1_container_state_terminatedJSON){
    ...
    // v1_container_state_terminated->container_id
    mazu_cJSON *container_id = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "containerID");
    if (container_id) { 
    ...
    // v1_container_state_terminated->exit_code
    mazu_cJSON *exit_code = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "exitCode");
    if (!exit_code) {
        goto end;
    }

    
    if(!mazu_cJSON_IsNumber(exit_code))
    {
    goto end; //Numeric
    }

    // v1_container_state_terminated->finished_at
    mazu_cJSON *finished_at = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "finishedAt");
    if (finished_at) { 
    if(!mazu_cJSON_IsString(finished_at) && !mazu_cJSON_IsNull(finished_at))
    {
    goto end; //DateTime
    }
    }
    ...
    // v1_container_state_terminated->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "message");
    if (message) { 
    ...
    // v1_container_state_terminated->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "reason");
    if (reason) { 
    ...
    // v1_container_state_terminated->signal
    mazu_cJSON *signal = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "signal");
    if (signal) { 
    if(!mazu_cJSON_IsNumber(signal))
    {
    goto end; //Numeric
    }
    }
    ...
    // v1_container_state_terminated->started_at
    mazu_cJSON *started_at = mazu_cJSON_GetObjectItemCaseSensitive(v1_container_state_terminatedJSON, "startedAt");
    if (started_at) { 
    ...
    v1_container_state_terminated_local_var = v1_container_state_terminated_create (
        ...
        finished_at && !mazu_cJSON_IsNull(finished_at) ? strdup(finished_at->valuestring) : NULL,

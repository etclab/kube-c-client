...
void v1_persistent_volume_claim_condition_free(v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition) {
    ...
    if (v1_persistent_volume_claim_condition->last_probe_time) {
        ...
        v1_persistent_volume_claim_condition->last_probe_time = NULL;
    }
...
mazu_cJSON *v1_persistent_volume_claim_condition_convertToJSON(v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_persistent_volume_claim_condition->last_probe_time
    if(v1_persistent_volume_claim_condition->last_probe_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastProbeTime", v1_persistent_volume_claim_condition->last_probe_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_persistent_volume_claim_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_persistent_volume_claim_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_persistent_volume_claim_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_persistent_volume_claim_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_persistent_volume_claim_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_persistent_volume_claim_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_persistent_volume_claim_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_persistent_volume_claim_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition_parseFromJSON(mazu_cJSON *v1_persistent_volume_claim_conditionJSON){

    v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition_local_var = NULL;

    // v1_persistent_volume_claim_condition->last_probe_time
    mazu_cJSON *last_probe_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "lastProbeTime");
    if (last_probe_time) { 
    ...
    // v1_persistent_volume_claim_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "lastTransitionTime");
    ...
    // v1_persistent_volume_claim_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "message");
    if (message) { 
    ...
    // v1_persistent_volume_claim_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_persistent_volume_claim_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_persistent_volume_claim_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "type");
    if (!type) {
        goto end;
    }

...
mazu_cJSON *v1alpha3_resource_claim_convertToJSON(v1alpha3_resource_claim_t *v1alpha3_resource_claim) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1alpha3_resource_claim->api_version
    if(v1alpha3_resource_claim->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1alpha3_resource_claim->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha3_resource_claim->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1alpha3_resource_claim->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha3_resource_claim->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1alpha3_resource_claim->metadata);
    ...
    mazu_cJSON *spec_local_JSON = v1alpha3_resource_claim_spec_convertToJSON(v1alpha3_resource_claim->spec);
    ...
    if(v1alpha3_resource_claim->status) {
    mazu_cJSON *status_local_JSON = v1alpha3_resource_claim_status_convertToJSON(v1alpha3_resource_claim->status);
...
v1alpha3_resource_claim_t *v1alpha3_resource_claim_parseFromJSON(mazu_cJSON *v1alpha3_resource_claimJSON){
    ...
    // v1alpha3_resource_claim->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claimJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1alpha3_resource_claim->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claimJSON, "kind");
    if (kind) { 
    ...
    // v1alpha3_resource_claim->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claimJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1alpha3_resource_claim->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claimJSON, "spec");
    if (!spec) {
        goto end;
    }
    ...
    // v1alpha3_resource_claim->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claimJSON, "status");
    if (status) { 

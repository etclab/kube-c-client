...
mazu_cJSON *v1_csi_driver_spec_convertToJSON(v1_csi_driver_spec_t *v1_csi_driver_spec) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_csi_driver_spec->attach_required
    if(v1_csi_driver_spec->attach_required) {
    if(mazu_cJSON_AddBoolToObject(item, "attachRequired", v1_csi_driver_spec->attach_required) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_csi_driver_spec->fs_group_policy) {
    if(mazu_cJSON_AddStringToObject(item, "fsGroupPolicy", v1_csi_driver_spec->fs_group_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "podInfoOnMount", v1_csi_driver_spec->pod_info_on_mount) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "requiresRepublish", v1_csi_driver_spec->requires_republish) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "seLinuxMount", v1_csi_driver_spec->se_linux_mount) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "storageCapacity", v1_csi_driver_spec->storage_capacity) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_csi_driver_spec->token_requests) {
    mazu_cJSON *token_requests = mazu_cJSON_AddArrayToObject(item, "tokenRequests");
    ...
    mazu_cJSON *itemLocal = storage_v1_token_request_convertToJSON(token_requestsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    mazu_cJSON_AddItemToArray(token_requests, itemLocal);
    }
    }
    }
    ...
    if(v1_csi_driver_spec->volume_lifecycle_modes) {
    mazu_cJSON *volume_lifecycle_modes = mazu_cJSON_AddArrayToObject(item, "volumeLifecycleModes");
    ...
    if(mazu_cJSON_AddStringToObject(volume_lifecycle_modes, "", (char*)volume_lifecycle_modesListEntry->data) == NULL)
    {
        goto fail;
    }
    }
...
v1_csi_driver_spec_t *v1_csi_driver_spec_parseFromJSON(mazu_cJSON *v1_csi_driver_specJSON){
    ...
    // v1_csi_driver_spec->attach_required
    mazu_cJSON *attach_required = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "attachRequired");
    if (attach_required) { 
    if(!mazu_cJSON_IsBool(attach_required))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_csi_driver_spec->fs_group_policy
    mazu_cJSON *fs_group_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "fsGroupPolicy");
    if (fs_group_policy) { 
    if(!mazu_cJSON_IsString(fs_group_policy) && !mazu_cJSON_IsNull(fs_group_policy))
    {
    goto end; //String
    }
    }
    ...
    // v1_csi_driver_spec->pod_info_on_mount
    mazu_cJSON *pod_info_on_mount = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "podInfoOnMount");
    if (pod_info_on_mount) { 
    if(!mazu_cJSON_IsBool(pod_info_on_mount))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_csi_driver_spec->requires_republish
    mazu_cJSON *requires_republish = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "requiresRepublish");
    if (requires_republish) { 
    if(!mazu_cJSON_IsBool(requires_republish))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_csi_driver_spec->se_linux_mount
    mazu_cJSON *se_linux_mount = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "seLinuxMount");
    if (se_linux_mount) { 
    if(!mazu_cJSON_IsBool(se_linux_mount))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_csi_driver_spec->storage_capacity
    mazu_cJSON *storage_capacity = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "storageCapacity");
    if (storage_capacity) { 
    if(!mazu_cJSON_IsBool(storage_capacity))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_csi_driver_spec->token_requests
    mazu_cJSON *token_requests = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "tokenRequests");
    if (token_requests) { 
    mazu_cJSON *token_requests_local_nonprimitive = NULL;
    if(!mazu_cJSON_IsArray(token_requests)){
        goto end; //nonprimitive container
    }

    token_requestsList = list_createList();

    mazu_cJSON_ArrayForEach(token_requests_local_nonprimitive,token_requests )
    {
        if(!mazu_cJSON_IsObject(token_requests_local_nonprimitive)){
            goto end;
        }
    ...
    // v1_csi_driver_spec->volume_lifecycle_modes
    mazu_cJSON *volume_lifecycle_modes = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_driver_specJSON, "volumeLifecycleModes");
    if (volume_lifecycle_modes) { 
    mazu_cJSON *volume_lifecycle_modes_local = NULL;
    if(!mazu_cJSON_IsArray(volume_lifecycle_modes)) {
        goto end;//primitive container
    }
    volume_lifecycle_modesList = list_createList();

    mazu_cJSON_ArrayForEach(volume_lifecycle_modes_local, volume_lifecycle_modes)
    {
        if(!mazu_cJSON_IsString(volume_lifecycle_modes_local))
        {
            goto end;
        }
    ...
    v1_csi_driver_spec_local_var = v1_csi_driver_spec_create (
        ...
        fs_group_policy && !mazu_cJSON_IsNull(fs_group_policy) ? strdup(fs_group_policy->valuestring) : NULL,

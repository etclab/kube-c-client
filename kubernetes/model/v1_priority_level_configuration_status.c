...
v1_priority_level_configuration_status_t *v1_priority_level_configuration_status_create(
    list_t *conditions
    ) {
...
mazu_cJSON *v1_priority_level_configuration_status_convertToJSON(v1_priority_level_configuration_status_t *v1_priority_level_configuration_status) {
    ...
    mazu_cJSON *itemLocal = v1_priority_level_configuration_condition_convertToJSON(conditionsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_priority_level_configuration_status_t *v1_priority_level_configuration_status_parseFromJSON(mazu_cJSON *v1_priority_level_configuration_statusJSON){
    ...
    // v1_priority_level_configuration_status->conditions
    mazu_cJSON *conditions = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_level_configuration_statusJSON, "conditions");
    if (conditions) { 
    ...
    v1_priority_level_configuration_status_local_var = v1_priority_level_configuration_status_create (

...
v1_cluster_role_binding_t *v1_cluster_role_binding_create(
    ...
    v1_cluster_role_binding_t *v1_cluster_role_binding_local_var = malloc(sizeof(v1_cluster_role_binding_t));
    if (!v1_cluster_role_binding_local_var) {
        return NULL;
    }
    v1_cluster_role_binding_local_var->api_version = api_version;
    v1_cluster_role_binding_local_var->kind = kind;
    v1_cluster_role_binding_local_var->metadata = metadata;

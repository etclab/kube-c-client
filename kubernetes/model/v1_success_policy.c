...
mazu_cJSON *v1_success_policy_convertToJSON(v1_success_policy_t *v1_success_policy) {
    ...
    mazu_cJSON *itemLocal = v1_success_policy_rule_convertToJSON(rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_success_policy_t *v1_success_policy_parseFromJSON(mazu_cJSON *v1_success_policyJSON){
    ...
    // v1_success_policy->rules
    mazu_cJSON *rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_success_policyJSON, "rules");
    if (!rules) {
        goto end;
    }

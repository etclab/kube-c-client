...
mazu_cJSON *v1beta1_type_checking_convertToJSON(v1beta1_type_checking_t *v1beta1_type_checking) {
    ...
    mazu_cJSON *itemLocal = v1beta1_expression_warning_convertToJSON(expression_warningsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1beta1_type_checking_t *v1beta1_type_checking_parseFromJSON(mazu_cJSON *v1beta1_type_checkingJSON){
    ...
    // v1beta1_type_checking->expression_warnings
    mazu_cJSON *expression_warnings = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_type_checkingJSON, "expressionWarnings");

...
mazu_cJSON *v1_pod_condition_convertToJSON(v1_pod_condition_t *v1_pod_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_pod_condition->last_probe_time
    if(v1_pod_condition->last_probe_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastProbeTime", v1_pod_condition->last_probe_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_pod_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_pod_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_pod_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_pod_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_pod_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_pod_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_pod_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_pod_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_pod_condition_t *v1_pod_condition_parseFromJSON(mazu_cJSON *v1_pod_conditionJSON){

    v1_pod_condition_t *v1_pod_condition_local_var = NULL;

    // v1_pod_condition->last_probe_time
    mazu_cJSON *last_probe_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "lastProbeTime");
    if (last_probe_time) { 
    ...
    // v1_pod_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "lastTransitionTime");
    ...
    // v1_pod_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "message");
    if (message) { 
    ...
    // v1_pod_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_pod_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_pod_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_conditionJSON, "type");
    if (!type) {
        goto end;
    }

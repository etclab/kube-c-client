...
v1_glusterfs_persistent_volume_source_t *v1_glusterfs_persistent_volume_source_create(
    ...
    v1_glusterfs_persistent_volume_source_local_var->endpoints_namespace = endpoints_namespace;
...
mazu_cJSON *v1_glusterfs_persistent_volume_source_convertToJSON(v1_glusterfs_persistent_volume_source_t *v1_glusterfs_persistent_volume_source) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "endpoints", v1_glusterfs_persistent_volume_source->endpoints) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_glusterfs_persistent_volume_source->endpoints_namespace) {
    if(mazu_cJSON_AddStringToObject(item, "endpointsNamespace", v1_glusterfs_persistent_volume_source->endpoints_namespace) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "path", v1_glusterfs_persistent_volume_source->path) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_glusterfs_persistent_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
...
v1_glusterfs_persistent_volume_source_t *v1_glusterfs_persistent_volume_source_parseFromJSON(mazu_cJSON *v1_glusterfs_persistent_volume_sourceJSON){

    v1_glusterfs_persistent_volume_source_t *v1_glusterfs_persistent_volume_source_local_var = NULL;

    // v1_glusterfs_persistent_volume_source->endpoints
    mazu_cJSON *endpoints = mazu_cJSON_GetObjectItemCaseSensitive(v1_glusterfs_persistent_volume_sourceJSON, "endpoints");
    if (!endpoints) {
        goto end;
    }
    ...
    // v1_glusterfs_persistent_volume_source->endpoints_namespace
    mazu_cJSON *endpoints_namespace = mazu_cJSON_GetObjectItemCaseSensitive(v1_glusterfs_persistent_volume_sourceJSON, "endpointsNamespace");
    if (endpoints_namespace) { 
    if(!mazu_cJSON_IsString(endpoints_namespace) && !mazu_cJSON_IsNull(endpoints_namespace))
    {
    goto end; //String
    }
    }
    ...
    // v1_glusterfs_persistent_volume_source->path
    mazu_cJSON *path = mazu_cJSON_GetObjectItemCaseSensitive(v1_glusterfs_persistent_volume_sourceJSON, "path");
    if (!path) {
        goto end;
    }
    ...
    // v1_glusterfs_persistent_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_glusterfs_persistent_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    v1_glusterfs_persistent_volume_source_local_var = v1_glusterfs_persistent_volume_source_create (
        ...
        endpoints_namespace && !mazu_cJSON_IsNull(endpoints_namespace) ? strdup(endpoints_namespace->valuestring) : NULL,

...
mazu_cJSON *v1_api_group_convertToJSON(v1_api_group_t *v1_api_group) {
    ...
    if(v1_api_group->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_api_group->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_api_group->kind
    if(v1_api_group->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_api_group->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1_api_group->name) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_api_group->preferred_version) {
    mazu_cJSON *preferred_version_local_JSON = v1_group_version_for_discovery_convertToJSON(v1_api_group->preferred_version);
    if(preferred_version_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "preferredVersion", preferred_version_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_group_version_for_discovery_convertToJSON(versionsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_api_group_t *v1_api_group_parseFromJSON(mazu_cJSON *v1_api_groupJSON){
    ...
    // v1_api_group->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_api_group->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "kind");
    if (kind) { 
    ...
    // v1_api_group->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "name");
    if (!name) {
        goto end;
    }
    ...
    // v1_api_group->preferred_version
    mazu_cJSON *preferred_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "preferredVersion");
    if (preferred_version) { 
    preferred_version_local_nonprim = v1_group_version_for_discovery_parseFromJSON(preferred_version); //nonprimitive
    }

    // v1_api_group->server_address_by_client_cidrs
    mazu_cJSON *server_address_by_client_cidrs = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "serverAddressByClientCIDRs");
    ...
    // v1_api_group->versions
    mazu_cJSON *versions = mazu_cJSON_GetObjectItemCaseSensitive(v1_api_groupJSON, "versions");
    if (!versions) {
        goto end;
    }

...
mazu_cJSON *v1beta3_flow_schema_list_convertToJSON(v1beta3_flow_schema_list_t *v1beta3_flow_schema_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1beta3_flow_schema_list->api_version
    if(v1beta3_flow_schema_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta3_flow_schema_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1beta3_flow_schema_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1beta3_flow_schema_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta3_flow_schema_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta3_flow_schema_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1beta3_flow_schema_list->metadata);
...
v1beta3_flow_schema_list_t *v1beta3_flow_schema_list_parseFromJSON(mazu_cJSON *v1beta3_flow_schema_listJSON){
    ...
    // v1beta3_flow_schema_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta3_flow_schema_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta3_flow_schema_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1beta3_flow_schema_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1beta3_flow_schema_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta3_flow_schema_listJSON, "kind");
    if (kind) { 
    ...
    // v1beta3_flow_schema_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1beta3_flow_schema_listJSON, "metadata");
    if (metadata) { 

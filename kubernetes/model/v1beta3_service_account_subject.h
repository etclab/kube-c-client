/*
 * v1beta3_service_account_subject.h
 *
 * ServiceAccountSubject holds detailed information for service-account-kind subject.
 */

#ifndef _v1beta3_service_account_subject_H_
...
typedef struct v1beta3_service_account_subject_t v1beta3_service_account_subject_t;




typedef struct v1beta3_service_account_subject_t {
    char *name; // string
    char *_namespace; // string

} v1beta3_service_account_subject_t;

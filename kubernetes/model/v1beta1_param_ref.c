...
mazu_cJSON *v1beta1_param_ref_convertToJSON(v1beta1_param_ref_t *v1beta1_param_ref) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1beta1_param_ref->name
    if(v1beta1_param_ref->name) {
    if(mazu_cJSON_AddStringToObject(item, "name", v1beta1_param_ref->name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_param_ref->_namespace) {
    if(mazu_cJSON_AddStringToObject(item, "namespace", v1beta1_param_ref->_namespace) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_param_ref->parameter_not_found_action) {
    if(mazu_cJSON_AddStringToObject(item, "parameterNotFoundAction", v1beta1_param_ref->parameter_not_found_action) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_param_ref->selector) {
    mazu_cJSON *selector_local_JSON = v1_label_selector_convertToJSON(v1beta1_param_ref->selector);
...
v1beta1_param_ref_t *v1beta1_param_ref_parseFromJSON(mazu_cJSON *v1beta1_param_refJSON){
    ...
    // v1beta1_param_ref->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_refJSON, "name");
    if (name) { 
    ...
    // v1beta1_param_ref->_namespace
    mazu_cJSON *_namespace = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_refJSON, "namespace");
    if (_namespace) { 
    ...
    // v1beta1_param_ref->parameter_not_found_action
    mazu_cJSON *parameter_not_found_action = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_refJSON, "parameterNotFoundAction");
    ...
    // v1beta1_param_ref->selector
    mazu_cJSON *selector = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_refJSON, "selector");
    if (selector) { 

...
mazu_cJSON *v1_downward_api_volume_file_convertToJSON(v1_downward_api_volume_file_t *v1_downward_api_volume_file) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_downward_api_volume_file->field_ref
    if(v1_downward_api_volume_file->field_ref) {
    mazu_cJSON *field_ref_local_JSON = v1_object_field_selector_convertToJSON(v1_downward_api_volume_file->field_ref);
    ...
    if(mazu_cJSON_AddNumberToObject(item, "mode", v1_downward_api_volume_file->mode) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "path", v1_downward_api_volume_file->path) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_downward_api_volume_file->resource_field_ref) {
    mazu_cJSON *resource_field_ref_local_JSON = v1_resource_field_selector_convertToJSON(v1_downward_api_volume_file->resource_field_ref);
...
v1_downward_api_volume_file_t *v1_downward_api_volume_file_parseFromJSON(mazu_cJSON *v1_downward_api_volume_fileJSON){
    ...
    // v1_downward_api_volume_file->field_ref
    mazu_cJSON *field_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_downward_api_volume_fileJSON, "fieldRef");
    if (field_ref) { 
    field_ref_local_nonprim = v1_object_field_selector_parseFromJSON(field_ref); //nonprimitive
    }

    // v1_downward_api_volume_file->mode
    mazu_cJSON *mode = mazu_cJSON_GetObjectItemCaseSensitive(v1_downward_api_volume_fileJSON, "mode");
    if (mode) { 
    ...
    // v1_downward_api_volume_file->path
    mazu_cJSON *path = mazu_cJSON_GetObjectItemCaseSensitive(v1_downward_api_volume_fileJSON, "path");
    if (!path) {
        goto end;
    }
    ...
    // v1_downward_api_volume_file->resource_field_ref
    mazu_cJSON *resource_field_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_downward_api_volume_fileJSON, "resourceFieldRef");

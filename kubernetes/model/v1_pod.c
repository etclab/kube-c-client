...
mazu_cJSON *v1_pod_convertToJSON(v1_pod_t *v1_pod) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_pod->api_version
    if(v1_pod->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_pod->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_pod->kind
    if(v1_pod->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_pod->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_pod->metadata
    if(v1_pod->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_pod->metadata);
    ...
    // v1_pod->spec
    if(v1_pod->spec) {
    mazu_cJSON *spec_local_JSON = v1_pod_spec_convertToJSON(v1_pod->spec);
    ...
    // v1_pod->status
    if(v1_pod->status) {
    mazu_cJSON *status_local_JSON = v1_pod_status_convertToJSON(v1_pod->status);
...
v1_pod_t *v1_pod_parseFromJSON(mazu_cJSON *v1_podJSON){
    ...
    // v1_pod->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_podJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_pod->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_podJSON, "kind");
    if (kind) { 
    ...
    // v1_pod->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_podJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_pod->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_podJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_pod_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_pod->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_podJSON, "status");
    if (status) { 

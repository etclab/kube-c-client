...
v1_pod_affinity_t *v1_pod_affinity_create(
    ...
    v1_pod_affinity_local_var->preferred_during_scheduling_ignored_during_execution = preferred_during_scheduling_ignored_during_execution;
    v1_pod_affinity_local_var->required_during_scheduling_ignored_during_execution = required_during_scheduling_ignored_during_execution;
...
void v1_pod_affinity_free(v1_pod_affinity_t *v1_pod_affinity) {
    ...
    if (v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
        ...
        list_freeList(v1_pod_affinity->preferred_during_scheduling_ignored_during_execution);
    ...
    if (v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
        ...
        list_freeList(v1_pod_affinity->required_during_scheduling_ignored_during_execution);
        v1_pod_affinity->required_during_scheduling_ignored_during_execution = NULL;
    }
    free(v1_pod_affinity);
}

mazu_cJSON *v1_pod_affinity_convertToJSON(v1_pod_affinity_t *v1_pod_affinity) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_pod_affinity->preferred_during_scheduling_ignored_during_execution
    if(v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
    mazu_cJSON *preferred_during_scheduling_ignored_during_execution = mazu_cJSON_AddArrayToObject(item, "preferredDuringSchedulingIgnoredDuringExecution");
    ...
    if (v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
    list_ForEach(preferred_during_scheduling_ignored_during_executionListEntry, v1_pod_affinity->preferred_during_scheduling_ignored_during_execution) {
    mazu_cJSON *itemLocal = v1_weighted_pod_affinity_term_convertToJSON(preferred_during_scheduling_ignored_during_executionListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    mazu_cJSON_AddItemToArray(preferred_during_scheduling_ignored_during_execution, itemLocal);
    }
    }
    }
    ...
    if(v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
    mazu_cJSON *required_during_scheduling_ignored_during_execution = mazu_cJSON_AddArrayToObject(item, "requiredDuringSchedulingIgnoredDuringExecution");
    ...
    if (v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
    list_ForEach(required_during_scheduling_ignored_during_executionListEntry, v1_pod_affinity->required_during_scheduling_ignored_during_execution) {
    mazu_cJSON *itemLocal = v1_pod_affinity_term_convertToJSON(required_during_scheduling_ignored_during_executionListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    mazu_cJSON_AddItemToArray(required_during_scheduling_ignored_during_execution, itemLocal);
    }
    }
    }
...
v1_pod_affinity_t *v1_pod_affinity_parseFromJSON(mazu_cJSON *v1_pod_affinityJSON){

    v1_pod_affinity_t *v1_pod_affinity_local_var = NULL;

    // define the local list for v1_pod_affinity->preferred_during_scheduling_ignored_during_execution
    list_t *preferred_during_scheduling_ignored_during_executionList = NULL;

    // define the local list for v1_pod_affinity->required_during_scheduling_ignored_during_execution
    list_t *required_during_scheduling_ignored_during_executionList = NULL;

    // v1_pod_affinity->preferred_during_scheduling_ignored_during_execution
    mazu_cJSON *preferred_during_scheduling_ignored_during_execution = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_affinityJSON, "preferredDuringSchedulingIgnoredDuringExecution");
    if (preferred_during_scheduling_ignored_during_execution) { 
    mazu_cJSON *preferred_during_scheduling_ignored_during_execution_local_nonprimitive = NULL;
    if(!mazu_cJSON_IsArray(preferred_during_scheduling_ignored_during_execution)){
        goto end; //nonprimitive container
    }

    preferred_during_scheduling_ignored_during_executionList = list_createList();

    mazu_cJSON_ArrayForEach(preferred_during_scheduling_ignored_during_execution_local_nonprimitive,preferred_during_scheduling_ignored_during_execution )
    {
        if(!mazu_cJSON_IsObject(preferred_during_scheduling_ignored_during_execution_local_nonprimitive)){
            goto end;
        }
    ...
    // v1_pod_affinity->required_during_scheduling_ignored_during_execution
    mazu_cJSON *required_during_scheduling_ignored_during_execution = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_affinityJSON, "requiredDuringSchedulingIgnoredDuringExecution");
    if (required_during_scheduling_ignored_during_execution) { 
    mazu_cJSON *required_during_scheduling_ignored_during_execution_local_nonprimitive = NULL;
    if(!mazu_cJSON_IsArray(required_during_scheduling_ignored_during_execution)){
        goto end; //nonprimitive container
    }

    required_during_scheduling_ignored_during_executionList = list_createList();

    mazu_cJSON_ArrayForEach(required_during_scheduling_ignored_during_execution_local_nonprimitive,required_during_scheduling_ignored_during_execution )
    {
        if(!mazu_cJSON_IsObject(required_during_scheduling_ignored_during_execution_local_nonprimitive)){
            goto end;
        }

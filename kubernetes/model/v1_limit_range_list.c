...
void v1_limit_range_list_free(v1_limit_range_list_t *v1_limit_range_list) {
    ...
    if (v1_limit_range_list->items) {
        ...
        list_freeList(v1_limit_range_list->items);
...
mazu_cJSON *v1_limit_range_list_convertToJSON(v1_limit_range_list_t *v1_limit_range_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_limit_range_list->api_version
    if(v1_limit_range_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_limit_range_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_limit_range_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_limit_range_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_limit_range_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_limit_range_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1_limit_range_list->metadata);
...
v1_limit_range_list_t *v1_limit_range_list_parseFromJSON(mazu_cJSON *v1_limit_range_listJSON){
    ...
    // v1_limit_range_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_limit_range_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_limit_range_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_limit_range_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_limit_range_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_limit_range_listJSON, "kind");
    if (kind) { 
    ...
    // v1_limit_range_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_limit_range_listJSON, "metadata");
    if (metadata) { 

...
v1_network_policy_list_t *v1_network_policy_list_create(
    ...
    v1_network_policy_list_local_var->api_version = api_version;
...
void v1_network_policy_list_free(v1_network_policy_list_t *v1_network_policy_list) {
    ...
    if (v1_network_policy_list->api_version) {
        free(v1_network_policy_list->api_version);
        v1_network_policy_list->api_version = NULL;
    }
...
mazu_cJSON *v1_network_policy_list_convertToJSON(v1_network_policy_list_t *v1_network_policy_list) {
    ...
    if(v1_network_policy_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_network_policy_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_network_policy_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_network_policy_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_network_policy_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_network_policy_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1_network_policy_list->metadata);
...
v1_network_policy_list_t *v1_network_policy_list_parseFromJSON(mazu_cJSON *v1_network_policy_listJSON){
    ...
    // v1_network_policy_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_network_policy_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_network_policy_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_network_policy_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_network_policy_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_network_policy_listJSON, "kind");
    if (kind) { 
    ...
    // v1_network_policy_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_network_policy_listJSON, "metadata");
    if (metadata) { 

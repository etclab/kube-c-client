...
mazu_cJSON *v1beta1_service_cidr_convertToJSON(v1beta1_service_cidr_t *v1beta1_service_cidr) {
    ...
    if(v1beta1_service_cidr->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta1_service_cidr->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_service_cidr->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta1_service_cidr->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_service_cidr->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1beta1_service_cidr->metadata);
    ...
    if(v1beta1_service_cidr->spec) {
    mazu_cJSON *spec_local_JSON = v1beta1_service_cidr_spec_convertToJSON(v1beta1_service_cidr->spec);
    ...
    if(v1beta1_service_cidr->status) {
    mazu_cJSON *status_local_JSON = v1beta1_service_cidr_status_convertToJSON(v1beta1_service_cidr->status);
...
v1beta1_service_cidr_t *v1beta1_service_cidr_parseFromJSON(mazu_cJSON *v1beta1_service_cidrJSON){
    ...
    // v1beta1_service_cidr->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_service_cidrJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta1_service_cidr->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_service_cidrJSON, "kind");
    if (kind) { 
    ...
    // v1beta1_service_cidr->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_service_cidrJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1beta1_service_cidr->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_service_cidrJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1beta1_service_cidr_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1beta1_service_cidr->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_service_cidrJSON, "status");
    if (status) { 

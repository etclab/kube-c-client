...
mazu_cJSON *v1alpha3_resource_claim_template_convertToJSON(v1alpha3_resource_claim_template_t *v1alpha3_resource_claim_template) {
    ...
    if(v1alpha3_resource_claim_template->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1alpha3_resource_claim_template->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha3_resource_claim_template->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1alpha3_resource_claim_template->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1alpha3_resource_claim_template->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1alpha3_resource_claim_template->metadata);
    ...
    mazu_cJSON *spec_local_JSON = v1alpha3_resource_claim_template_spec_convertToJSON(v1alpha3_resource_claim_template->spec);
...
v1alpha3_resource_claim_template_t *v1alpha3_resource_claim_template_parseFromJSON(mazu_cJSON *v1alpha3_resource_claim_templateJSON){
    ...
    // v1alpha3_resource_claim_template->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_templateJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1alpha3_resource_claim_template->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_templateJSON, "kind");
    if (kind) { 
    ...
    // v1alpha3_resource_claim_template->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_templateJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1alpha3_resource_claim_template->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1alpha3_resource_claim_templateJSON, "spec");
    if (!spec) {
        goto end;
    }

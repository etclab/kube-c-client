...
mazu_cJSON *v1_node_convertToJSON(v1_node_t *v1_node) {
    ...
    // v1_node->api_version
    if(v1_node->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_node->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_node->kind
    if(v1_node->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_node->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_node->metadata
    if(v1_node->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_node->metadata);
    ...
    // v1_node->spec
    if(v1_node->spec) {
    mazu_cJSON *spec_local_JSON = v1_node_spec_convertToJSON(v1_node->spec);
    ...
    // v1_node->status
    if(v1_node->status) {
    mazu_cJSON *status_local_JSON = v1_node_status_convertToJSON(v1_node->status);
...
v1_node_t *v1_node_parseFromJSON(mazu_cJSON *v1_nodeJSON){
    ...
    // v1_node->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_nodeJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_node->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_nodeJSON, "kind");
    if (kind) { 
    ...
    // v1_node->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_nodeJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_node->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_nodeJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_node_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_node->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_nodeJSON, "status");
    if (status) { 

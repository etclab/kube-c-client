...
v1_validating_webhook_t *v1_validating_webhook_create(
    ...
    v1_validating_webhook_local_var->match_conditions = match_conditions;
...
void v1_validating_webhook_free(v1_validating_webhook_t *v1_validating_webhook) {
    ...
    if (v1_validating_webhook->match_conditions) {
        list_ForEach(listEntry, v1_validating_webhook->match_conditions) {
            v1_match_condition_free(listEntry->data);
        }
        list_freeList(v1_validating_webhook->match_conditions);
        v1_validating_webhook->match_conditions = NULL;
    }
...
mazu_cJSON *v1_validating_webhook_convertToJSON(v1_validating_webhook_t *v1_validating_webhook) {
    ...
    mazu_cJSON *client_config_local_JSON = admissionregistration_v1_webhook_client_config_convertToJSON(v1_validating_webhook->client_config);
    ...
    if(v1_validating_webhook->failure_policy) {
    if(mazu_cJSON_AddStringToObject(item, "failurePolicy", v1_validating_webhook->failure_policy) == NULL) {
    goto fail; //String
    }
    }


    // v1_validating_webhook->match_conditions
    if(v1_validating_webhook->match_conditions) {
    ...
    if (v1_validating_webhook->match_conditions) {
    list_ForEach(match_conditionsListEntry, v1_validating_webhook->match_conditions) {
    ...
    if(v1_validating_webhook->match_policy) {
    if(mazu_cJSON_AddStringToObject(item, "matchPolicy", v1_validating_webhook->match_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1_validating_webhook->name) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_validating_webhook->namespace_selector) {
    mazu_cJSON *namespace_selector_local_JSON = v1_label_selector_convertToJSON(v1_validating_webhook->namespace_selector);
    ...
    if(v1_validating_webhook->object_selector) {
    mazu_cJSON *object_selector_local_JSON = v1_label_selector_convertToJSON(v1_validating_webhook->object_selector);
    ...
    if(mazu_cJSON_AddStringToObject(item, "sideEffects", v1_validating_webhook->side_effects) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "timeoutSeconds", v1_validating_webhook->timeout_seconds) == NULL) {
    goto fail; //Numeric
    }
    }
...
v1_validating_webhook_t *v1_validating_webhook_parseFromJSON(mazu_cJSON *v1_validating_webhookJSON){

    v1_validating_webhook_t *v1_validating_webhook_local_var = NULL;

    // define the local list for v1_validating_webhook->admission_review_versions
    ...
    // define the local list for v1_validating_webhook->match_conditions
    ...
    // define the local list for v1_validating_webhook->rules
    list_t *rulesList = NULL;

    // v1_validating_webhook->admission_review_versions
    mazu_cJSON *admission_review_versions = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "admissionReviewVersions");
    ...
    // v1_validating_webhook->client_config
    mazu_cJSON *client_config = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "clientConfig");
    if (!client_config) {
        goto end;
    }
    ...
    // v1_validating_webhook->failure_policy
    mazu_cJSON *failure_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "failurePolicy");
    if (failure_policy) { 
    ...
    // v1_validating_webhook->match_conditions
    mazu_cJSON *match_conditions = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "matchConditions");
    if (match_conditions) { 
    ...
    // v1_validating_webhook->match_policy
    mazu_cJSON *match_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "matchPolicy");
    if (match_policy) { 
    ...
    // v1_validating_webhook->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "name");
    if (!name) {
        goto end;
    }
    ...
    // v1_validating_webhook->namespace_selector
    mazu_cJSON *namespace_selector = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "namespaceSelector");
    if (namespace_selector) { 
    namespace_selector_local_nonprim = v1_label_selector_parseFromJSON(namespace_selector); //nonprimitive
    }

    // v1_validating_webhook->object_selector
    mazu_cJSON *object_selector = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "objectSelector");
    if (object_selector) { 
    object_selector_local_nonprim = v1_label_selector_parseFromJSON(object_selector); //nonprimitive
    }

    // v1_validating_webhook->rules
    mazu_cJSON *rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "rules");
    if (rules) { 
    ...
    // v1_validating_webhook->side_effects
    mazu_cJSON *side_effects = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "sideEffects");
    if (!side_effects) {
        goto end;
    }
    ...
    // v1_validating_webhook->timeout_seconds
    mazu_cJSON *timeout_seconds = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_webhookJSON, "timeoutSeconds");
    if (timeout_seconds) { 

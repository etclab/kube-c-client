...
mazu_cJSON *v1_csi_volume_source_convertToJSON(v1_csi_volume_source_t *v1_csi_volume_source) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "driver", v1_csi_volume_source->driver) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_csi_volume_source->fs_type) {
    if(mazu_cJSON_AddStringToObject(item, "fsType", v1_csi_volume_source->fs_type) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_csi_volume_source->node_publish_secret_ref) {
    mazu_cJSON *node_publish_secret_ref_local_JSON = v1_local_object_reference_convertToJSON(v1_csi_volume_source->node_publish_secret_ref);
    ...
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_csi_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
...
v1_csi_volume_source_t *v1_csi_volume_source_parseFromJSON(mazu_cJSON *v1_csi_volume_sourceJSON){
    ...
    // v1_csi_volume_source->driver
    mazu_cJSON *driver = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_volume_sourceJSON, "driver");
    if (!driver) {
        goto end;
    }
    ...
    // v1_csi_volume_source->fs_type
    mazu_cJSON *fs_type = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_volume_sourceJSON, "fsType");
    if (fs_type) { 
    ...
    // v1_csi_volume_source->node_publish_secret_ref
    mazu_cJSON *node_publish_secret_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_volume_sourceJSON, "nodePublishSecretRef");
    ...
    // v1_csi_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    // v1_csi_volume_source->volume_attributes
    mazu_cJSON *volume_attributes = mazu_cJSON_GetObjectItemCaseSensitive(v1_csi_volume_sourceJSON, "volumeAttributes");

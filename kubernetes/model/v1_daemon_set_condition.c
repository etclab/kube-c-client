...
mazu_cJSON *v1_daemon_set_condition_convertToJSON(v1_daemon_set_condition_t *v1_daemon_set_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_daemon_set_condition->last_transition_time
    if(v1_daemon_set_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_daemon_set_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_daemon_set_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_daemon_set_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_daemon_set_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_daemon_set_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_daemon_set_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_daemon_set_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_daemon_set_condition_t *v1_daemon_set_condition_parseFromJSON(mazu_cJSON *v1_daemon_set_conditionJSON){

    v1_daemon_set_condition_t *v1_daemon_set_condition_local_var = NULL;

    // v1_daemon_set_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_set_conditionJSON, "lastTransitionTime");
    ...
    // v1_daemon_set_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_set_conditionJSON, "message");
    if (message) { 
    ...
    // v1_daemon_set_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_set_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_daemon_set_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_set_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_daemon_set_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_set_conditionJSON, "type");
    if (!type) {
        goto end;
    }

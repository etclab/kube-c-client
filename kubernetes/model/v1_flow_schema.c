...
v1_flow_schema_t *v1_flow_schema_create(
    char *api_version,
    char *kind,
...
mazu_cJSON *v1_flow_schema_convertToJSON(v1_flow_schema_t *v1_flow_schema) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_flow_schema->api_version
    if(v1_flow_schema->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_flow_schema->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_flow_schema->kind
    if(v1_flow_schema->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_flow_schema->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_flow_schema->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_flow_schema->metadata);
    ...
    // v1_flow_schema->spec
    if(v1_flow_schema->spec) {
    mazu_cJSON *spec_local_JSON = v1_flow_schema_spec_convertToJSON(v1_flow_schema->spec);
    ...
    if(v1_flow_schema->status) {
    mazu_cJSON *status_local_JSON = v1_flow_schema_status_convertToJSON(v1_flow_schema->status);
...
v1_flow_schema_t *v1_flow_schema_parseFromJSON(mazu_cJSON *v1_flow_schemaJSON){
    ...
    // v1_flow_schema->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_flow_schemaJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_flow_schema->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_flow_schemaJSON, "kind");
    if (kind) { 
    ...
    // v1_flow_schema->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_flow_schemaJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_flow_schema->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_flow_schemaJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_flow_schema_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_flow_schema->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_flow_schemaJSON, "status");
    if (status) { 
    status_local_nonprim = v1_flow_schema_status_parseFromJSON(status); //nonprimitive
    }


    v1_flow_schema_local_var = v1_flow_schema_create (

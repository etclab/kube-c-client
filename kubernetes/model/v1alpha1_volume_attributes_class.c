...
#include <string.h>
#include <stdio.h>
#include "v1alpha1_volume_attributes_class.h"
...
v1alpha1_volume_attributes_class_t *v1alpha1_volume_attributes_class_create(
    ...
    v1alpha1_volume_attributes_class_t *v1alpha1_volume_attributes_class_local_var = malloc(sizeof(v1alpha1_volume_attributes_class_t));
    if (!v1alpha1_volume_attributes_class_local_var) {
        return NULL;
    }
    v1alpha1_volume_attributes_class_local_var->api_version = api_version;
    v1alpha1_volume_attributes_class_local_var->driver_name = driver_name;
    v1alpha1_volume_attributes_class_local_var->kind = kind;
...
void v1alpha1_volume_attributes_class_free(v1alpha1_volume_attributes_class_t *v1alpha1_volume_attributes_class) {
    ...
    if (v1alpha1_volume_attributes_class->api_version) {
        free(v1alpha1_volume_attributes_class->api_version);
        v1alpha1_volume_attributes_class->api_version = NULL;
    }
    if (v1alpha1_volume_attributes_class->driver_name) {
        free(v1alpha1_volume_attributes_class->driver_name);
        v1alpha1_volume_attributes_class->driver_name = NULL;
    }
    if (v1alpha1_volume_attributes_class->kind) {
        free(v1alpha1_volume_attributes_class->kind);
        v1alpha1_volume_attributes_class->kind = NULL;
    }
    if (v1alpha1_volume_attributes_class->metadata) {
        v1_object_meta_free(v1alpha1_volume_attributes_class->metadata);
        v1alpha1_volume_attributes_class->metadata = NULL;
    }
    if (v1alpha1_volume_attributes_class->parameters) {
        ...
        list_freeList(v1alpha1_volume_attributes_class->parameters);
        v1alpha1_volume_attributes_class->parameters = NULL;
    }
...
v1alpha1_volume_attributes_class_t *v1alpha1_volume_attributes_class_parseFromJSON(mazu_cJSON *v1alpha1_volume_attributes_classJSON){
    ...
    // define the local variable for v1alpha1_volume_attributes_class->metadata
    v1_object_meta_t *metadata_local_nonprim = NULL;

    // define the local map for v1alpha1_volume_attributes_class->parameters

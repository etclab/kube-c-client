...
mazu_cJSON *v1_certificate_signing_request_condition_convertToJSON(v1_certificate_signing_request_condition_t *v1_certificate_signing_request_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_certificate_signing_request_condition->last_transition_time
    if(v1_certificate_signing_request_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_certificate_signing_request_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_certificate_signing_request_condition->last_update_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastUpdateTime", v1_certificate_signing_request_condition->last_update_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_certificate_signing_request_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_certificate_signing_request_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_certificate_signing_request_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_certificate_signing_request_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_certificate_signing_request_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_certificate_signing_request_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_certificate_signing_request_condition_t *v1_certificate_signing_request_condition_parseFromJSON(mazu_cJSON *v1_certificate_signing_request_conditionJSON){

    v1_certificate_signing_request_condition_t *v1_certificate_signing_request_condition_local_var = NULL;

    // v1_certificate_signing_request_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "lastTransitionTime");
    ...
    // v1_certificate_signing_request_condition->last_update_time
    mazu_cJSON *last_update_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "lastUpdateTime");
    if (last_update_time) { 
    ...
    // v1_certificate_signing_request_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "message");
    if (message) { 
    ...
    // v1_certificate_signing_request_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_certificate_signing_request_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_certificate_signing_request_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_certificate_signing_request_conditionJSON, "type");
    if (!type) {
        goto end;
    }

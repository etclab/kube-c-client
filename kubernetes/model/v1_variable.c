...
mazu_cJSON *v1_variable_convertToJSON(v1_variable_t *v1_variable) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "expression", v1_variable->expression) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1_variable->name) == NULL) {
    goto fail; //String
    }
...
v1_variable_t *v1_variable_parseFromJSON(mazu_cJSON *v1_variableJSON){

    v1_variable_t *v1_variable_local_var = NULL;

    // v1_variable->expression
    mazu_cJSON *expression = mazu_cJSON_GetObjectItemCaseSensitive(v1_variableJSON, "expression");
    if (!expression) {
        goto end;
    }
    ...
    // v1_variable->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_variableJSON, "name");
    if (!name) {
        goto end;
    }

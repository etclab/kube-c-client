...
mazu_cJSON *v1_priority_class_list_convertToJSON(v1_priority_class_list_t *v1_priority_class_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_priority_class_list->api_version
    if(v1_priority_class_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_priority_class_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_priority_class_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_priority_class_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_priority_class_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_priority_class_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1_priority_class_list->metadata);
...
v1_priority_class_list_t *v1_priority_class_list_parseFromJSON(mazu_cJSON *v1_priority_class_listJSON){
    ...
    // v1_priority_class_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_class_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_priority_class_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_class_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_priority_class_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_class_listJSON, "kind");
    if (kind) { 
    ...
    // v1_priority_class_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_priority_class_listJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_list_meta_parseFromJSON(metadata); //nonprimitive
    }


    v1_priority_class_list_local_var = v1_priority_class_list_create (

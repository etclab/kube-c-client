...
mazu_cJSON *v1_daemon_set_convertToJSON(v1_daemon_set_t *v1_daemon_set) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_daemon_set->api_version
    if(v1_daemon_set->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_daemon_set->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_daemon_set->kind
    if(v1_daemon_set->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_daemon_set->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_daemon_set->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_daemon_set->metadata);
    ...
    // v1_daemon_set->spec
    if(v1_daemon_set->spec) {
    mazu_cJSON *spec_local_JSON = v1_daemon_set_spec_convertToJSON(v1_daemon_set->spec);
    ...
    if(v1_daemon_set->status) {
    mazu_cJSON *status_local_JSON = v1_daemon_set_status_convertToJSON(v1_daemon_set->status);
...
v1_daemon_set_t *v1_daemon_set_parseFromJSON(mazu_cJSON *v1_daemon_setJSON){
    ...
    // v1_daemon_set->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_setJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_daemon_set->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_setJSON, "kind");
    if (kind) { 
    ...
    // v1_daemon_set->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_setJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_daemon_set->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_setJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_daemon_set_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_daemon_set->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_daemon_setJSON, "status");
    if (status) { 

...
mazu_cJSON *v1_expression_warning_convertToJSON(v1_expression_warning_t *v1_expression_warning) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "fieldRef", v1_expression_warning->field_ref) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "warning", v1_expression_warning->warning) == NULL) {
    goto fail; //String
    }
...
v1_expression_warning_t *v1_expression_warning_parseFromJSON(mazu_cJSON *v1_expression_warningJSON){

    v1_expression_warning_t *v1_expression_warning_local_var = NULL;

    // v1_expression_warning->field_ref
    mazu_cJSON *field_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_expression_warningJSON, "fieldRef");
    if (!field_ref) {
        goto end;
    }
    ...
    // v1_expression_warning->warning
    mazu_cJSON *warning = mazu_cJSON_GetObjectItemCaseSensitive(v1_expression_warningJSON, "warning");
    if (!warning) {
        goto end;
    }

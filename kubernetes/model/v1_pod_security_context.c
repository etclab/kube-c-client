...
mazu_cJSON *v1_pod_security_context_convertToJSON(v1_pod_security_context_t *v1_pod_security_context) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_pod_security_context->app_armor_profile
    if(v1_pod_security_context->app_armor_profile) {
    mazu_cJSON *app_armor_profile_local_JSON = v1_app_armor_profile_convertToJSON(v1_pod_security_context->app_armor_profile);
    if(app_armor_profile_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "appArmorProfile", app_armor_profile_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "fsGroup", v1_pod_security_context->fs_group) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(v1_pod_security_context->fs_group_change_policy) {
    if(mazu_cJSON_AddStringToObject(item, "fsGroupChangePolicy", v1_pod_security_context->fs_group_change_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "runAsGroup", v1_pod_security_context->run_as_group) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "runAsNonRoot", v1_pod_security_context->run_as_non_root) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "runAsUser", v1_pod_security_context->run_as_user) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(v1_pod_security_context->se_linux_options) {
    mazu_cJSON *se_linux_options_local_JSON = v1_se_linux_options_convertToJSON(v1_pod_security_context->se_linux_options);
    if(se_linux_options_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "seLinuxOptions", se_linux_options_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    if(v1_pod_security_context->seccomp_profile) {
    mazu_cJSON *seccomp_profile_local_JSON = v1_seccomp_profile_convertToJSON(v1_pod_security_context->seccomp_profile);
    if(seccomp_profile_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "seccompProfile", seccomp_profile_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
    ...
    if(v1_pod_security_context->supplemental_groups_policy) {
    if(mazu_cJSON_AddStringToObject(item, "supplementalGroupsPolicy", v1_pod_security_context->supplemental_groups_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_pod_security_context->sysctls) {
    mazu_cJSON *sysctls = mazu_cJSON_AddArrayToObject(item, "sysctls");
    if(sysctls == NULL) {
    ...
    mazu_cJSON *itemLocal = v1_sysctl_convertToJSON(sysctlsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    mazu_cJSON_AddItemToArray(sysctls, itemLocal);
    }
    }
    }
    ...
    if(v1_pod_security_context->windows_options) {
    mazu_cJSON *windows_options_local_JSON = v1_windows_security_context_options_convertToJSON(v1_pod_security_context->windows_options);
    if(windows_options_local_JSON == NULL) {
    goto fail; //model
    }
    mazu_cJSON_AddItemToObject(item, "windowsOptions", windows_options_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
    }
...
v1_pod_security_context_t *v1_pod_security_context_parseFromJSON(mazu_cJSON *v1_pod_security_contextJSON){
    ...
    // v1_pod_security_context->app_armor_profile
    mazu_cJSON *app_armor_profile = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "appArmorProfile");
    if (app_armor_profile) { 
    app_armor_profile_local_nonprim = v1_app_armor_profile_parseFromJSON(app_armor_profile); //nonprimitive
    }

    // v1_pod_security_context->fs_group
    mazu_cJSON *fs_group = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "fsGroup");
    if (fs_group) { 
    if(!mazu_cJSON_IsNumber(fs_group))
    {
    goto end; //Numeric
    }
    }
    ...
    // v1_pod_security_context->fs_group_change_policy
    mazu_cJSON *fs_group_change_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "fsGroupChangePolicy");
    if (fs_group_change_policy) { 
    if(!mazu_cJSON_IsString(fs_group_change_policy) && !mazu_cJSON_IsNull(fs_group_change_policy))
    {
    goto end; //String
    }
    }
    ...
    // v1_pod_security_context->run_as_group
    mazu_cJSON *run_as_group = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "runAsGroup");
    if (run_as_group) { 
    if(!mazu_cJSON_IsNumber(run_as_group))
    {
    goto end; //Numeric
    }
    }
    ...
    // v1_pod_security_context->run_as_non_root
    mazu_cJSON *run_as_non_root = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "runAsNonRoot");
    if (run_as_non_root) { 
    if(!mazu_cJSON_IsBool(run_as_non_root))
    {
    goto end; //Bool
    }
    }
    ...
    // v1_pod_security_context->run_as_user
    mazu_cJSON *run_as_user = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "runAsUser");
    if (run_as_user) { 
    if(!mazu_cJSON_IsNumber(run_as_user))
    {
    goto end; //Numeric
    }
    }
    ...
    // v1_pod_security_context->se_linux_options
    mazu_cJSON *se_linux_options = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "seLinuxOptions");
    if (se_linux_options) { 
    se_linux_options_local_nonprim = v1_se_linux_options_parseFromJSON(se_linux_options); //nonprimitive
    }

    // v1_pod_security_context->seccomp_profile
    mazu_cJSON *seccomp_profile = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "seccompProfile");
    if (seccomp_profile) { 
    seccomp_profile_local_nonprim = v1_seccomp_profile_parseFromJSON(seccomp_profile); //nonprimitive
    }

    // v1_pod_security_context->supplemental_groups
    mazu_cJSON *supplemental_groups = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "supplementalGroups");
    ...
    // v1_pod_security_context->supplemental_groups_policy
    mazu_cJSON *supplemental_groups_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "supplementalGroupsPolicy");
    if (supplemental_groups_policy) { 
    if(!mazu_cJSON_IsString(supplemental_groups_policy) && !mazu_cJSON_IsNull(supplemental_groups_policy))
    {
    goto end; //String
    }
    }
    ...
    // v1_pod_security_context->sysctls
    mazu_cJSON *sysctls = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "sysctls");
    if (sysctls) { 
    mazu_cJSON *sysctls_local_nonprimitive = NULL;
    if(!mazu_cJSON_IsArray(sysctls)){
        goto end; //nonprimitive container
    }

    sysctlsList = list_createList();

    mazu_cJSON_ArrayForEach(sysctls_local_nonprimitive,sysctls )
    {
        if(!mazu_cJSON_IsObject(sysctls_local_nonprimitive)){
            goto end;
        }
    ...
    // v1_pod_security_context->windows_options
    mazu_cJSON *windows_options = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_security_contextJSON, "windowsOptions");
    if (windows_options) { 
    ...
    v1_pod_security_context_local_var = v1_pod_security_context_create (
        ...
        fs_group_change_policy && !mazu_cJSON_IsNull(fs_group_change_policy) ? strdup(fs_group_change_policy->valuestring) : NULL,
        ...
        supplemental_groups_policy && !mazu_cJSON_IsNull(supplemental_groups_policy) ? strdup(supplemental_groups_policy->valuestring) : NULL,

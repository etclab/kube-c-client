...
mazu_cJSON *v1_pod_template_spec_convertToJSON(v1_pod_template_spec_t *v1_pod_template_spec) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_pod_template_spec->metadata
    if(v1_pod_template_spec->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_pod_template_spec->metadata);
    ...
    if(v1_pod_template_spec->spec) {
    mazu_cJSON *spec_local_JSON = v1_pod_spec_convertToJSON(v1_pod_template_spec->spec);
...
v1_pod_template_spec_t *v1_pod_template_spec_parseFromJSON(mazu_cJSON *v1_pod_template_specJSON){
    ...
    // v1_pod_template_spec->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_template_specJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_pod_template_spec->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_pod_template_specJSON, "spec");
    if (spec) { 

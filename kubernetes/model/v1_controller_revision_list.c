...
void v1_controller_revision_list_free(v1_controller_revision_list_t *v1_controller_revision_list) {
    ...
    if (v1_controller_revision_list->api_version) {
        ...
        v1_controller_revision_list->api_version = NULL;
    }
    ...
    if (v1_controller_revision_list->kind) {
        ...
        v1_controller_revision_list->kind = NULL;
    }
    if (v1_controller_revision_list->metadata) {
        v1_list_meta_free(v1_controller_revision_list->metadata);
        v1_controller_revision_list->metadata = NULL;
    }
    free(v1_controller_revision_list);
}

mazu_cJSON *v1_controller_revision_list_convertToJSON(v1_controller_revision_list_t *v1_controller_revision_list) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_controller_revision_list->api_version
    if(v1_controller_revision_list->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_controller_revision_list->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    mazu_cJSON *itemLocal = v1_controller_revision_convertToJSON(itemsListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_controller_revision_list->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_controller_revision_list->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_controller_revision_list->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_list_meta_convertToJSON(v1_controller_revision_list->metadata);
...
v1_controller_revision_list_t *v1_controller_revision_list_parseFromJSON(mazu_cJSON *v1_controller_revision_listJSON){
    ...
    // v1_controller_revision_list->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_controller_revision_listJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_controller_revision_list->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_controller_revision_listJSON, "items");
    if (!items) {
        goto end;
    }
    ...
    // v1_controller_revision_list->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_controller_revision_listJSON, "kind");
    if (kind) { 
    ...
    // v1_controller_revision_list->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_controller_revision_listJSON, "metadata");
    if (metadata) { 

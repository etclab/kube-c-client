...
mazu_cJSON *v1_endpoint_address_convertToJSON(v1_endpoint_address_t *v1_endpoint_address) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_endpoint_address->hostname
    if(v1_endpoint_address->hostname) {
    if(mazu_cJSON_AddStringToObject(item, "hostname", v1_endpoint_address->hostname) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "ip", v1_endpoint_address->ip) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_endpoint_address->node_name) {
    if(mazu_cJSON_AddStringToObject(item, "nodeName", v1_endpoint_address->node_name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_endpoint_address->target_ref) {
    mazu_cJSON *target_ref_local_JSON = v1_object_reference_convertToJSON(v1_endpoint_address->target_ref);
...
v1_endpoint_address_t *v1_endpoint_address_parseFromJSON(mazu_cJSON *v1_endpoint_addressJSON){
    ...
    // v1_endpoint_address->hostname
    mazu_cJSON *hostname = mazu_cJSON_GetObjectItemCaseSensitive(v1_endpoint_addressJSON, "hostname");
    if (hostname) { 
    ...
    // v1_endpoint_address->ip
    mazu_cJSON *ip = mazu_cJSON_GetObjectItemCaseSensitive(v1_endpoint_addressJSON, "ip");
    if (!ip) {
        goto end;
    }
    ...
    // v1_endpoint_address->node_name
    mazu_cJSON *node_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_endpoint_addressJSON, "nodeName");
    if (node_name) { 
    ...
    // v1_endpoint_address->target_ref
    mazu_cJSON *target_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_endpoint_addressJSON, "targetRef");
    if (target_ref) { 

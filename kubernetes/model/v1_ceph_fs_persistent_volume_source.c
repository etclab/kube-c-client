...
mazu_cJSON *v1_ceph_fs_persistent_volume_source_convertToJSON(v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source) {
    ...
    if(v1_ceph_fs_persistent_volume_source->path) {
    if(mazu_cJSON_AddStringToObject(item, "path", v1_ceph_fs_persistent_volume_source->path) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_ceph_fs_persistent_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_ceph_fs_persistent_volume_source->secret_file) {
    if(mazu_cJSON_AddStringToObject(item, "secretFile", v1_ceph_fs_persistent_volume_source->secret_file) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_ceph_fs_persistent_volume_source->secret_ref) {
    mazu_cJSON *secret_ref_local_JSON = v1_secret_reference_convertToJSON(v1_ceph_fs_persistent_volume_source->secret_ref);
    ...
    if(v1_ceph_fs_persistent_volume_source->user) {
    if(mazu_cJSON_AddStringToObject(item, "user", v1_ceph_fs_persistent_volume_source->user) == NULL) {
    goto fail; //String
    }
    }
...
v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source_parseFromJSON(mazu_cJSON *v1_ceph_fs_persistent_volume_sourceJSON){
    ...
    // v1_ceph_fs_persistent_volume_source->monitors
    mazu_cJSON *monitors = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "monitors");
    if (!monitors) {
        goto end;
    }
    ...
    // v1_ceph_fs_persistent_volume_source->path
    mazu_cJSON *path = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "path");
    if (path) { 
    ...
    // v1_ceph_fs_persistent_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    // v1_ceph_fs_persistent_volume_source->secret_file
    mazu_cJSON *secret_file = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "secretFile");
    if (secret_file) { 
    ...
    // v1_ceph_fs_persistent_volume_source->secret_ref
    mazu_cJSON *secret_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "secretRef");
    if (secret_ref) { 
    secret_ref_local_nonprim = v1_secret_reference_parseFromJSON(secret_ref); //nonprimitive
    }

    // v1_ceph_fs_persistent_volume_source->user
    mazu_cJSON *user = mazu_cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "user");
    if (user) { 

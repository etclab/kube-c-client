...
mazu_cJSON *v1_persistent_volume_claim_convertToJSON(v1_persistent_volume_claim_t *v1_persistent_volume_claim) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_persistent_volume_claim->api_version
    if(v1_persistent_volume_claim->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_persistent_volume_claim->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_persistent_volume_claim->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_persistent_volume_claim->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_persistent_volume_claim->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_persistent_volume_claim->metadata);
    ...
    if(v1_persistent_volume_claim->spec) {
    mazu_cJSON *spec_local_JSON = v1_persistent_volume_claim_spec_convertToJSON(v1_persistent_volume_claim->spec);
    ...
    if(v1_persistent_volume_claim->status) {
    mazu_cJSON *status_local_JSON = v1_persistent_volume_claim_status_convertToJSON(v1_persistent_volume_claim->status);
...
v1_persistent_volume_claim_t *v1_persistent_volume_claim_parseFromJSON(mazu_cJSON *v1_persistent_volume_claimJSON){
    ...
    // v1_persistent_volume_claim->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claimJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_persistent_volume_claim->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claimJSON, "kind");
    if (kind) { 
    ...
    // v1_persistent_volume_claim->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claimJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_persistent_volume_claim->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claimJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_persistent_volume_claim_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_persistent_volume_claim->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claimJSON, "status");
    if (status) { 

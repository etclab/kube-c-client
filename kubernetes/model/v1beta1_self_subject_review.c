...
v1beta1_self_subject_review_t *v1beta1_self_subject_review_create(
    char *api_version,
    char *kind,
...
mazu_cJSON *v1beta1_self_subject_review_convertToJSON(v1beta1_self_subject_review_t *v1beta1_self_subject_review) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1beta1_self_subject_review->api_version
    if(v1beta1_self_subject_review->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta1_self_subject_review->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_self_subject_review->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta1_self_subject_review->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_self_subject_review->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1beta1_self_subject_review->metadata);
    ...
    if(v1beta1_self_subject_review->status) {
    mazu_cJSON *status_local_JSON = v1beta1_self_subject_review_status_convertToJSON(v1beta1_self_subject_review->status);
...
v1beta1_self_subject_review_t *v1beta1_self_subject_review_parseFromJSON(mazu_cJSON *v1beta1_self_subject_reviewJSON){
    ...
    // v1beta1_self_subject_review->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_self_subject_reviewJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta1_self_subject_review->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_self_subject_reviewJSON, "kind");
    if (kind) { 
    ...
    // v1beta1_self_subject_review->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_self_subject_reviewJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1beta1_self_subject_review->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_self_subject_reviewJSON, "status");
    if (status) { 
    status_local_nonprim = v1beta1_self_subject_review_status_parseFromJSON(status); //nonprimitive
    }


    v1beta1_self_subject_review_local_var = v1beta1_self_subject_review_create (

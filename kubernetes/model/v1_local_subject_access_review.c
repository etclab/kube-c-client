...
mazu_cJSON *v1_local_subject_access_review_convertToJSON(v1_local_subject_access_review_t *v1_local_subject_access_review) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_local_subject_access_review->api_version
    if(v1_local_subject_access_review->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_local_subject_access_review->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_local_subject_access_review->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_local_subject_access_review->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_local_subject_access_review->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_local_subject_access_review->metadata);
    ...
    mazu_cJSON *spec_local_JSON = v1_subject_access_review_spec_convertToJSON(v1_local_subject_access_review->spec);
    ...
    if(v1_local_subject_access_review->status) {
    mazu_cJSON *status_local_JSON = v1_subject_access_review_status_convertToJSON(v1_local_subject_access_review->status);
...
v1_local_subject_access_review_t *v1_local_subject_access_review_parseFromJSON(mazu_cJSON *v1_local_subject_access_reviewJSON){
    ...
    // v1_local_subject_access_review->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_local_subject_access_reviewJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_local_subject_access_review->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_local_subject_access_reviewJSON, "kind");
    if (kind) { 
    ...
    // v1_local_subject_access_review->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_local_subject_access_reviewJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_local_subject_access_review->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_local_subject_access_reviewJSON, "spec");
    if (!spec) {
        goto end;
    }
    ...
    // v1_local_subject_access_review->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_local_subject_access_reviewJSON, "status");
    if (status) { 

...
mazu_cJSON *v1_storage_os_persistent_volume_source_convertToJSON(v1_storage_os_persistent_volume_source_t *v1_storage_os_persistent_volume_source) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_storage_os_persistent_volume_source->fs_type
    if(v1_storage_os_persistent_volume_source->fs_type) {
    if(mazu_cJSON_AddStringToObject(item, "fsType", v1_storage_os_persistent_volume_source->fs_type) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_storage_os_persistent_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_storage_os_persistent_volume_source->secret_ref) {
    mazu_cJSON *secret_ref_local_JSON = v1_object_reference_convertToJSON(v1_storage_os_persistent_volume_source->secret_ref);
    ...
    if(v1_storage_os_persistent_volume_source->volume_name) {
    if(mazu_cJSON_AddStringToObject(item, "volumeName", v1_storage_os_persistent_volume_source->volume_name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_storage_os_persistent_volume_source->volume_namespace) {
    if(mazu_cJSON_AddStringToObject(item, "volumeNamespace", v1_storage_os_persistent_volume_source->volume_namespace) == NULL) {
    goto fail; //String
    }
    }
...
v1_storage_os_persistent_volume_source_t *v1_storage_os_persistent_volume_source_parseFromJSON(mazu_cJSON *v1_storage_os_persistent_volume_sourceJSON){
    ...
    // v1_storage_os_persistent_volume_source->fs_type
    mazu_cJSON *fs_type = mazu_cJSON_GetObjectItemCaseSensitive(v1_storage_os_persistent_volume_sourceJSON, "fsType");
    if (fs_type) { 
    ...
    // v1_storage_os_persistent_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_storage_os_persistent_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    // v1_storage_os_persistent_volume_source->secret_ref
    mazu_cJSON *secret_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_storage_os_persistent_volume_sourceJSON, "secretRef");
    if (secret_ref) { 
    secret_ref_local_nonprim = v1_object_reference_parseFromJSON(secret_ref); //nonprimitive
    }

    // v1_storage_os_persistent_volume_source->volume_name
    mazu_cJSON *volume_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_storage_os_persistent_volume_sourceJSON, "volumeName");
    if (volume_name) { 
    ...
    // v1_storage_os_persistent_volume_source->volume_namespace
    mazu_cJSON *volume_namespace = mazu_cJSON_GetObjectItemCaseSensitive(v1_storage_os_persistent_volume_sourceJSON, "volumeNamespace");
    if (volume_namespace) { 

...
v1beta3_limit_response_t *v1beta3_limit_response_create(
    ...
    v1beta3_limit_response_t *v1beta3_limit_response_local_var = malloc(sizeof(v1beta3_limit_response_t));
    if (!v1beta3_limit_response_local_var) {
        return NULL;
    }
    v1beta3_limit_response_local_var->queuing = queuing;
    v1beta3_limit_response_local_var->type = type;

    return v1beta3_limit_response_local_var;
}


void v1beta3_limit_response_free(v1beta3_limit_response_t *v1beta3_limit_response) {
    if(NULL == v1beta3_limit_response){
        return ;
    }
    listEntry_t *listEntry;
    if (v1beta3_limit_response->queuing) {
        v1beta3_queuing_configuration_free(v1beta3_limit_response->queuing);
        v1beta3_limit_response->queuing = NULL;
    }
    if (v1beta3_limit_response->type) {
        free(v1beta3_limit_response->type);
        v1beta3_limit_response->type = NULL;
    }
...
v1beta3_limit_response_t *v1beta3_limit_response_parseFromJSON(mazu_cJSON *v1beta3_limit_responseJSON){
    ...
    // define the local variable for v1beta3_limit_response->queuing
    ...
    v1beta3_limit_response_local_var = v1beta3_limit_response_create (
    ...
    if (queuing_local_nonprim) {
        v1beta3_queuing_configuration_free(queuing_local_nonprim);

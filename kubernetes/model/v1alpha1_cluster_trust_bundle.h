/*
 * v1alpha1_cluster_trust_bundle.h
 *
...
#ifndef _v1alpha1_cluster_trust_bundle_H_
#define _v1alpha1_cluster_trust_bundle_H_
...
typedef struct v1alpha1_cluster_trust_bundle_t v1alpha1_cluster_trust_bundle_t;
...
typedef struct v1alpha1_cluster_trust_bundle_t {
    char *api_version; // string
    char *kind; // string
    struct v1_object_meta_t *metadata; //model
    struct v1alpha1_cluster_trust_bundle_spec_t *spec; //model
...
#endif /* _v1alpha1_cluster_trust_bundle_H_ */

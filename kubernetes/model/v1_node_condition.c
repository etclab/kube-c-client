...
mazu_cJSON *v1_node_condition_convertToJSON(v1_node_condition_t *v1_node_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_node_condition->last_heartbeat_time
    if(v1_node_condition->last_heartbeat_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastHeartbeatTime", v1_node_condition->last_heartbeat_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_node_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_node_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_node_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_node_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_node_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_node_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_node_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_node_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_node_condition_t *v1_node_condition_parseFromJSON(mazu_cJSON *v1_node_conditionJSON){

    v1_node_condition_t *v1_node_condition_local_var = NULL;

    // v1_node_condition->last_heartbeat_time
    mazu_cJSON *last_heartbeat_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "lastHeartbeatTime");
    if (last_heartbeat_time) { 
    if(!mazu_cJSON_IsString(last_heartbeat_time) && !mazu_cJSON_IsNull(last_heartbeat_time))
    {
    goto end; //DateTime
    }
    }
    ...
    // v1_node_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "lastTransitionTime");
    ...
    // v1_node_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "message");
    if (message) { 
    ...
    // v1_node_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_node_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_node_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_conditionJSON, "type");
    if (!type) {
        goto end;
    }
    ...
    v1_node_condition_local_var = v1_node_condition_create (
        last_heartbeat_time && !mazu_cJSON_IsNull(last_heartbeat_time) ? strdup(last_heartbeat_time->valuestring) : NULL,

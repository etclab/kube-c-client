...
v2_pods_metric_source_t *v2_pods_metric_source_create(
...
mazu_cJSON *v2_pods_metric_source_convertToJSON(v2_pods_metric_source_t *v2_pods_metric_source) {
    ...
    mazu_cJSON *metric_local_JSON = v2_metric_identifier_convertToJSON(v2_pods_metric_source->metric);
    ...
    mazu_cJSON *target_local_JSON = v2_metric_target_convertToJSON(v2_pods_metric_source->target);
...
v2_pods_metric_source_t *v2_pods_metric_source_parseFromJSON(mazu_cJSON *v2_pods_metric_sourceJSON){
    ...
    // v2_pods_metric_source->metric
    mazu_cJSON *metric = mazu_cJSON_GetObjectItemCaseSensitive(v2_pods_metric_sourceJSON, "metric");
    if (!metric) {
        goto end;
    }
    ...
    // v2_pods_metric_source->target
    mazu_cJSON *target = mazu_cJSON_GetObjectItemCaseSensitive(v2_pods_metric_sourceJSON, "target");
    if (!target) {
        goto end;
    }
    ...
    v2_pods_metric_source_local_var = v2_pods_metric_source_create (

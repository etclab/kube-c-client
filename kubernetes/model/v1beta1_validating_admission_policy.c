...
mazu_cJSON *v1beta1_validating_admission_policy_convertToJSON(v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1beta1_validating_admission_policy->api_version
    if(v1beta1_validating_admission_policy->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta1_validating_admission_policy->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_validating_admission_policy->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta1_validating_admission_policy->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_validating_admission_policy->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1beta1_validating_admission_policy->metadata);
    ...
    if(v1beta1_validating_admission_policy->spec) {
    mazu_cJSON *spec_local_JSON = v1beta1_validating_admission_policy_spec_convertToJSON(v1beta1_validating_admission_policy->spec);
    ...
    if(v1beta1_validating_admission_policy->status) {
    mazu_cJSON *status_local_JSON = v1beta1_validating_admission_policy_status_convertToJSON(v1beta1_validating_admission_policy->status);
...
v1beta1_validating_admission_policy_t *v1beta1_validating_admission_policy_parseFromJSON(mazu_cJSON *v1beta1_validating_admission_policyJSON){
    ...
    // v1beta1_validating_admission_policy->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_validating_admission_policyJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta1_validating_admission_policy->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_validating_admission_policyJSON, "kind");
    if (kind) { 
    ...
    // v1beta1_validating_admission_policy->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_validating_admission_policyJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1beta1_validating_admission_policy->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_validating_admission_policyJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1beta1_validating_admission_policy_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1beta1_validating_admission_policy->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_validating_admission_policyJSON, "status");
    if (status) { 

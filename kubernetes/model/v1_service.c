...
v1_service_t *v1_service_create(
    ...
    v1_service_local_var->api_version = api_version;
...
void v1_service_free(v1_service_t *v1_service) {
    ...
    if (v1_service->api_version) {
        free(v1_service->api_version);
        v1_service->api_version = NULL;
    }
    if (v1_service->kind) {
        free(v1_service->kind);
        v1_service->kind = NULL;
    }
    if (v1_service->metadata) {
        v1_object_meta_free(v1_service->metadata);
        v1_service->metadata = NULL;
    }
    if (v1_service->spec) {
        v1_service_spec_free(v1_service->spec);
        v1_service->spec = NULL;
    }
    if (v1_service->status) {
        v1_service_status_free(v1_service->status);
        v1_service->status = NULL;
    }
    free(v1_service);
}

mazu_cJSON *v1_service_convertToJSON(v1_service_t *v1_service) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_service->api_version
    if(v1_service->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_service->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_service->kind
    if(v1_service->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_service->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    // v1_service->metadata
    if(v1_service->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_service->metadata);
    ...
    // v1_service->spec
    if(v1_service->spec) {
    mazu_cJSON *spec_local_JSON = v1_service_spec_convertToJSON(v1_service->spec);
    ...
    // v1_service->status
    if(v1_service->status) {
    mazu_cJSON *status_local_JSON = v1_service_status_convertToJSON(v1_service->status);
...
v1_service_t *v1_service_parseFromJSON(mazu_cJSON *v1_serviceJSON){
    ...
    // v1_service->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_serviceJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_service->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_serviceJSON, "kind");
    if (kind) { 
    ...
    // v1_service->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_serviceJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_service->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_serviceJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_service_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_service->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_serviceJSON, "status");
    if (status) { 

...
mazu_cJSON *v1_limited_priority_level_configuration_convertToJSON(v1_limited_priority_level_configuration_t *v1_limited_priority_level_configuration) {
    ...
    if(mazu_cJSON_AddNumberToObject(item, "borrowingLimitPercent", v1_limited_priority_level_configuration->borrowing_limit_percent) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "lendablePercent", v1_limited_priority_level_configuration->lendable_percent) == NULL) {
    goto fail; //Numeric
    }
    }
    ...
    if(v1_limited_priority_level_configuration->limit_response) {
    mazu_cJSON *limit_response_local_JSON = v1_limit_response_convertToJSON(v1_limited_priority_level_configuration->limit_response);
    ...
    if(mazu_cJSON_AddNumberToObject(item, "nominalConcurrencyShares", v1_limited_priority_level_configuration->nominal_concurrency_shares) == NULL) {
    goto fail; //Numeric
    }
    }
...
v1_limited_priority_level_configuration_t *v1_limited_priority_level_configuration_parseFromJSON(mazu_cJSON *v1_limited_priority_level_configurationJSON){
    ...
    // v1_limited_priority_level_configuration->borrowing_limit_percent
    mazu_cJSON *borrowing_limit_percent = mazu_cJSON_GetObjectItemCaseSensitive(v1_limited_priority_level_configurationJSON, "borrowingLimitPercent");
    ...
    // v1_limited_priority_level_configuration->lendable_percent
    mazu_cJSON *lendable_percent = mazu_cJSON_GetObjectItemCaseSensitive(v1_limited_priority_level_configurationJSON, "lendablePercent");
    if (lendable_percent) { 
    ...
    // v1_limited_priority_level_configuration->limit_response
    mazu_cJSON *limit_response = mazu_cJSON_GetObjectItemCaseSensitive(v1_limited_priority_level_configurationJSON, "limitResponse");
    if (limit_response) { 
    limit_response_local_nonprim = v1_limit_response_parseFromJSON(limit_response); //nonprimitive
    }

    // v1_limited_priority_level_configuration->nominal_concurrency_shares
    mazu_cJSON *nominal_concurrency_shares = mazu_cJSON_GetObjectItemCaseSensitive(v1_limited_priority_level_configurationJSON, "nominalConcurrencyShares");

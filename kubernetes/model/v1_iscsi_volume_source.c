...
void v1_iscsi_volume_source_free(v1_iscsi_volume_source_t *v1_iscsi_volume_source) {
    ...
    if (v1_iscsi_volume_source->portals) {
        ...
        list_freeList(v1_iscsi_volume_source->portals);
...
mazu_cJSON *v1_iscsi_volume_source_convertToJSON(v1_iscsi_volume_source_t *v1_iscsi_volume_source) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_iscsi_volume_source->chap_auth_discovery
    if(v1_iscsi_volume_source->chap_auth_discovery) {
    if(mazu_cJSON_AddBoolToObject(item, "chapAuthDiscovery", v1_iscsi_volume_source->chap_auth_discovery) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "chapAuthSession", v1_iscsi_volume_source->chap_auth_session) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_iscsi_volume_source->fs_type) {
    if(mazu_cJSON_AddStringToObject(item, "fsType", v1_iscsi_volume_source->fs_type) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_iscsi_volume_source->initiator_name) {
    if(mazu_cJSON_AddStringToObject(item, "initiatorName", v1_iscsi_volume_source->initiator_name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "iqn", v1_iscsi_volume_source->iqn) == NULL) {
    goto fail; //String
    }
    ...
    if(v1_iscsi_volume_source->iscsi_interface) {
    if(mazu_cJSON_AddStringToObject(item, "iscsiInterface", v1_iscsi_volume_source->iscsi_interface) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddNumberToObject(item, "lun", v1_iscsi_volume_source->lun) == NULL) {
    goto fail; //Numeric
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "readOnly", v1_iscsi_volume_source->read_only) == NULL) {
    goto fail; //Bool
    }
    }
    ...
    if(v1_iscsi_volume_source->secret_ref) {
    mazu_cJSON *secret_ref_local_JSON = v1_local_object_reference_convertToJSON(v1_iscsi_volume_source->secret_ref);
    ...
    if(mazu_cJSON_AddStringToObject(item, "targetPortal", v1_iscsi_volume_source->target_portal) == NULL) {
    goto fail; //String
    }
...
v1_iscsi_volume_source_t *v1_iscsi_volume_source_parseFromJSON(mazu_cJSON *v1_iscsi_volume_sourceJSON){
    ...
    // v1_iscsi_volume_source->chap_auth_discovery
    mazu_cJSON *chap_auth_discovery = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "chapAuthDiscovery");
    ...
    // v1_iscsi_volume_source->chap_auth_session
    mazu_cJSON *chap_auth_session = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "chapAuthSession");
    ...
    // v1_iscsi_volume_source->fs_type
    mazu_cJSON *fs_type = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "fsType");
    if (fs_type) { 
    ...
    // v1_iscsi_volume_source->initiator_name
    mazu_cJSON *initiator_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "initiatorName");
    if (initiator_name) { 
    ...
    // v1_iscsi_volume_source->iqn
    mazu_cJSON *iqn = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "iqn");
    if (!iqn) {
        goto end;
    }
    ...
    // v1_iscsi_volume_source->iscsi_interface
    mazu_cJSON *iscsi_interface = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "iscsiInterface");
    if (iscsi_interface) { 
    ...
    // v1_iscsi_volume_source->lun
    mazu_cJSON *lun = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "lun");
    if (!lun) {
        goto end;
    }
    ...
    // v1_iscsi_volume_source->portals
    mazu_cJSON *portals = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "portals");
    if (portals) { 
    ...
    // v1_iscsi_volume_source->read_only
    mazu_cJSON *read_only = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "readOnly");
    if (read_only) { 
    ...
    // v1_iscsi_volume_source->secret_ref
    mazu_cJSON *secret_ref = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "secretRef");
    if (secret_ref) { 
    secret_ref_local_nonprim = v1_local_object_reference_parseFromJSON(secret_ref); //nonprimitive
    }

    // v1_iscsi_volume_source->target_portal
    mazu_cJSON *target_portal = mazu_cJSON_GetObjectItemCaseSensitive(v1_iscsi_volume_sourceJSON, "targetPortal");
    if (!target_portal) {
        goto end;
    }

...
v1_match_resources_t *v1_match_resources_create(
    ...
    v1_match_resources_t *v1_match_resources_local_var = malloc(sizeof(v1_match_resources_t));
    if (!v1_match_resources_local_var) {
        return NULL;
    }
    v1_match_resources_local_var->exclude_resource_rules = exclude_resource_rules;
    v1_match_resources_local_var->match_policy = match_policy;
    v1_match_resources_local_var->namespace_selector = namespace_selector;
...
void v1_match_resources_free(v1_match_resources_t *v1_match_resources) {
    ...
    if (v1_match_resources->exclude_resource_rules) {
        list_ForEach(listEntry, v1_match_resources->exclude_resource_rules) {
            v1_named_rule_with_operations_free(listEntry->data);
        }
        list_freeList(v1_match_resources->exclude_resource_rules);
        v1_match_resources->exclude_resource_rules = NULL;
    }
    if (v1_match_resources->match_policy) {
        free(v1_match_resources->match_policy);
        v1_match_resources->match_policy = NULL;
    }
    if (v1_match_resources->namespace_selector) {
        v1_label_selector_free(v1_match_resources->namespace_selector);
        v1_match_resources->namespace_selector = NULL;
    }
    if (v1_match_resources->object_selector) {
        v1_label_selector_free(v1_match_resources->object_selector);
        v1_match_resources->object_selector = NULL;
    }
    if (v1_match_resources->resource_rules) {
        list_ForEach(listEntry, v1_match_resources->resource_rules) {
            v1_named_rule_with_operations_free(listEntry->data);
        }
        list_freeList(v1_match_resources->resource_rules);
        v1_match_resources->resource_rules = NULL;
    }
    free(v1_match_resources);
}
...
mazu_cJSON *v1_match_resources_convertToJSON(v1_match_resources_t *v1_match_resources) {
    ...
    if (v1_match_resources->exclude_resource_rules) {
    list_ForEach(exclude_resource_rulesListEntry, v1_match_resources->exclude_resource_rules) {
    mazu_cJSON *itemLocal = v1_named_rule_with_operations_convertToJSON(exclude_resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
    ...
    if(v1_match_resources->match_policy) {
    if(mazu_cJSON_AddStringToObject(item, "matchPolicy", v1_match_resources->match_policy) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_match_resources->namespace_selector) {
    mazu_cJSON *namespace_selector_local_JSON = v1_label_selector_convertToJSON(v1_match_resources->namespace_selector);
    ...
    if(v1_match_resources->object_selector) {
    mazu_cJSON *object_selector_local_JSON = v1_label_selector_convertToJSON(v1_match_resources->object_selector);
    ...
    if (v1_match_resources->resource_rules) {
    list_ForEach(resource_rulesListEntry, v1_match_resources->resource_rules) {
    mazu_cJSON *itemLocal = v1_named_rule_with_operations_convertToJSON(resource_rulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1_match_resources_t *v1_match_resources_parseFromJSON(mazu_cJSON *v1_match_resourcesJSON){
    ...
    v1_match_resources_t *v1_match_resources_local_var = NULL;

    // define the local list for v1_match_resources->exclude_resource_rules
    list_t *exclude_resource_rulesList = NULL;

    // define the local variable for v1_match_resources->namespace_selector
    v1_label_selector_t *namespace_selector_local_nonprim = NULL;

    // define the local variable for v1_match_resources->object_selector
    v1_label_selector_t *object_selector_local_nonprim = NULL;

    // define the local list for v1_match_resources->resource_rules
    list_t *resource_rulesList = NULL;

    // v1_match_resources->exclude_resource_rules
    mazu_cJSON *exclude_resource_rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_match_resourcesJSON, "excludeResourceRules");
    ...
    mazu_cJSON_ArrayForEach(exclude_resource_rules_local_nonprimitive,exclude_resource_rules )
    {
        ...
        v1_named_rule_with_operations_t *exclude_resource_rulesItem = v1_named_rule_with_operations_parseFromJSON(exclude_resource_rules_local_nonprimitive);
    ...
    // v1_match_resources->match_policy
    mazu_cJSON *match_policy = mazu_cJSON_GetObjectItemCaseSensitive(v1_match_resourcesJSON, "matchPolicy");
    if (match_policy) { 
    ...
    // v1_match_resources->namespace_selector
    mazu_cJSON *namespace_selector = mazu_cJSON_GetObjectItemCaseSensitive(v1_match_resourcesJSON, "namespaceSelector");
    if (namespace_selector) { 
    namespace_selector_local_nonprim = v1_label_selector_parseFromJSON(namespace_selector); //nonprimitive
    }

    // v1_match_resources->object_selector
    mazu_cJSON *object_selector = mazu_cJSON_GetObjectItemCaseSensitive(v1_match_resourcesJSON, "objectSelector");
    if (object_selector) { 
    object_selector_local_nonprim = v1_label_selector_parseFromJSON(object_selector); //nonprimitive
    }

    // v1_match_resources->resource_rules
    mazu_cJSON *resource_rules = mazu_cJSON_GetObjectItemCaseSensitive(v1_match_resourcesJSON, "resourceRules");
    if (resource_rules) { 
    ...
    mazu_cJSON_ArrayForEach(resource_rules_local_nonprimitive,resource_rules )
    {
        ...
        v1_named_rule_with_operations_t *resource_rulesItem = v1_named_rule_with_operations_parseFromJSON(resource_rules_local_nonprimitive);

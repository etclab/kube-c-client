...
mazu_cJSON *v1_node_selector_requirement_convertToJSON(v1_node_selector_requirement_t *v1_node_selector_requirement) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "key", v1_node_selector_requirement->key) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "operator", v1_node_selector_requirement->_operator) == NULL) {
    goto fail; //String
    }
...
v1_node_selector_requirement_t *v1_node_selector_requirement_parseFromJSON(mazu_cJSON *v1_node_selector_requirementJSON){
    ...
    // v1_node_selector_requirement->key
    mazu_cJSON *key = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_selector_requirementJSON, "key");
    if (!key) {
        goto end;
    }
    ...
    // v1_node_selector_requirement->_operator
    mazu_cJSON *_operator = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_selector_requirementJSON, "operator");
    if (!_operator) {
        goto end;
    }
    ...
    // v1_node_selector_requirement->values
    mazu_cJSON *values = mazu_cJSON_GetObjectItemCaseSensitive(v1_node_selector_requirementJSON, "values");
    if (values) { 

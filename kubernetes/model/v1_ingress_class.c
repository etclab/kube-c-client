...
mazu_cJSON *v1_ingress_class_convertToJSON(v1_ingress_class_t *v1_ingress_class) {
    ...
    if(v1_ingress_class->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_ingress_class->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_ingress_class->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_ingress_class->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_ingress_class->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_ingress_class->metadata);
    ...
    if(v1_ingress_class->spec) {
    mazu_cJSON *spec_local_JSON = v1_ingress_class_spec_convertToJSON(v1_ingress_class->spec);
...
v1_ingress_class_t *v1_ingress_class_parseFromJSON(mazu_cJSON *v1_ingress_classJSON){
    ...
    // v1_ingress_class->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_ingress_classJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_ingress_class->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_ingress_classJSON, "kind");
    if (kind) { 
    ...
    // v1_ingress_class->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_ingress_classJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_ingress_class->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_ingress_classJSON, "spec");
    if (spec) { 

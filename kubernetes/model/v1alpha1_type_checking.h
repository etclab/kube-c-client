/*
 * v1alpha1_type_checking.h
 *
 * TypeChecking contains results of type checking the expressions in the ValidatingAdmissionPolicy
 */

#ifndef _v1alpha1_type_checking_H_
...
typedef struct v1alpha1_type_checking_t v1alpha1_type_checking_t;

#include "v1alpha1_expression_warning.h"



typedef struct v1alpha1_type_checking_t {
    list_t *expression_warnings; //nonprimitive container

} v1alpha1_type_checking_t;

/*
 * v1_rbd_volume_source.h
 *
 * Represents a Rados Block Device mount that lasts the lifetime of a pod. RBD volumes support ownership management and SELinux relabeling.
 */

#ifndef _v1_rbd_volume_source_H_
#define _v1_rbd_volume_source_H_
...
typedef struct v1_rbd_volume_source_t v1_rbd_volume_source_t;

#include "v1_local_object_reference.h"



typedef struct v1_rbd_volume_source_t {
    char *fs_type; // string
    char *image; // string
    char *keyring; // string
...
#endif /* _v1_rbd_volume_source_H_ */

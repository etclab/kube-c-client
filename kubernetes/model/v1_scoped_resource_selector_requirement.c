...
mazu_cJSON *v1_scoped_resource_selector_requirement_convertToJSON(v1_scoped_resource_selector_requirement_t *v1_scoped_resource_selector_requirement) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "operator", v1_scoped_resource_selector_requirement->_operator) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "scopeName", v1_scoped_resource_selector_requirement->scope_name) == NULL) {
    goto fail; //String
    }
...
v1_scoped_resource_selector_requirement_t *v1_scoped_resource_selector_requirement_parseFromJSON(mazu_cJSON *v1_scoped_resource_selector_requirementJSON){
    ...
    // v1_scoped_resource_selector_requirement->_operator
    mazu_cJSON *_operator = mazu_cJSON_GetObjectItemCaseSensitive(v1_scoped_resource_selector_requirementJSON, "operator");
    if (!_operator) {
        goto end;
    }
    ...
    // v1_scoped_resource_selector_requirement->scope_name
    mazu_cJSON *scope_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_scoped_resource_selector_requirementJSON, "scopeName");
    if (!scope_name) {
        goto end;
    }

    
    if(!mazu_cJSON_IsString(scope_name))
    {
    goto end; //String
    }

    // v1_scoped_resource_selector_requirement->values
    mazu_cJSON *values = mazu_cJSON_GetObjectItemCaseSensitive(v1_scoped_resource_selector_requirementJSON, "values");
    if (values) { 

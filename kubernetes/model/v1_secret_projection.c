...
mazu_cJSON *v1_secret_projection_convertToJSON(v1_secret_projection_t *v1_secret_projection) {
    ...
    if(v1_secret_projection->name) {
    if(mazu_cJSON_AddStringToObject(item, "name", v1_secret_projection->name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddBoolToObject(item, "optional", v1_secret_projection->optional) == NULL) {
    goto fail; //Bool
    }
    }
...
v1_secret_projection_t *v1_secret_projection_parseFromJSON(mazu_cJSON *v1_secret_projectionJSON){
    ...
    // v1_secret_projection->items
    mazu_cJSON *items = mazu_cJSON_GetObjectItemCaseSensitive(v1_secret_projectionJSON, "items");
    if (items) { 
    ...
    // v1_secret_projection->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1_secret_projectionJSON, "name");
    if (name) { 
    ...
    // v1_secret_projection->optional
    mazu_cJSON *optional = mazu_cJSON_GetObjectItemCaseSensitive(v1_secret_projectionJSON, "optional");
    if (optional) { 

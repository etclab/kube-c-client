...
mazu_cJSON *v1_vsphere_virtual_disk_volume_source_convertToJSON(v1_vsphere_virtual_disk_volume_source_t *v1_vsphere_virtual_disk_volume_source) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_vsphere_virtual_disk_volume_source->fs_type
    if(v1_vsphere_virtual_disk_volume_source->fs_type) {
    if(mazu_cJSON_AddStringToObject(item, "fsType", v1_vsphere_virtual_disk_volume_source->fs_type) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_vsphere_virtual_disk_volume_source->storage_policy_id) {
    if(mazu_cJSON_AddStringToObject(item, "storagePolicyID", v1_vsphere_virtual_disk_volume_source->storage_policy_id) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_vsphere_virtual_disk_volume_source->storage_policy_name) {
    if(mazu_cJSON_AddStringToObject(item, "storagePolicyName", v1_vsphere_virtual_disk_volume_source->storage_policy_name) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "volumePath", v1_vsphere_virtual_disk_volume_source->volume_path) == NULL) {
    goto fail; //String
    }
...
v1_vsphere_virtual_disk_volume_source_t *v1_vsphere_virtual_disk_volume_source_parseFromJSON(mazu_cJSON *v1_vsphere_virtual_disk_volume_sourceJSON){

    v1_vsphere_virtual_disk_volume_source_t *v1_vsphere_virtual_disk_volume_source_local_var = NULL;

    // v1_vsphere_virtual_disk_volume_source->fs_type
    mazu_cJSON *fs_type = mazu_cJSON_GetObjectItemCaseSensitive(v1_vsphere_virtual_disk_volume_sourceJSON, "fsType");
    if (fs_type) { 
    ...
    // v1_vsphere_virtual_disk_volume_source->storage_policy_id
    mazu_cJSON *storage_policy_id = mazu_cJSON_GetObjectItemCaseSensitive(v1_vsphere_virtual_disk_volume_sourceJSON, "storagePolicyID");
    if (storage_policy_id) { 
    if(!mazu_cJSON_IsString(storage_policy_id) && !mazu_cJSON_IsNull(storage_policy_id))
    {
    goto end; //String
    }
    }
    ...
    // v1_vsphere_virtual_disk_volume_source->storage_policy_name
    mazu_cJSON *storage_policy_name = mazu_cJSON_GetObjectItemCaseSensitive(v1_vsphere_virtual_disk_volume_sourceJSON, "storagePolicyName");
    if (storage_policy_name) { 
    if(!mazu_cJSON_IsString(storage_policy_name) && !mazu_cJSON_IsNull(storage_policy_name))
    {
    goto end; //String
    }
    }
    ...
    // v1_vsphere_virtual_disk_volume_source->volume_path
    mazu_cJSON *volume_path = mazu_cJSON_GetObjectItemCaseSensitive(v1_vsphere_virtual_disk_volume_sourceJSON, "volumePath");
    if (!volume_path) {
        goto end;
    }

    
    if(!mazu_cJSON_IsString(volume_path))
    {
    goto end; //String
    }
    ...
    v1_vsphere_virtual_disk_volume_source_local_var = v1_vsphere_virtual_disk_volume_source_create (
        ...
        storage_policy_id && !mazu_cJSON_IsNull(storage_policy_id) ? strdup(storage_policy_id->valuestring) : NULL,
        storage_policy_name && !mazu_cJSON_IsNull(storage_policy_name) ? strdup(storage_policy_name->valuestring) : NULL,

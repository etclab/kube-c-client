...
v1_validating_admission_policy_binding_t *v1_validating_admission_policy_binding_create(
    char *api_version,
    char *kind,
...
mazu_cJSON *v1_validating_admission_policy_binding_convertToJSON(v1_validating_admission_policy_binding_t *v1_validating_admission_policy_binding) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_validating_admission_policy_binding->api_version
    if(v1_validating_admission_policy_binding->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_validating_admission_policy_binding->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_validating_admission_policy_binding->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_validating_admission_policy_binding->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_validating_admission_policy_binding->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_validating_admission_policy_binding->metadata);
    ...
    if(v1_validating_admission_policy_binding->spec) {
    mazu_cJSON *spec_local_JSON = v1_validating_admission_policy_binding_spec_convertToJSON(v1_validating_admission_policy_binding->spec);
...
v1_validating_admission_policy_binding_t *v1_validating_admission_policy_binding_parseFromJSON(mazu_cJSON *v1_validating_admission_policy_bindingJSON){
    ...
    // v1_validating_admission_policy_binding->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_bindingJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_validating_admission_policy_binding->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_bindingJSON, "kind");
    if (kind) { 
    ...
    // v1_validating_admission_policy_binding->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_bindingJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_validating_admission_policy_binding->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_validating_admission_policy_bindingJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_validating_admission_policy_binding_spec_parseFromJSON(spec); //nonprimitive
    }


    v1_validating_admission_policy_binding_local_var = v1_validating_admission_policy_binding_create (

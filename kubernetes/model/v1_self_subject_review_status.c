...
mazu_cJSON *v1_self_subject_review_status_convertToJSON(v1_self_subject_review_status_t *v1_self_subject_review_status) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_self_subject_review_status->user_info
    if(v1_self_subject_review_status->user_info) {
    mazu_cJSON *user_info_local_JSON = v1_user_info_convertToJSON(v1_self_subject_review_status->user_info);
...
v1_self_subject_review_status_t *v1_self_subject_review_status_parseFromJSON(mazu_cJSON *v1_self_subject_review_statusJSON){
    ...
    // v1_self_subject_review_status->user_info
    mazu_cJSON *user_info = mazu_cJSON_GetObjectItemCaseSensitive(v1_self_subject_review_statusJSON, "userInfo");
    if (user_info) { 

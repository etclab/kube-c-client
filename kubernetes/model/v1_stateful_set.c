...
mazu_cJSON *v1_stateful_set_convertToJSON(v1_stateful_set_t *v1_stateful_set) {
    ...
    if(v1_stateful_set->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1_stateful_set->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_stateful_set->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1_stateful_set->kind) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_stateful_set->metadata) {
    mazu_cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_stateful_set->metadata);
    ...
    if(v1_stateful_set->spec) {
    mazu_cJSON *spec_local_JSON = v1_stateful_set_spec_convertToJSON(v1_stateful_set->spec);
    ...
    if(v1_stateful_set->status) {
    mazu_cJSON *status_local_JSON = v1_stateful_set_status_convertToJSON(v1_stateful_set->status);
...
v1_stateful_set_t *v1_stateful_set_parseFromJSON(mazu_cJSON *v1_stateful_setJSON){
    ...
    // v1_stateful_set->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1_stateful_set->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "kind");
    if (kind) { 
    ...
    // v1_stateful_set->metadata
    mazu_cJSON *metadata = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "metadata");
    if (metadata) { 
    metadata_local_nonprim = v1_object_meta_parseFromJSON(metadata); //nonprimitive
    }

    // v1_stateful_set->spec
    mazu_cJSON *spec = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "spec");
    if (spec) { 
    spec_local_nonprim = v1_stateful_set_spec_parseFromJSON(spec); //nonprimitive
    }

    // v1_stateful_set->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "status");
    if (status) { 

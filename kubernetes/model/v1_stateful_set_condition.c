...
v1_stateful_set_condition_t *v1_stateful_set_condition_create(
    ...
    v1_stateful_set_condition_local_var->last_transition_time = last_transition_time;
...
void v1_stateful_set_condition_free(v1_stateful_set_condition_t *v1_stateful_set_condition) {
    ...
    if (v1_stateful_set_condition->last_transition_time) {
        free(v1_stateful_set_condition->last_transition_time);
        v1_stateful_set_condition->last_transition_time = NULL;
    }
    if (v1_stateful_set_condition->message) {
        free(v1_stateful_set_condition->message);
        v1_stateful_set_condition->message = NULL;
    }
    if (v1_stateful_set_condition->reason) {
        free(v1_stateful_set_condition->reason);
        v1_stateful_set_condition->reason = NULL;
    }
    if (v1_stateful_set_condition->status) {
        free(v1_stateful_set_condition->status);
        v1_stateful_set_condition->status = NULL;
    }
    if (v1_stateful_set_condition->type) {
        free(v1_stateful_set_condition->type);
        v1_stateful_set_condition->type = NULL;
    }
    free(v1_stateful_set_condition);
}

mazu_cJSON *v1_stateful_set_condition_convertToJSON(v1_stateful_set_condition_t *v1_stateful_set_condition) {
    mazu_cJSON *item = mazu_cJSON_CreateObject();

    // v1_stateful_set_condition->last_transition_time
    if(v1_stateful_set_condition->last_transition_time) {
    if(mazu_cJSON_AddStringToObject(item, "lastTransitionTime", v1_stateful_set_condition->last_transition_time) == NULL) {
    goto fail; //Date-Time
    }
    }
    ...
    if(v1_stateful_set_condition->message) {
    if(mazu_cJSON_AddStringToObject(item, "message", v1_stateful_set_condition->message) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1_stateful_set_condition->reason) {
    if(mazu_cJSON_AddStringToObject(item, "reason", v1_stateful_set_condition->reason) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "status", v1_stateful_set_condition->status) == NULL) {
    goto fail; //String
    }
    ...
    if(mazu_cJSON_AddStringToObject(item, "type", v1_stateful_set_condition->type) == NULL) {
    goto fail; //String
    }
...
v1_stateful_set_condition_t *v1_stateful_set_condition_parseFromJSON(mazu_cJSON *v1_stateful_set_conditionJSON){

    v1_stateful_set_condition_t *v1_stateful_set_condition_local_var = NULL;

    // v1_stateful_set_condition->last_transition_time
    mazu_cJSON *last_transition_time = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_set_conditionJSON, "lastTransitionTime");
    ...
    // v1_stateful_set_condition->message
    mazu_cJSON *message = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_set_conditionJSON, "message");
    if (message) { 
    ...
    // v1_stateful_set_condition->reason
    mazu_cJSON *reason = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_set_conditionJSON, "reason");
    if (reason) { 
    ...
    // v1_stateful_set_condition->status
    mazu_cJSON *status = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_set_conditionJSON, "status");
    if (!status) {
        goto end;
    }
    ...
    // v1_stateful_set_condition->type
    mazu_cJSON *type = mazu_cJSON_GetObjectItemCaseSensitive(v1_stateful_set_conditionJSON, "type");
    if (!type) {
        goto end;
    }

...
mazu_cJSON *v1beta3_user_subject_convertToJSON(v1beta3_user_subject_t *v1beta3_user_subject) {
    ...
    if(mazu_cJSON_AddStringToObject(item, "name", v1beta3_user_subject->name) == NULL) {
    goto fail; //String
    }
...
v1beta3_user_subject_t *v1beta3_user_subject_parseFromJSON(mazu_cJSON *v1beta3_user_subjectJSON){

    v1beta3_user_subject_t *v1beta3_user_subject_local_var = NULL;

    // v1beta3_user_subject->name
    mazu_cJSON *name = mazu_cJSON_GetObjectItemCaseSensitive(v1beta3_user_subjectJSON, "name");
    if (!name) {
        goto end;
    }

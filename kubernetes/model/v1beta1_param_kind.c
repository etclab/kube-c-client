...
mazu_cJSON *v1beta1_param_kind_convertToJSON(v1beta1_param_kind_t *v1beta1_param_kind) {
    ...
    if(v1beta1_param_kind->api_version) {
    if(mazu_cJSON_AddStringToObject(item, "apiVersion", v1beta1_param_kind->api_version) == NULL) {
    goto fail; //String
    }
    }
    ...
    if(v1beta1_param_kind->kind) {
    if(mazu_cJSON_AddStringToObject(item, "kind", v1beta1_param_kind->kind) == NULL) {
    goto fail; //String
    }
    }
...
v1beta1_param_kind_t *v1beta1_param_kind_parseFromJSON(mazu_cJSON *v1beta1_param_kindJSON){
    ...
    // v1beta1_param_kind->api_version
    mazu_cJSON *api_version = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_kindJSON, "apiVersion");
    if (api_version) { 
    ...
    // v1beta1_param_kind->kind
    mazu_cJSON *kind = mazu_cJSON_GetObjectItemCaseSensitive(v1beta1_param_kindJSON, "kind");
    if (kind) { 
